<?php
/* Smarty version 3.1.30, created on 2024-10-01 12:48:48
  from "/inelplm/www/html/lm_qms_atul_22sep24/lib/admin/templates/list_user.admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_66fbefb0a1dd86_90631664',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e853d792a494213378e37834b401306d26fe2ce6' => 
    array (
      0 => '/inelplm/www/html/lm_qms_atul_22sep24/lib/admin/templates/list_user.admin.tpl',
      1 => 1633500692,
      2 => 'file',
    ),
  ),
...
function content_66fbefb0a1dd86_90631664 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="list_user" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="list_user-form" autocomplete="off">
 ...
 <span class="vd_red">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2"><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"password"),$_smarty_tpl);?>
 <span class="vd_red">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2"><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"retypepassword"),$_smarty_tpl);?>
 <span class="vd_red">*</span></label>
                                            <div id="company-input-wrapper" class="controls col-sm-6">
...
?>
 ...
 <span class="vd_red">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2"><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"confirm_email"),$_smarty_tpl);?>
 <span class="vd_red">*</span></label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2"><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"select_applicable_per"),$_smarty_tpl);?>
 </label>
                                            <div class="vd_checkbox checkbox-info col-sm-2">
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['workflow_access_per_list']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
                                                    <input type="checkbox" name="sworkflow_per[]" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['access_per_id'];?>
...
?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading vd_bg-dark-green">
                    <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Active (<?php echo $_smarty_tpl->tpl_vars['active_user_count']->value;?>
) </a> </h4>
                </div>
                                        ...
                                        <table class="table table-bordered table-striped" id="active_data-table" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th ><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"emp_id"),$_smarty_tpl);?>
</th>
                                            ...
                                            <tbody>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['active_userlist']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?> 
                                                    <tr >
                                                        ...
                                                        <td ><?php echo $_smarty_tpl->tpl_vars['item']->value['organization'];?>
</td>
...
"><font  color="blue"><?php echo $_smarty_tpl->tpl_vars['item']->value['email'];?>
</font> </a></td>
                                                        <td class="menu-action">
                                                            <a data-original-title="Edit User Account" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"  href="?module=admin&action=update_user&update_user_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['user_id'];?>
"><i class="fa fa-pencil-square-o"></i></a>
                                                            <a data-original-title="Set Privilege" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_green"  href="?module=admin&action=permission_assign&upuserid=<?php echo $_smarty_tpl->tpl_vars['item']->value['user_id'];?>
"><i class="fa fa-key"></i></a>
                                                            <a data-original-title="Download PDF" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_red"  href="index.php?module=file&action=view_user_signup_file&signup_user_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['user_id'];?>
" onclick="window.open(this.href, 'mysignupwin','left=200,top=150,width=500,height=500,toolbar=1,resizable=0'); return false;"><i class="fa fa-pencil-square-o"></i></a>
                                                            <a data-original-title="Reset Password" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_green" href="?module=admin&action=reset_password&user_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['user_id'];?>
"><i class="fa fa-unlock-alt" ></i></a>
                                                            <?php if (!empty($_smarty_tpl->tpl_vars['item']->value['signup_object_id'])) {?>
                                                                <a data-original-title="View User Account" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"  href="?module=admin&action=view_signup&object_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['signup_object_id'];?>
...
?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading vd_bg-dark-green">
                    <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"> Disabled (<?php echo $_smarty_tpl->tpl_vars['inactive_user_count']->value;?>
) </a> </h4>
                </div>
                                ...
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        <table class="table table-bordered table-striped" id="inactive_data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['inactive_userlist']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
...
"><font  color="blue"><?php echo $_smarty_tpl->tpl_vars['item']->value['email'];?>
                                                        ...
                                                        <td class="menu-action">
                                                            <a data-original-title="Edit User Account" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"  href="?module=admin&action=update_user&update_user_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['user_id'];?>
"><i class="fa fa-pencil-square-o"></i></a>
                                                            <a data-original-title="Download PDF" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_red"  href="index.php?module=file&action=view_user_exit_file&exit_user_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['user_id'];?>
" onclick="window.open(this.href, 'mysignupwin','left=200,top=150,width=500,height=500,toolbar=1,resizable=0'); return false;"><i class="fa fa-pencil-square-o"></i></a>
                                                            <?php if (!empty($_smarty_tpl->tpl_vars['item']->value['exit_object_id'])) {?>
                                                                <a data-original-title="View User Account" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"  href="?module=admin&action=view_user_exit&object_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['exit_object_id'];?>
"><i class="fa fa-folder-open-o"></i></a>
                                                            <?php } else { ?>
