<?php
/* Smarty version 3.1.30, created on 2025-02-13 12:08:28
  from "/var/www/html/lm_qms/lib/dash/templates/analytics_dashboard.dash.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_67ad93646adb77_62434262',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '64620800583e47d130fe8e1c15c51baaa078bb49' => 
    array (
      0 => '/var/www/html/lm_qms/lib/dash/templates/analytics_dashboard.dash.tpl',
      1 => 1739428695,
      2 => 'file',
    ),
  ),
...
function content_67ad93646adb77_62434262 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
...
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
                                        <option value="<?php echo date('Y')-$_smarty_tpl->tpl_vars['i']->value;?>
"><?php echo date('Y')-$_smarty_tpl->tpl_vars['i']->value;?>
</option>
                                    <?php }
}
?>
...
" <?php if ($_smarty_tpl->tpl_vars['item']->value['plant_id'] == $_smarty_tpl->tpl_vars['userPlantId']->value) {?> selected
                                            <?php }?>>
...
>
        $(document).ready(function() {
            ...
            $('.refresh-dms').click(function() {
                ...
                $('#dmsPlantId').val('<?php echo $_smarty_tpl->tpl_vars['userPlantId']->value;?>
');
            ...
            $('.refresh-qms').click(function() {
                ...
                $('#qmsPlantId').val('<?php echo $_smarty_tpl->tpl_vars['userPlantId']->value;?>
');
            ...
            $(document).on('click', '.trending-button', function() {
                ...
                if (entity == 'dms') {
                    ...
                    var modules = <?php echo json_encode($_smarty_tpl->tpl_vars['dmsModules']->value);?>
;
                ...
                if (entity == 'qms') {
                    ...
                    var modules = <?php echo json_encode($_smarty_tpl->tpl_vars['qmsModules']->value);?>
;
