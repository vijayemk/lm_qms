<?php
/* Smarty version 3.1.30, created on 2024-09-28 12:55:06
  from "/inelplm/www/html/lm_qms_atul_22sep24/lib/ams/templates/search.ams.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_66f7fcaac13631_21788604',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a6eb5605f5f9a589079faca4df03b60c3c471387' => 
    array (
      0 => '/inelplm/www/html/lm_qms_atul_22sep24/lib/ams/templates/search.ams.tpl',
      1 => 1726295184,
      2 => 'file',
    ),
  ),
...
function content_66f7fcaac13631_21788604 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <form name="viewams-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="viewams-form">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-3">
...
?>
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"ams",'attribute'=>"am_no"),$_smarty_tpl);?>
</label>
                                        <div class="controls">
                                            ...
                                            <datalist id="ams_no_data_list">
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ams_no_list_completion']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
