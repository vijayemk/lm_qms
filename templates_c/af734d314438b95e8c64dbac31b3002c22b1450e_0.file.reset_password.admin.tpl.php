<?php
/* Smarty version 3.1.30, created on 2024-11-12 12:54:05
  from "/var/www/html/lm_qms/lib/admin/templates/reset_password.admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_67330295be8d46_25182739',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'af734d314438b95e8c64dbac31b3002c22b1450e' => 
    array (
      0 => '/var/www/html/lm_qms/lib/admin/templates/reset_password.admin.tpl',
      1 => 1537509146,
      2 => 'file',
    ),
  ),
...
function content_67330295be8d46_25182739 (Smarty_Internal_Template $_smarty_tpl) {
?>
                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="reset_pass" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="reset_pass-form" autocomplete="off">
 ...
 <span class="vd_red"></span></label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <input type="text" placeholder="Min 3 - Max 30" class="width-60 required" name="user_name" id="user_name" maxlength="30"  value="<?php echo $_smarty_tpl->tpl_vars['regobj']->value->user_name;?>
"  readonly required title="Enter Valid User Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
 ...
 <span class="vd_red">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <label class="control-label  col-sm-2"><span class="vd_red"></span></label>
                                        <div class="controls col-sm-6" ><p style="color:green">Note : <span> <b>New Password</b></span> will be sent to <?php echo $_smarty_tpl->tpl_vars['regobj']->value->email;?>
</p></div>
                                    </div>
