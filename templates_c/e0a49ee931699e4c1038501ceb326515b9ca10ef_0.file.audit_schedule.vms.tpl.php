<?php
/* Smarty version 3.1.30, created on 2024-10-01 09:20:10
  from "/inelplm/www/html/lm_qms_atul_22sep24/lib/vms/templates/audit_schedule.vms.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_66fbbecaec6819_77530339',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e0a49ee931699e4c1038501ceb326515b9ca10ef' => 
    array (
      0 => '/inelplm/www/html/lm_qms_atul_22sep24/lib/vms/templates/audit_schedule.vms.tpl',
      1 => 1727774384,
      2 => 'file',
    ),
  ),
...
function content_66fbbecaec6819_77530339 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
                                        ...
                                        <table class="table table-bordered table-striped generate_datatable" title="Vendor Audit List" data-ori="landscape" data-pagesize="A3" data-sort_column=1>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo template_get_attribute_name(array('module'=>"vms",'attribute'=>"audit_date_from"),$_smarty_tpl);?>
</th>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"vms",'attribute'=>"audit_date_to"),$_smarty_tpl);?>
</th>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"vms",'attribute'=>"auditor_details"),$_smarty_tpl);?>
</th>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"vms",'attribute'=>"auditee_details"),$_smarty_tpl);?>
</th>
                                            ...
                                            <tbody>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['vm_list']->value, 'item', false, 'key');
if ($_from !== null) {
...
?> 
                                                    <tr>
                                                        ...
                                                        <td><?php ob_start();
echo display_date_format(array('var'=>$_smarty_tpl->tpl_vars['item']->value['schedule_details']->audit_from_date),$_smarty_tpl);
$_prefixVariable1=ob_get_clean();
echo display_hypen_if_null(array('var'=>$_prefixVariable1),$_smarty_tpl);?>
</td>
                                                        <td><?php ob_start();
echo display_date_format(array('var'=>$_smarty_tpl->tpl_vars['item']->value['schedule_details']->audit_to_date),$_smarty_tpl);
$_prefixVariable2=ob_get_clean();
echo display_hypen_if_null(array('var'=>$_prefixVariable2),$_smarty_tpl);?>
</td>
                                                        <td class="text-nowrap">
                                                            <?php echo template_get_attribute_name(array('module'=>"vms",'attribute'=>"audit_lead"),$_smarty_tpl);?>
 : <?php echo display_hypen_if_null(array('var'=>$_smarty_tpl->tpl_vars['item']->value['audit_lead_name']),$_smarty_tpl);?>

                                                            <br> 
                                                            <?php echo template_get_attribute_name(array('module'=>"vms",'attribute'=>"auditor_details"),$_smarty_tpl);?>
 : 
                                                            <br>
                                                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['item']->value['auditors'], 'item1', false, 'key1');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key1']->value => $_smarty_tpl->tpl_vars['item1']->value) {
?> 
                                                                <?php echo $_smarty_tpl->tpl_vars['key1']->value+1;?>
.<?php echo $_smarty_tpl->tpl_vars['item1']->value['auditor_name'];?>
 [<?php echo $_smarty_tpl->tpl_vars['item1']->value['auditor_plant'];?>
] [<?php echo $_smarty_tpl->tpl_vars['item1']->value['auditor_dept'];?>
]
                                                                <br>
                                                            <?php
}
...
?>
                                                        ...
                                                        <td>
                                                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['item']->value['auditees'], 'item1', false, 'key1');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key1']->value => $_smarty_tpl->tpl_vars['item1']->value) {
?> 
                                                                <?php echo $_smarty_tpl->tpl_vars['key1']->value+1;?>
.<?php echo $_smarty_tpl->tpl_vars['item1']->value['auditee_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['item1']->value['auditee_email'];?>
    ...
    <div class="modal-dialog width-90">
        <div class="modal-content">
            ...
            <div class="modal-body pd-15">
                <form name="initiate_vendor-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="initiate_vendor-form" autocomplete="off">
                    ...
                    <div class="form-group">
                        <div class="col-md-2">
                            ...
                            <div class="controls">
                                <input type="text" name="vm_no" value="<?php echo $_smarty_tpl->tpl_vars['vm_no']->value;?>
" readonly  required title="Invalid VMS No">                                                
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="controls">
                                <select class="org" name="org" title="Select Valid Vendor">
                                    ...
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['organization_list']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
...
?>
 ...
 <span class="vd_red">*</span></th>
                                        <th class="col-md-1 pd-10"><?php echo template_get_attribute_name(array('module'=>'vms','attribute'=>"score_weightage"),$_smarty_tpl);?>
 <span class="vd_red">*</span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['agenda']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
                                        <tr>
                                            <td>
                                                <div class="vd_checkbox checkbox-danger">
                                                    <input type="checkbox" class="select_agenda" name="agenda_cat[]" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['object_id'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['item2']->value['sub_category'];?>
</option>
                                                    <?php
}
}
...
?>
                                            ...
                                            <td>
                                                <input type="number" class="cmn_ed score" name="score[]" min="1" max="100" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['category_score'];?>
" title="Enter Score" disabled>
                                            </td>
                                        </tr>
                                    <?php
}
