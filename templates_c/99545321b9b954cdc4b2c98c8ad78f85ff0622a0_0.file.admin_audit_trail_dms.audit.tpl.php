<?php
/* Smarty version 3.1.30, created on 2024-10-01 13:11:22
  from "/inelplm/www/html/lm_qms_atul_22sep24/lib/audit/templates/admin_audit_trail_dms.audit.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_66fbf4fa84f0f4_69648767',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '99545321b9b954cdc4b2c98c8ad78f85ff0622a0' => 
    array (
      0 => '/inelplm/www/html/lm_qms_atul_22sep24/lib/audit/templates/admin_audit_trail_dms.audit.tpl',
      1 => 1727081572,
      2 => 'file',
    ),
  ),
...
function content_66fbf4fa84f0f4_69648767 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div class="panel-heading vd_bg-dark-green vd_bd-green">
                    <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Audit Trial</a> </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <form name="view_audit" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="view_audit-form">
                            <div class="row">
                                <div class="col-md-3">
 ...
 <span class="vd_red">*</span></label>
                                    <div class="controls">
                                        <select class="width-100" name="audit_section" id="audit_section"  onchange="search_audit_trial();" >
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="controls">
                                        <select class="width-100" name="year" id="year" onchange=search_audit_trial();>
                                            <option value="">Select</option>
                                            <?php
...
?>
                                    ...
                                    <div class="controls">
                                        <select class="width-100" name="month" id="month" onchange=search_audit_trial();>
                                            <option value="">Select</option>
                                            <?php
...
?>
                                    ...
                                    <div class="controls">
                                        <select class="width-100"  name="userid" id="userid" onchange="search_audit_trial();"></select>
                                    </div>
                                </div>
                                <div class="col-md-3">
 ...
 type="text/javascript">
        ...
        function search_audit_trial() {
            ...
            if (audit_section == "business_object") {
                x_search_admin_audit_trial_type(audit_section, year, month, department, userid, date_from, date_to, list_audit_result1);
            }
