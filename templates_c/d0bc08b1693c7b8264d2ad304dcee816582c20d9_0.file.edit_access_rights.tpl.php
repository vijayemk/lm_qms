...
/* Smarty version 3.1.30, created on 2024-09-23 12:36:07
  from "/inelplm/www/html/lm_qms_atul_22sep24/templates/common/edit_access_rights.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_66f160b7849336_85524201',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd0bc08b1693c7b8264d2ad304dcee816582c20d9' => 
    array (
      0 => '/inelplm/www/html/lm_qms_atul_22sep24/templates/common/edit_access_rights.tpl',
      1 => 1716647689,
      2 => 'file',
    ),
  ),
...
function content_66f160b7849336_85524201 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="panel panel-default">
    <div class="panel-heading vd_bg-dark-green">
        <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse_edit_access">Edit Access Rights <i class="fa  fa-exclamation-triangle vd_white"></i></a> </h4>
    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-5">
                                    ...
                                    <div id="first-name-input-wrapper" class="controls">
                                        <select  title="Select Valid Company" onchange="get_dept_list(this.options[this.selectedIndex].value, '#from_dept', 'multiselect');">
...
<span class="vd_red">*</span></label>
                                    <div class="controls row">
                                        <div class="col-md-5">
                                            <select name="dept[]" id="from_dept" class="form-control generate_multiselect" size="10" multiple="multiple"></select>
                                        </div>
                                        <div class="col-md-1">
                                            <br><br><br>
                                        ...
                                        <div class="col-md-6">
                                            <select name="doc_access_dept[]" id="from_dept_to" class="form-control" size="10" multiple="multiple" title="Select valid Department">
                                                <?php
...
">
                            <div class="form-actions-condensed row mgbt-xs-0 text-right" >
                                <div class="col-sm-12">
                                    ...
                                    <button class="btn vd_bg-green vd_white" type="submit" id="edit_access_rights"><span class="menu-icon"><i class="fa fa-fw fa-edit"></i></span> Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            $(document).ready(function () {
                ...
                form_submit.validate({
                    ...
                    submitHandler: function (form) {
                        if (lm_validate.is_value_exist_in_array($("#from_dept_to").val(), $("#usr_dept_id").val(), 'Select Current User Department') && lm_validate.is_duplicate_value_exists_in_array($("#from_dept_to").val(), $("#from_dept_to"))) {
