<?php
/* Smarty version 3.1.30, created on 2024-10-26 17:45:08
  from "/var/www/html/lm_qms/lib/admin/templates/update_management_auth.admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_671cdd4c0560f5_19529473',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ca64f20a050dc4b53062539fa76f0bec1d2906a9' => 
    array (
      0 => '/var/www/html/lm_qms/lib/admin/templates/update_management_auth.admin.tpl',
      1 => 1634295054,
      2 => 'file',
    ),
  ),
...
function content_671cdd4c0560f5_19529473 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
        ...
        <div class="panel-group" id="accordion">  
            <div class="panel panel-default">
                <div class="panel-heading vd_bg-dark-green">
                    <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Update Management Authorization <?php echo $_smarty_tpl->tpl_vars['doc_short_name']->value;?>
 </a> </h4>
                </div>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-bordered table-striped" id="doc_data-tables">
                                            <thead>
                                                <tr>
                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['workflow_actionlist']->value, 'item', false, 'key');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['item']->value['action'];?>
</th>
                                                        <?php
}
}
...
?>
                                                        <td>
                                                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['auth_user_list']->value, 'item1', false, 'key1');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key1']->value => $_smarty_tpl->tpl_vars['item1']->value) {
?>
                                                                <?php if ($_smarty_tpl->tpl_vars['item']->value['action'] == $_smarty_tpl->tpl_vars['item1']->value['action']) {?>
                                                                    <?php echo $_smarty_tpl->tpl_vars['item1']->value['user_name'];?>
<br>
                                                                <?php }?>
                                                            <?php
}
...
?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        <form name="mgmt_auth_form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="mgmt_auth_form" autocomplete="off">
 ...
 <span class="vd_red">*</span></label>
                                                    <div id="first-name-input-wrapper"  class="controls col-sm-10">
                                                        <select class="width-60" name="workflow_action" id="workflow_action" onchange="get_doc_mgmt_auth_users();" title="Select Valid Action">
                                                            ...
                                                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['workflow_actionlist']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
                                                                <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['action'];?>
...
?>
                                            ...
                                            <div class="form-group">
                                                <div id="company-input-wrapper" class="controls col-sm-12"><br>
                                                    ...
                                                    <input name="doc_object_id" id ="doc_object_id" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['doc_object_id']->value;?>
">
                                                </div>
                                            </div>
                                            <div class="form-group">
