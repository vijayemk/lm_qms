<?php
/* Smarty version 3.1.30, created on 2024-11-16 14:59:34
  from "/var/www/html/lm_qms/lib/admin/templates/list_oos_check_list.admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_673865fe473c41_94687887',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fd1ff37737a0d70801e1bb054d2027b165fc48f7' => 
    array (
      0 => '/var/www/html/lm_qms/lib/admin/templates/list_oos_check_list.admin.tpl',
      1 => 1731749355,
      2 => 'file',
    ),
  ),
...
function content_673865fe473c41_94687887 (Smarty_Internal_Template $_smarty_tpl) {
?>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_checklist-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="add_checklist-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"check_points"),$_smarty_tpl);?>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['checklistList']->value)) {?>
                                        <table class="table table-bordered table-striped generate_datatable" title="Checklist list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"check_points"),$_smarty_tpl);?>
</th>                                                    
                                            ...
                                            <tbody>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['checklistList']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
...
?> 
                                                    <tr>
                                                        <td></td>
                                                        <td><?php echo $_smarty_tpl->tpl_vars['item']->value['checkPoints'];?>
</td>                                                        
                                                        <td ><span class="label label-<?php if ($_smarty_tpl->tpl_vars['item']->value['isEnabled'] == 'yes') {?>success<?php } else { ?>danger<?php }?>"><?php echo $_smarty_tpl->tpl_vars['item']->value['isEnabled'];?>
</span></td>
                                                        <td>
                                                            <button class="btn vd_bg-blue vd_white" data-toggle="modal" onclick="updateCheckList(<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['item']->value));?>
);"  data-target="#editCheckList"><i class="fa fa-pencil"></i></button>
                                                        </td> 
                                                    </tr>
                                                <?php
}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="edit_checklist-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="edit_checklist-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
