<?php
/* Smarty version 3.1.30, created on 2025-01-24 15:03:33
  from "/var/www/html/lm_qms/lib/dms/templates/search.dms.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_67935e6dd92a84_25862037',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c46065082cb2b11830affd46b4c9fea08b9f9982' => 
    array (
      0 => '/var/www/html/lm_qms/lib/dms/templates/search.dms.tpl',
      1 => 1726641734,
      2 => 'file',
    ),
  ),
...
function content_67935e6dd92a84_25862037 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
...
?>
                                ...
                                <div class="col-md-2">
                                    <div class="controls">
                                        <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"dms",'attribute'=>"dm_no"),$_smarty_tpl);?>
</label>
                                        <div class="controls">
                                            <input type="text" class="dm_no search_dms" list="dms_no_data_list">
                                            <datalist id="dms_no_data_list" class="dm_no">
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['dms_list']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item']->value) {
?>
...
?>
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"dms",'attribute'=>"start_date"),$_smarty_tpl);?>
 </label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"dms",'attribute'=>"end_date"),$_smarty_tpl);?>
 </label>
                                    <div class="controls">
                            ...
                            <div class="row mgbt-md-10">
                                <div class="col-md-2">
                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"dms",'attribute'=>"type"),$_smarty_tpl);?>
</label>
                                    <div class="controls">
...
?>
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"dms",'attribute'=>"approval_status"),$_smarty_tpl);?>
</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"dms",'attribute'=>"wf_status"),$_smarty_tpl);?>
</label>
                                    <div class="controls">
...
?>
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"dms",'attribute'=>"status"),$_smarty_tpl);?>
</label>
                                    <div class="controls">
