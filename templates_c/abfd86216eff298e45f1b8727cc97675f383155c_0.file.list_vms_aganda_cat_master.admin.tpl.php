<?php
/* Smarty version 3.1.30, created on 2024-10-26 10:34:17
  from "/var/www/html/lm_qms/lib/admin/templates/list_vms_aganda_cat_master.admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_671c7851680540_53425954',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'abfd86216eff298e45f1b8727cc97675f383155c' => 
    array (
      0 => '/var/www/html/lm_qms/lib/admin/templates/list_vms_aganda_cat_master.admin.tpl',
      1 => 1723888808,
      2 => 'file',
    ),
  ),
...
function content_671c7851680540_53425954 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_agenda_category-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="add_agenda_category-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"vm_category"),$_smarty_tpl);?>
                                                ...
                                                <div class="col-md-3">
                                                    <label class="control-label"><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"category_score"),$_smarty_tpl);?>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['category_list']->value)) {?>
                                        <table class="table table-bordered table-striped generate_datatable" title="Agenda category list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"vm_category"),$_smarty_tpl);?>
</th>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"description"),$_smarty_tpl);?>
</th>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"category_score"),$_smarty_tpl);?>
</th>
                                            ...
                                            <tbody>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['category_list']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
...
?> 
                                                    <tr>
                                                        ...
                                                        <td><?php echo $_smarty_tpl->tpl_vars['item']->value['category_score'];?>
</td>
                                                        ...
                                                        <td><button class="btn vd_bg-blue vd_white" data-toggle="modal" onclick="update_agenda_category(<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['item']->value));?>
);"  data-target="#edit_agenda_category"><i class="fa fa-pencil"></i></button></td>                                                        </tr>
                                                            <?php
}
}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="edit_agenda_category-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="edit_agenda_category-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
