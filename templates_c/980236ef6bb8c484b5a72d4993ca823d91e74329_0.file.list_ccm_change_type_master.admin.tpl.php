<?php
/* Smarty version 3.1.30, created on 2024-10-26 10:34:49
  from "/var/www/html/lm_qms/lib/admin/templates/list_ccm_change_type_master.admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_671c78711562f5_93566691',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '980236ef6bb8c484b5a72d4993ca823d91e74329' => 
    array (
      0 => '/var/www/html/lm_qms/lib/admin/templates/list_ccm_change_type_master.admin.tpl',
      1 => 1723887872,
      2 => 'file',
    ),
  ),
...
function content_671c78711562f5_93566691 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Change Type Master</li>
        </ul>
    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Add Change Type Master</a> </h4>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_change_type-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="add_change_type-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Min 2 - Max 40" class="required change_type" name="achange_type" id="achange_type" required title="Enter Valid Change Type">
                                                        <span class="change_type_exist font-semibold vd_red error_exists"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
 ...
 <span class="vd_red">*</span></label>
        ...
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Change Type Master List</a> </h4>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['changes_list']->value)) {?>
                                        <table class="table table-bordered table-striped generate_datatable" title="Change Type List">
                                            <thead>
                                                <tr>
                                                    <td><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"sl_no"),$_smarty_tpl);?>
</td>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"ccm",'attribute'=>"type"),$_smarty_tpl);?>
</th>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"ccm",'attribute'=>"description"),$_smarty_tpl);?>
</th>
                                                    <th><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"is_enabled"),$_smarty_tpl);?>
</th> 
                                                    <th><?php echo template_get_attribute_name(array('module'=>"ccm",'attribute'=>"action"),$_smarty_tpl);?>
</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['changes_list']->value, 'item', false, 'key', 'list', array (
));
if ($_from !== null) {
...
?> 
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary" data-toggle="modal" onClick="update_changes(<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['item']->value));?>
);"  data-target="#edit_change_type"><i class="fa fa-pencil"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php
}
...
<!-- Modal -->
<div class="modal fade" id="edit_change_type" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="myModalLabel">Edit Change Type Master</h4>
            </div>
            <div class="modal-body">
                <form name="edit_change_type-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="edit_change_type-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <div class="controls">
                                <input type="text" placeholder="Min 2 - Max 40" class="required change_type" name="uchange_type" id="uchange_type" required title="Enter Valid Change Type">
                                <span class="change_type_exist font-semibold vd_red error_exists"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
...
>
 ...
 type="text/javascript">
        $(document).ready(function () {
            "use strict";
            // Add Cahnge Type
            var form_submit = $('#add_change_type-form');
            ...
            form_submit.validate({
             ...
             // Edit Cahnge Type
            var form_submit = $('#edit_change_type-form');
            var error_register = $('.alert-danger', form_submit);
            form_submit.validate({
                errorElement: 'div', //default input error message container
                errorClass: 'vd_red', // default input error message class
            ...
            $(document).on('keyup', '.change_type', function () {
                let ele = $(this);
                ele.val(ele.val().toUpperCase());
                x_is_change_type_exist(ele.val(), function (result) {
