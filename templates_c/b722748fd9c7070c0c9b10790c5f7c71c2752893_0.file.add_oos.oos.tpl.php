<?php
/* Smarty version 3.1.30, created on 2024-11-26 09:17:54
  from "/var/www/html/lm_qms/lib/oos/templates/add_oos.oos.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_674544ea8f9e13_03437875',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b722748fd9c7070c0c9b10790c5f7c71c2752893' => 
    array (
      0 => '/var/www/html/lm_qms/lib/oos/templates/add_oos.oos.tpl',
      1 => 1732592872,
      2 => 'file',
    ),
  ),
...
function content_674544ea8f9e13_03437875 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
                        ...
                        <div class="panel-body">
                            <div class="vd_content-section clearfix">
                                ...
                                <div class="panel-body  panel-bd-left">
                                    <!-- Add OOS Form -->
                                    <form name="add-oos-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3"
                                                ...
                                                <label
                                                    class="control-label"><?php echo template_get_attribute_name(array('module'=>"oos",'attribute'=>"oos_no"),$_smarty_tpl);?>

                                                    <?php echo template_get_attribute_name(array('module'=>"oos",'attribute'=>"temporary_no"),$_smarty_tpl);?>
 <span
                                                        class="vd_red">*</span></label>
                                                <div class="controls">
                                                    <input type="text" placeholder="Temporary No" class="required"
                                                        name="oos_no" id="oos_no" value="<?php echo $_smarty_tpl->tpl_vars['oosNo']->value;?>
" required
                                            ...
                                            <div class="col-md-3">
                                                <label
                                                    class="control-label"><?php echo template_get_attribute_name(array('module'=>"oos",'attribute'=>"specification_no"),$_smarty_tpl);?>
<span
                                                        class="vd_red">*</span></label>
                                                <div class="controls">
                                            ...
                                            <div class="col-md-3">
                                                <label
                                                    class="control-label"><?php echo template_get_attribute_name(array('module'=>"oos",'attribute'=>"test_procedure_no"),$_smarty_tpl);?>
<span
                                                        class="vd_red">*</span></label>
                                                <div class="controls">
                                                    <input type="text" placeholder="Min 3 - Max 40" class="required"
                                            ...
                                            <div class="col-md-3">
                                                <label
                                                    class="control-label"><?php echo template_get_attribute_name(array('module'=>"oos",'attribute'=>"ar_no"),$_smarty_tpl);?>
<span
                                                        class="vd_red">*</span></label>
                                                <div class="controls">
                                                    <input type="text" placeholder="Min 3 - Max 40" class="required"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3"
                                                ...
                                                <label
                                                    class="control-label"><?php echo template_get_attribute_name(array('module'=>"oos",'attribute'=>"date_of_occurrence"),$_smarty_tpl);?>
                                            ...
                                            <div class="col-md-3"
                                                ...
                                                <label
                                                    class="control-label"><?php echo template_get_attribute_name(array('module'=>"oos",'attribute'=>"time_of_occurrence"),$_smarty_tpl);?>
                                            ...
                                            <div class="col-md-12">
                                                <table class="table table-bordered table-striped"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th width="25%">
                                                                <?php echo template_get_attribute_name(array('module'=>'oos','attribute'=>'test_name'),$_smarty_tpl);?>
<span
                                                                    class="vd_red">*</span></th>
                                                            <th width="30%">
                                                                <?php echo template_get_attribute_name(array('module'=>'oos','attribute'=>'specification_limit'),$_smarty_tpl);?>
<span
                                                                    class="vd_red">*</span></th>
                                                            <th width="40%">
                                                                <?php echo template_get_attribute_name(array('module'=>'oos','attribute'=>'obtained_result_remarks'),$_smarty_tpl);?>
<span
                                                                    class="vd_red">*</span></th>
                                                ...
                                                <div class="controls row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <select name="access_dept[]" id="from_dept_to" class="form-control" size="10" multiple="multiple" title="Select valid Department">
                                                            <option value="<?php echo $_smarty_tpl->tpl_vars['userPlantId']->value;?>
-<?php echo $_smarty_tpl->tpl_vars['userDepartmentId']->value;?>
" data-drop_down_value="<?php echo $_smarty_tpl->tpl_vars['userPlantId']->value;?>
-<?php echo $_smarty_tpl->tpl_vars['userDepartmentId']->value;?>
" selected><?php echo $_smarty_tpl->tpl_vars['userPlantName']->value;?>
 - [<?php echo $_smarty_tpl->tpl_vars['userDepartmentName']->value;?>
]</option>
                                                        </select>
                                                    </div>
                                                </div>
...
">
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['masterDataCreationAlert']->value) {?>
