<?php
/* Smarty version 3.1.30, created on 2024-10-26 10:41:54
  from "/var/www/html/lm_qms/lib/admin/templates/list_dms_dev_related_to_master.admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_671c7a1a96a357_64155344',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '39a473f5a4ba1480b0e324da994b3aba488703db' => 
    array (
      0 => '/var/www/html/lm_qms/lib/admin/templates/list_dms_dev_related_to_master.admin.tpl',
      1 => 1723888109,
      2 => 'file',
    ),
  ),
...
function content_671c7a1a96a357_64155344 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Deviation Related To Master</li>
        </ul>
    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Add Deviation Related To Master</a> </h4>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_dev_related_to-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="add_dev_related_to-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Min 2 - Max 40" class="required dev_related_to" name="adev_related_to" id="adev_related_to" required title="Enter Valid Deviation Related To">
                                                        <span class="dev_related_to_exist font-semibold vd_red error_exists"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
 ...
 <span class="vd_red">*</span></label>
        ...
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Deviation Related To Master List</a> </h4>
            </div>
                            ...
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['dev_related_to_list']->value)) {?>
                                        <table class="table table-bordered table-striped generate_datatable" title="Deviation related to list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th ><?php echo template_get_attribute_name(array('module'=>"admin",'attribute'=>"dm_desc"),$_smarty_tpl);?>
</th>
...
?> 
                                                    <tr >
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary" data-toggle="modal" onClick="update_dev_related_to(<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['item']->value));?>
);"  data-target="#edit_dev_related_to"><i class="fa fa-pencil"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php
}
...
<!-- Modal -->
<div class="modal fade" id="edit_dev_related_to" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="myModalLabel">Edit Deviation Related To Master</h4>
            </div>
            <div class="modal-body">
                <form name="edit_dev_related_to-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>
" class="form-horizontal" role="form" id="edit_dev_related_to-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <div class="controls">
                                <input type="text" placeholder="Min 2 - Max 40" class="required dev_related_to" name="udev_related_to" id="udev_related_to" required title="Enter Valid Deviation Related To">
                                <span class="dev_related_to_exist font-semibold vd_red error_exists"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
...
>
 ...
 type="text/javascript">
        $(document).ready(function () {
            "use strict";
            // Add Devaition realted to
            var form_submit = $('#add_dev_related_to-form');
            ...
            // Edit Devaition realted to
            var form_submit = $('#edit_dev_related_to-form');
            var error_register = $('.alert-danger', form_submit);
            form_submit.validate({
                errorElement: 'div', //default input error message container
                errorClass: 'vd_red', // default input error message class
            ...
            $(document).on('keyup', '.dev_related_to', function () {
                let ele = $(this);
                ele.val(ele.val().toUpperCase());
                x_is_dev_related_to_exist(ele.val(), function (result) {
                    ajax_respone_handler_value_exist(result, ele);
                });
            });
        });
        function update_dev_related_to(data) {
            $("#uobject_id").val(data.object_id);
            $("#udev_related_to").val(data.related_to);
