			...
			if (x == null) {
				...
				x.onreadystatechange = function() {
					...
					sajax_debug("received " + x.responseText);
                                        // We debugged what JSON object is being returned in the 
                                        // Ajax's onreadystatechange attribute of the XMLHttpRequest object
                                        // by alerting the responseText of the XMLHttpRequest object.
					var status;
					var data;
