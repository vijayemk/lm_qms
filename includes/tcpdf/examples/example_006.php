...
$html = '<p>Here i want to store aome text data with some image</p>

<table border="1" cellpadding="0" cellspacing="0" style="width:650px">
	<tbody>
		<tr>
			<td rowspan="2"><img alt="" src="http://localhost/lm_test/images/sop_images/stabicon-logo.png" style="height:50px; width:50px" /><strong>LogicMind,</strong></td>
		</tr>
		<tr>
			<td>Sheet No:</td>
		</tr>
...
// create some HTML content
$subtable = '<table border="1" cellspacing="0" cellpadding="0"><tr><td>a</td><td>b</td></tr><tr><td>c</td><td>d</td></tr></table>';
