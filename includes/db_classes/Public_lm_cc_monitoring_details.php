<?php
/**
 * Table Definition for public.lm_cc_monitoring_details
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_cc_monitoring_details extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_cc_monitoring_details';    // table name
