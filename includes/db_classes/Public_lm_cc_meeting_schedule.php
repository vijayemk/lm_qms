<?php
/**
 * Table Definition for public.lm_cc_meeting_schedule
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_cc_meeting_schedule extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_cc_meeting_schedule';    // table name
