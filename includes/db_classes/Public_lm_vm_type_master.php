<?php
/**
 * Table Definition for public.lm_vm_type_master
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_vm_type_master extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_vm_type_master';    // table name
