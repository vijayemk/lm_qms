<?php
/**
 * Table Definition for public.lm_capa_meeting_schedule
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_capa_meeting_schedule extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_capa_meeting_schedule';    // table name
    ...
    public $created_time;                   // varchar(-1) not_null
    public $modified_by;                    // varchar(-1) not_null
    public $modified_time;                  // varchar(-1) not_null
