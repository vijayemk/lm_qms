<?php
/**
 * Table Definition for public.lm_dev_related_to_master
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_dev_related_to_master extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_dev_related_to_master';    // table name
