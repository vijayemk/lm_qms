<?php
/**
 * Table Definition for public.user_signup
 */
require_once 'DB/DataObject.php';

class DB_Public_user_signup extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.user_signup';    // table name
