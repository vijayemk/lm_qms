<?php
/**
 * Table Definition for public.lm_cc_task_details
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_cc_task_details extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_cc_task_details';    // table name
    public $object_id;                      // varchar(-1) not_null unique_key primary_key
    public $cc_object_id;                   // varchar(-1) not_null
