<?php
/**
 * Table Definition for public.lm_sop_online_exam_user_details
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_sop_online_exam_user_details extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_sop_online_exam_user_details';    // table name
