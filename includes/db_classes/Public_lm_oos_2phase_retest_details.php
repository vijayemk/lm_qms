<?php
/**
 * Table Definition for public.lm_oos_2phase_retest_details
 */
require_once 'DB/DataObject.php';

class DB_Public_lm_oos_2phase_retest_details extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'public.lm_oos_2phase_retest_details';    // table name
    ...
    public $retesting_description;          // text(-1)
    public $error_type_id;                  // varchar(-1)
    public $error_classification_id;        // varchar(-1)
