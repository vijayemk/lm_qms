                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row mgbt-md-10">
                                <div class="col-md-2">
                                    ...
                                    <div class="controls">
                                        <select class="plant search_oos show_oos_no">
                                            ...
                                            {foreach name=list item=item key=key from=$plantLists}
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"> {attribute_name module="oos" attribute="department"}</label>
                                    <div class="controls">
                                        <select class="dept search_oos show_oos_no">
                                            <option value="">All</option>
                                            {foreach name=list item=item key=key from=$departmentLists}
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"> {attribute_name module="oos" attribute="user_name"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <div class="controls">
                                        <label class="control-label">{attribute_name module="oos" attribute="oos_no"}</label>
                                        <div class="controls">
                                            <input type="text" class="oos_no search_oos" list="oos_no_data_list" style="height: 30px;">
                                            <datalist id="oos_no_data_list" class="oos_no">
                                                {foreach name=list item=item key=key from=$oosList}
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="oos" attribute="start_date"} </label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="oos" attribute="end_date"} </label>
                                    <div class="controls">
                            ...
                            <div class="row mgbt-md-10">
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="oos" attribute="type"}</label>
                                    <div class="controls">
                                        <select class="dm_type search_oos">
                                            <option value="">All</option>
                                            {foreach name=list item=item key=key from=$devTypeList}
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="oos" attribute="classification"}</label>
                                    <div class="controls">
                                        <select class="classification search_oos">
                                            <option value="">All</option>
                                            {foreach item=item key=key from=$classificationLists}
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="oos" attribute="approval_status"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="oos" attribute="wf_status"}</label>
                                    <div class="controls">
                                        <select class="wf_status search_oos">
                                            <option value="">All</option>
                                            {foreach name=list item=item key=key from=$workFlowStatus}
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="oos" attribute="status"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="controls">
                                        <select class="mat_type search_oos">
                                            <option value="">All</option>
                                            {foreach name=list item=item key=key from=$materialTypeLists}
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="controls">
                                        <select class="pro_stage search_oos">
                                            <option value="">All</option>
                                            {foreach name=list item=item key=key from=$processStageLists}
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="controls">
                                        <select class="pro_name search_oos">
                                            <option value="">All</option>
                                            {foreach name=list item=item key=key from=$productLists}
