...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Change Control Management</li>
        </ul>
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                <h2 class="mgbt-xs-20">{$cc_no}</h2>
                                <form name="cc_timeline-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="cc_timeline-form" autocomplete="off">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="ccm" attribute="cc_no"} <span class="vd_red">*</span></label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-5">
                                                <select class="width-60" name="cc_no" id="cc_no" onchange = addList('cc_object_id',this.options[this.selectedIndex].value); required title="Select Valid CC Number">
                                                    <option value="">Select</option>
                                                    {foreach name=list item=item key=key from=$cc_list}
                                                        <option value="{$item.cc_object_id}" {if $cc_object_id eq $item.cc_object_id} selected {/if}>{$item.cc_no}</option>
                                                    {/foreach}
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="vd_content-section clearfix">
                                                    ...
                                                    <ul class="vd_timeline">
                                                            ...
                                                            <li class="tl-item">
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left">
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{$dept_approver_image}">
                                                                        ...
                                                                        <span class="vd_soft-grey">{$dept_approved_date_time} </span>
                                                                        <div class="clearfix mgbt-xs-10"></div>
                                                                ...
                                                                <li class="tl-item">
                                                                    ...
                                                                    <div class="tl-label panel widget light-widget panel-bd-left">
                                                                        <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{$item.reviewer_image}">
                                                                            ...
                                                                            <div class="clearfix mgbt-xs-10"></div>
                                                                            <div class="tl-action"> <a role="button" class="btn btn-sm btn-xs mgr-10" href="javascript:void(0)"><i class="fa fa-comment fa-fw"></i>CFT Comment</a> </div>
                                                                            <hr class="mgtp-0"/>
                                                                            <div class="comments">
                                                                                <div class="content-list content-image">
                                                                                    <ul class="list-wrapper no-bd-btm">
                                                                                        {foreach name=list item=item1 key=key1 from=$item.reviewer_remarks} 
                                                                                            <li>
                                                                                                <div class="menu-text">{$item1.remarks}
                                                                                                </div>
                                                                                            </li>
                                                                                        {/foreach}
                                                                                    </ul>
                                                        ...
                                                        {else}
                                                            <li class="tl-item">
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left">
                                                                    <div class="panel-body"> 
                                                                        <h3 class="mgtp-10 mgbt-xs-5"> <span class="vd_red">CFT Details Not Available</span></h3>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        {/if}
                                                            ...
                                                            <li class="tl-item">
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left">
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{$approver_image}">
                                                                        ...
                                                                        <hr class="mgtp-0"/>
                                                                        <div class="comments"><div class="mgtp-10 text-right"><span class="vd_green mgtp-10 text-right">{$meeting_status} </span></div>
                                                                            <div class="content-list content-image">
                                                                                <ul class="list-wrapper no-bd-btm">
                                                            ...
                                                            <li class="tl-item">
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left">
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{$creator_image}">
                                                                        ...
                                                                        <hr class="mgtp-0"/>
                                                                        <div class="panel-body">
                                                                            <span class="vd_soft-black"><b>Meeting Date : </b>{$meeting_date_time}<br> <b>Meeting Time : </b>{$meeting_time} <br> <b>Venue : </b>{$meeting_venue} </span>
                                                                            <div class="mgtp-10 text-right"><span class="vd_green mgtp-10 text-left">{$meeting_status} </span></div>
                                                                            <div class="clearfix mgbt-xs-10"></div>
                                                                            <div class="tl-action"> <a role="button" class="btn btn-sm btn-xs mgr-10" href="javascript:void(0)"><i class="fa fa-users fa-fw"></i>Attendees </a> </div>
                                                                            <hr class="mgtp-0"/>
                                                                            <div class="comments">
                                                                                <div class="content-list content-image">
                                                                                    <ul class="list-wrapper no-bd-btm">
                                                                                        {foreach name=list item=item key=key from=$attendee_details} 
                                                                                            <li>
                                                                                                <div class="menu-text">{$item.attendee} - [{$item.department}]</div>
                                                                                            </li>
                                                                                        {/foreach}
                                                                                    </ul>
                                                                                </div>
                                                            ...
                                                            <li class="tl-item">
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left">
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{$creator_image}">
                                                                        <h3 class="mgtp-10 mgbt-xs-5"> {$creator_name} <em class="vd_soft-grey font-sm">{$creator_dept}</em> </h3>
                                                                        <div class="clearfix mgbt-xs-10"></div>
                                                                        <div class="tl-action"> <a role="button" class="btn btn-sm btn-xs mgr-10" href="javascript:void(0)"><i class="fa fa-comment fa-fw"></i>MOM Details</a> </div>
                                                                        <hr class="mgtp-0"/>
                                                                        <div class="comments">
                                                                            <div class="content-list content-image">
                                                                                <ul class="list-wrapper no-bd-btm">
                                                                                    <table class="table table-bordered table-striped" id="data-tables-mom_details">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th>{attribute_name module="ccm" attribute="identified_activity"}</th>
                                                                                                <th>{attribute_name module="ccm" attribute="responsible_person"}</th>
                                                                                                <th>{attribute_name module="ccm" attribute="target_date"}</th>
                                                                                                <th>{attribute_name module="ccm" attribute="completion_date"}</th>
                                                                                                <th>{attribute_name module="ccm" attribute="status"}</th>
                                                                                            </tr>
                                                                                        </thead>
                                                                                        <tbody>
                                                                                            {foreach name=list item=item key=key from=$mom_details}
                                                                                                <tr>
                                                                                                    <td><a href="index.php?module=ccm&action=update_ccm_mom_details&object_id={$item.object_id}" target='_blank'><font color=blue>{$item.identified_activity}</font></a></td>
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left">
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{$trainer_image}">
                                                                        ...
                                                                        <div class="comments">
                                                                            <div class="content-list content-image">
                                                                                <ul class="list-wrapper no-bd-btm">
                                                                                    {foreach name=list item=item key=key from=$training_details} 
                                                                                        <li>
                                                                                            <div class="menu-text">{$item.attendee} - [{$item.department}]</div>
                                                                                        </li>
                                                                                    {/foreach}
                                                                    ...
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{$approver_image}">
                                                                        ...
                                                                        <div class="comments">
                                                                            <div class="content-list content-image">
                                                                                <ul class="list-wrapper no-bd-btm">
                                                                                    <li>
                                                                                        <div class="menu-text"><b>Change Follow Up : </b>{$change_follow_up}</div><br>
                                                                        ...
                                                                        <div class="comments">
                                                                            <div class="content-list content-image">
                                                                                <table class="table table-bordered table-striped" id="data-tables-extension_details">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th width="5%">{attribute_name module="ccm" attribute="s_no"}</th>
                                                                                            <th width="5%">{attribute_name module="ccm" attribute="existing_target_date"}</th>
                                                                                            <th width="5%">{attribute_name module="ccm" attribute="proposed_target_date"}</th>
                                                                                            <th width="5%">{attribute_name module="ccm" attribute="reason"}</th>
                                                                                            <th width="5%">{attribute_name module="ccm" attribute="status"}</th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            {foreach name=list item=item key=key from=$cc_extension_details}
                                                                                                <td>
                                                                                                    {$item.count}
                                                                                                </td>
                                                                                                <td>
                                        ...
                                        {else}
                                            <div class="col-md-12">
                                                <div class="panel widget light-widget">
                                                    <div class="panel-body">
                                                        <h2 class="mgbt-xs-20 mgtp-10"><strong>Select Valid CC Number</strong></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        {/if}
