                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row mgbt-md-10">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label"> {attribute_name module="ccm" attribute="user_name"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <div class="controls">
                                        <label class="control-label">{attribute_name module="ccm" attribute="cc_no"}</label>
                                        <div class="controls">
                                            <input type="text" class="ccm_no search_ccm" list="ccm_no_data_list">
                                            <datalist id="ccm_no_data_list" class="ccm_no">
                                                {foreach name=list item=item key=key from=$ccm_list}
                            ...
                            <div class="row mgbt-md-10">
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="type"}</label>
                                    <div class="controls">
                                        <select class="change_type search_ccm">
                                            <option value="">All</option>
                                            {foreach name=list item=item key=key from=$ccm_type_list}
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="classification"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="approval_status"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="wf_status"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="status"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="material_type"}</label>
                                    <div class="controls">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="processing_stage"}</label>
                                    <div class="controls">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">{attribute_name module="ccm" attribute="product_name"}</label>
                                    <div class="controls">
                        ...
                        <table class="table table-bordered table-striped generate_datatable search_result_table" title="Search CCM" data-whitespace="nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>{attribute_name module="ccm" attribute="cc_no"}</th>
                                    <th>{attribute_name module="admin" attribute="plant_name"}</th>
                                    <th>{attribute_name module="ccm" attribute="department"}</th>
                                    <th>{attribute_name module="ccm" attribute="created_by"}</th>
                                    <th>{attribute_name module="ccm" attribute="classification"}</th>
                                    <th>{attribute_name module="ccm" attribute="target_date"}</th>
                                    <th>{attribute_name module="ccm" attribute="close_out_date"}</th>
                                    <th>{attribute_name module="ccm" attribute="completed_date"}</th>
                                    <th>{attribute_name module="ccm" attribute="approval_status"}</th>
                                    <th>{attribute_name module="ccm" attribute="wf_status"}</th>
