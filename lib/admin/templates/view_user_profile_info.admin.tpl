                                            ...
                                            <div class="col-sm-12">
                                                <div class="panel widget light-widget">
                                                  <div class="panel-heading no-title"> </div>
                                                    <form name="update_profile" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="update_profile-form" autocomplete="off">
                                                        <div  class="panel-body">
                                                            <h2 class="mgbt-xs-20"> Profile: <span class="font-semibold">{$full_name}</span> </h2>
                                                            <br/>
                                                            <div class="row">
                                                                <div class="col-sm-3 mgbt-xs-20">
                                                                    <div class="form-group1">
                                                                        <div class="col-xs-12">
                                                                            <div class="form-img text-center mgbt-xs-15"> <img alt="image" src="{$user_image}"> </div>
                                                                            ...
                                                                            <div>
                                                                                <table class="table table-striped table-hover">
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td >Status</td>
                                                                                            {if $account_status eq "enable"}
                                                                                                <td><span class="label label-success">Active</span></td>
                                                                                            {/if}
                                                                                            {if $account_status eq "disable"}
                                                                ...
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                              <div class="col-xs-9">
                                                                                    <input type="text" value="{$user_name}" readonly placeholder="username">
                                                                              </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" value="{$emp_id}" readonly placeholder="Employee Id">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" value="{$department}" readonly placeholder="Department">
                                                                            </div>
                                                                          </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" value="{$designation}" readonly placeholder="Designation">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" value="{$organization}" readonly placeholder="Organization">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" value="{$user_plant}" readonly placeholder="Company Name">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-9 controls">
                                                                        <div class="row mgbt-xs-0">
                                                                            <div class="col-xs-9">
                                                                                <input type="text" value="{$email}" readonly placeholder="email@yourcompany.com">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-sm-3 control-label">{attribute_name module=admin attribute=mothers_maiden_name}</label>
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" name="mothers_maiden_name" id="mothers_maiden_name" maxlength="40" value="{$mothers_maiden_name}" required placeholder="Min 3 - Max 40" title="Enter Valid Mothers Maiden Name">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" name="dob" id="dob" maxlength="10" value="{$dob}" readonly required placeholder="DD/MM/YYYY" title="Enter Valid Date of Birth">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="col-sm-3 control-label">{attribute_name module=admin attribute=place_of_birth}</label>
                                                                        <div class="col-sm-9 controls">
                                                                            <div class="row mgbt-xs-0">
                                                                                <div class="col-xs-9">
                                                                                    <input type="text" name="place_of_birth" id="place_of_birth" maxlength="40" value="{$place_of_birth}" required placeholder="Min 3 - Max 40" title="Enter Valid Place of Birth">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="vd_content-section clearfix">
                            <div class="panel widget light-widget">
                                <div class="panel-body">
                                    ...
                                    <form name="reset_password" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="reset_password-form" autocomplete="off">
                                        <div class="alert alert-danger vd_hidden">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                                <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                                          </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="current_password"} <span class="vd_red">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="newpassword"} <span class="vd_red">*</span></label>
                                                <div id="company-input-wrapper" class="controls col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="retypenewpassword"} <span class="vd_red">*</span></label>
                                                <div id="company-input-wrapper" class="controls col-sm-6">
