                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_inst_equip_dtls-form" method="POST" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_inst_equip_dtls-form" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-5">
                                                        <label class="control-label">{attribute_name module="admin" attribute="type"} <span class="vd_red">*</span></label>
                                                        <div class="controls">
                                                            <select class="inst_equip_type" name="ainst_equip_type" id="ainst_equip_type"  title="Select Valid  Type">
                                                                <option value="">Select</option>
                                                                {foreach name=list item=item key=key from=$inst_equip_type_list}
                                                                    <option value="{$item.object_id}">{$item.inst_equip_type}</option>
                                                                {/foreach}
                                                            </select>                                                  
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row" id="sub_category_parent_div">
                                                <div class="child_ele form-group" >
                                                    <div class="col-md-5 mgtp-10 ">
                                                        <label class="control-label">{attribute_name module="admin" attribute="inst_equip_id"} </label><span class="vd_red">*</span>
                                                        <div class="controls">
                                                    ...
                                                    <div class="col-md-6 mgtp-10 ">
                                                        <label class="control-label title">{attribute_name module="admin" attribute="inst_equip_name"} </label><span class="vd_red">*</span>
                                                        <div class="controls">
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if !empty($inst_equip_details_list)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Instrument/Equipment Master Data">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{attribute_name module="admin" attribute="inst_equip_id"}</th>
                                                    <th>{attribute_name module="admin" attribute="inst_equip_name"}</th>
                                                    <th>{attribute_name module="admin" attribute="is_enabled"}</th>
                                                    <th>{attribute_name module="admin" attribute="action"}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {foreach name=list item=item key=key from=$inst_equip_details_list} 
                                                    <tr>
                                                        <td></td>
                                                        <td>{$item.inst_equip_type}</td>
                                                        <td>{$item.inst_equip_id}</td>
                                                        <td>{$item.inst_equip_name}</td>
                                                        <td ><span class="label label-{if $item.is_enabled eq yes}success{else}danger{/if}">{$item.is_enabled}</span></td>
                                                        <td><button class="btn vd_bg-blue vd_white" data-toggle="modal" onclick="update_inst_equip_details({htmlspecialchars(json_encode($item))});"  data-target="#edit_inst_equip_dtls"><i class="fa fa-pencil"></i></button></td>
                                                    </tr>
                                                {/foreach}
                                            </tbody>
                                        </table>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="edit_inst_equip_dtls-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_inst_equip_dtls-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <label class="control-label">{attribute_name module="admin" attribute="is_active"} <span class="vd_red">*</span></label>
                            <div class="controls">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <div class="col-md-6 mgtp-10 ">
                                <label class="control-label">{attribute_name module="admin" attribute="inst_equip_name"} </label><span class="vd_red">*</span>
                                <div class="controls">
