                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="operation" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="access_per_object-form" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="object_name"} <span class="vd_red">*</span></label>
                                ...
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        <table class="table table-bordered table-striped" id="data-tables">
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$access_permission_list} 
                                                    <tr >
                                                        <td>{$item->name}</td>
