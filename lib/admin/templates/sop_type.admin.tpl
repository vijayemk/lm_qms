                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="soptypes" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="sop_type-form" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="sop_type"} <span class="vd_red">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="sop_desc"} <span class="vd_red"></span></label>
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        {if !empty($soptypelistdetails)}
                                            <table class="table table-bordered table-striped" id="sop_type_data-tables">
                                                <thead>
                                                    <tr>
                                                        <th >{attribute_name module="admin" attribute="sop_type"}</th>
                                                        <th >{attribute_name module="admin" attribute="sop_desc"}</th>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$soptypelistdetails} 
                                                        <tr >
                                                            <td>{$item.type}</td>
                                                            ...
                                                            <td ><button class="btn btn-primary" data-toggle="modal" onclick="set_usop_type('{$item.object_id}','{$item.type}','{$item.description}')"  data-target="#edit-sop_type"><i class="fa fa-pencil"></i></button></td>
                                                        </tr>
                                                    {/foreach}
                                                </tbody>
                                            </table>
...
<div class="modal fade" id="edit-sop_type" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form name="edit_sop_type-form" id="edit_sop_type-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="is_enabled"} <span class="vd_red">*</span></label>
                            <div id="first-name-input-wrapper"  class="controls col-sm-10">
