...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Vendor Score</li>
        </ul>
    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Add Vendor Score </a> </h4>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_vendor_score-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_vendor_score-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label">{attribute_name module="admin" attribute="score"} <span class="vd_red">*</span></label>
                                                    <div class="controls">
                                                        <input type="text"  class="required" value="{$vms_score}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="control-label">{attribute_name module="admin" attribute="change_to"} <span class="vd_red">*</span></label>
                                                    <div class="controls">
                                                        <select class="required" required name="uscore" id="uscore" title="Select Score">
                                                            {foreach name=list item=item key=key from=$score_range}
                                                                <option value="{$item}"{if $item eq $vms_score}selected{/if}>{$item}</option>
                                                            {/foreach}
                                                        </select>                                        
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if isset($vms_score_remarks)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Vendor score history list">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$vms_score_remarks} 
                                                    <tr >
                                                        <td></td>
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            "use strict";
            // Add vendor score
            var form_submit = $('#add_vendor_score-form');
