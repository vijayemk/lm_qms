                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_change_type-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_change_type-form" autocomplete="off">
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$changes_list} 
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary" data-toggle="modal" onClick="update_changes({htmlspecialchars(json_encode($item))});"  data-target="#edit_change_type"><i class="fa fa-pencil"></i></button>
                                                        </td>
                                                    </tr>
                                                {/foreach}
                                            </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="edit_change_type-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_change_type-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
