    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Add Unit of Measurements</a> </h4>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_unit-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_unit-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Min 2 - Max 50" class="required unit_type" name="aunit_type" id="aunit_type" required title="Enter Valid Type">
                                                        <span class="unit_exist font-semibold vd_red error_exists"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Unit of Measurements List</a> </h4>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if !empty($unit_of_measurement_details)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Unit of measurement list">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$unit_of_measurement_details} 
                                                    <tr>
                                                        <td></td>
                                                        <td>{$item.type}</td>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary" data-toggle="modal" onClick="update_unit_details({htmlspecialchars(json_encode($item))});"  data-target="#edit_unit"><i class="fa fa-pencil"></i></button>
                                                        </td>
                                                    </tr>
                                                {/foreach}
                                            </tbody>
...
<!-- Modal -->
<div class="modal fade" id="edit_unit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="myModalLabel">Edit Unit of Measurements</h4>
            </div>
            <div class="modal-body">
                <form name="edit_unit-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_unit-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
                            <label class="control-label">{attribute_name module="admin" attribute="type"}</label> <span class="vd_red">*</span>
                            <div class="controls">
                                <input type="text" placeholder="Min 2 - Max 50" class="required unit_type" name="uunit_type" id="uunit_type" required title="Enter Valid Type">
                                <span class="unit_exist font-semibold vd_red error_exists"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var form_submit = $('#edit_unit-form');
            var error_register = $('.alert-danger', form_submit);
            form_submit.validate({
                errorElement: 'div', //default input error message container
                errorClass: 'vd_red', // default input error message class
            ...
            $(document).on('keyup', '.unit_type', function () {
                let ele = $(this);
                //ele.val(ele.val().toUpperCase());
                x_is_unit_type_exist(ele.val(), function (result) {
