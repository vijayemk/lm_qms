                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_dev_related_to-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_dev_related_to-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    <label class="control-label">{attribute_name module="ccm" attribute="type"} </label><span class="vd_red">*</span>
                                                    <div class="controls">
                                        ...
                                        <table class="table table-bordered table-striped generate_datatable" title="Deviation related to list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th >{attribute_name module="admin" attribute="dm_desc"}</th>
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$dev_related_to_list} 
                                                    <tr >
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary" data-toggle="modal" onClick="update_dev_related_to({htmlspecialchars(json_encode($item))});"  data-target="#edit_dev_related_to"><i class="fa fa-pencil"></i></button>
                                                        </td>
                                                    </tr>
                                                {/foreach}
                                            </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="edit_dev_related_to-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_dev_related_to-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
