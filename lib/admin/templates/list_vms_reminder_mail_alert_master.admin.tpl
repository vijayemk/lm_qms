...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Reminder Mail Alert</li>
        </ul>
    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Add Reminder Mail Alert </a> </h4>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_mail_alert-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_mail_alert-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label">{attribute_name module="admin" attribute="current_setting"} <span class="vd_red">*</span></label>
                                                    <div class="controls">
                                                        <input type="text"  class="required" value="{$vm_expiry_reminder_mail_days}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="control-label">{attribute_name module="admin" attribute="change_to"} <span class="vd_red">*</span></label>
                                                    <div class="controls">
                                                        <select class="required" required name="umail_alert" id="umail_alert" title="Select Days">
                                                            {foreach name=list item=item key=key from=$days_range}
                                                                <option value="{$item}"{if $item eq $vm_expiry_reminder_mail_days}selected{/if}>{$item}</option>
                                                            {/foreach}
                                                        </select>                                        
                                                    </div>
                                                </div>
                            ...
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if !empty($remarks_array)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Remainder mail history list">
                                            <thead>
                                                <tr>
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            "use strict";
            // Add reminder mail days
            var form_submit = $('#add_mail_alert-form');
