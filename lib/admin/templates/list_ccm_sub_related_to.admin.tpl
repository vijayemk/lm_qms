...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Changes Sub Related To Master</li>
        </ul>
    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Add Changes Sub Related To Master</a> </h4>
            </div>
                                                    ...
                                                    <div class="controls">
                                                        <select class="required related_to" name="arelated_to" id="arelated_to"  required title="Select Valid Type">
                                                            ...
                                                            {foreach item=item key=key from=$related_to}
                                                                <option value="{$item.object_id}">{$item.related_to}</option>
                                                            {/foreach}
                                                        </select>                                                  
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group" id="sub_category_parent_div">
                                                <div class="child_ele form-group" >
                                                    <div class="col-md-5 mgtp-10 ">
                                                        <label class="control-label">{attribute_name module="ccm" attribute="cc_sub_related_to"}</label> <span class="vd_red">*</span>
                                                        <div class="controls">
        ...
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Changes Sub Related To Master List</a> </h4>
            </div>
                            ...
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if !empty($sub_rel_list)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Changes sub related to list">
                                            <thead>
                                                <tr>
                                                    <td>{attribute_name module="admin" attribute="sl_no"}</td>
                                                    <th >{attribute_name module="ccm" attribute="changes_in"}</th>
                                                    <th >{attribute_name module="ccm" attribute="cc_sub_related_to"}</th>
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$sub_rel_list} 
                                                    <tr >
                                                        <td></td>
                                                        <td>{$item.related_to_name}</td>
                                                        <td>{$item.sub_related_to_name}</td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                ...
                <h4 class="modal-title" id="myModalLabel">Edit Changes Sub Related To Master</h4>
            </div>
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('keyup', '.sub_related_to', function () {
                ...
                if (ele.closest('form').find('.related_to').val() == "") {
                    show_notification("e","topright","Select Realted To");
                    $(this).val("");
                } else {
                    ele.val(ele.val().toUpperCase());
                    var related_to = $(this).closest('form').find(".related_to :selected").val();
                    x_is_cc_sub_category_exist(related_to, ele.val(), function (result) {
        ...
        function update_sub_related_to(data) {
            ...
            $("#usub_related_to").val(data.sub_related_to_name);
