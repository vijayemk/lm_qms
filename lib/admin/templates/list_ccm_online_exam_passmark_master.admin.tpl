                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_exam_pass_mark-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_exam_pass_mark-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label">{attribute_name module="admin" attribute="current_passmark"} <span class="vd_red">*</span></label>
                                                    <div class="controls">
                                                        <input type="text"  class="required" value="{$cc_passmark}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="controls">
                                                        <select class="required" required name="upassmark" id="upassmark" title="Select Mark">
                                                            {foreach name=list item=item key=key from=$mark_range}
                                                                <option value="{$item}"{if $item eq $cc_pass_mark}selected{/if}>{$item}</option>
                                                            {/foreach}
                                                        </select>                                        
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if isset($cc_passmark_remarks)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Online exam pass mark history list">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$cc_passmark_remarks} 
                                                    <tr >
                                                        <td></td>
