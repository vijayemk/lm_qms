                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="add_designation-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_designation-form" autocomplete="off">
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$designationlist} 
                                                        <tr >
                                                            ...
                                                            <td ><button class="btn btn-primary" data-toggle="modal" onclick="set_udesi('{$item->designation_id}','{$item->designation_name}','{$item->full_name}');"  data-target="#edit-desi"><i class="fa fa-pencil"></i></button></td>
                                                        </tr>
                                                    {/foreach}
                                                </tbody>
                                            </table>
...
<div class="modal fade" id="edit-desi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form name="edit_designation-form" id="edit_designation-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" autocomplete="off">
