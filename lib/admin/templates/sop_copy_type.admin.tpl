                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="sopcopytypes" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="copy_type-form" autocomplete="off">
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        {if !empty($sopprintcopytypelistdetails)}
                                            <table class="table table-bordered table-striped" id="pdf_print_copy_data-tables">
                                                <thead>
                                                    <tr>
                                                        <th >{attribute_name module="admin" attribute="sop_copy_type"}</th>
                                                        <th >{attribute_name module="admin" attribute="sop_copy_type_color"}</th>
                                                        <th >{attribute_name module="admin" attribute="sop_copy_desc"}</th>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$sopprintcopytypelistdetails} 
                                                        <tr >
                                                            <td>{$item.copy_type}</td>
                                                            <td style="background-color:{$item.copy_type_color}"></td>
                                                            <td>{$item.description}</td>
                                                            <td>{$item.creator}</td>
                                                            <td>{$item.created_time}</td>
                                                            <td >
                                                                <a href="index.php?module=admin&action=edit_sop_copy_type&object_id={$item.object_id}" class="btn btn-primary"> <i class="fa fa-pencil"></i></a>
                                                            </td>
                                                        </tr>
                                                    {/foreach}
                                                </tbody>
