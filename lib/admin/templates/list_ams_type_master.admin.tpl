...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Audit Type Master</li>
        </ul>
    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Add Audit Type Master</a> </h4>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="modal-wide-width">
                                <div class="modal-content">
                                    ...
                                    <div class="panel-body">    
                                        <form name="add_audit_type_to-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_audit_type_to-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Min 2 - Max 50" class="required am_type" name="aam_type" id="aam_type" required title="Enter Valid Type">
                                                        <span class="audit_type_exist font-semibold vd_red error_exists"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading vd_bg-dark-green">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Audit Type Master List</a> </h4>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if !empty($amtypelist)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Audit type list">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$amtypelist} 
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn vd_bg-blue vd_white" data-toggle="modal" onclick="update_audit_type({htmlspecialchars(json_encode($item))});"  data-target="#edit-type"><i class="fa fa-pencil"></i></button>
                                                        </td>
                                                    </tr>
                                                {/foreach}
                                            </tbody>
...
<!-- Modal -->
<div class="modal fade" id="edit-type" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="myModalLabel">Edit Audit Type Master</h4>
            </div>
            <div class="modal-body">
                <form name="edit_audit_type_to-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_audit_type_to-form" autocomplete="off">
                    <div class="alert alert-danger vd_hidden">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
                            <label class="control-label">{attribute_name module="admin" attribute="am_type"} </label><span class="vd_red">*</span>
                            <div class="controls">
                                <input type="text" placeholder="Min 2 - Max 50" class="required am_type" name="uam_type" id="uam_type" required title="Enter Valid Type">
                                <span class="audit_type_exist font-semibold vd_red error_exists"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            "use strict";
            // Add audit_type
            var form_submit = $('#add_audit_type_to-form');
            ...
            //Edit audit_type
            var form_submit = $('#edit_audit_type_to-form');
            var error_register = $('.alert-danger', form_submit);
            form_submit.validate({
                errorElement: 'div', //default input error message container
                errorClass: 'vd_red', // default input error message class
            ...
            $(document).on('keyup', '.am_type', function () {
                let ele = $(this);
                ele.val(ele.val().toUpperCase());
                x_is_audit_type_exists(ele.val(), function (result) {
                    ajax_respone_handler_value_exist(result, ele);
                });
            });
        });
        function update_audit_type(data) {
            $("#uobject_id").val(data.object_id);
            $("#uam_type").val(data.type);
