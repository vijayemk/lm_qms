...
<div class="panel widget">
    <div class="panel-heading vd_bg-grey">
        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-magic"></i> </span>  Account Deactivation Request </h3>
    </div>
                                ...
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        ...
                                        <form name="user_exit" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="user_exit-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <label class="control-label  col-sm-2">{attribute_name module=admin attribute=default_role} <span class="vd_red">*</span></label>
                                                    <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                        <input type="text" class="width-60 required" name="default_role" id="default_role" required readonly value="{$role}" title="Enter Valid Role">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                        <input type="text" class="width-60 required" name="email" id="email" required readonly value="{$email}" title="Enter Valid Role">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-md-6 mgbt-xs-10 mgtp-20">
                                                ...
                                                <div class="mgtp-10">
                                                  <button class="btn vd_bg-green vd_white" type="submit"  name="exit_request" onClick="return validation();">Submit</button>
                                                </div>
                                              </div>
