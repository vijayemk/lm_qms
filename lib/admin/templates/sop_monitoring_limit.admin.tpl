        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div class="panel-heading vd_bg-dark-green">
                    <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> SOP Monitoring Limit </a> </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                <h2 class="mgbt-xs-20">Limits of SOP Monitoring Setting Form</h2>
                                <form name="monitoring_limit_form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="monitoring_limit_form" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="current_limit"}</label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <input type="text" class="width-60" name="cmonitoring_limit" value="{$sop_monitoring_limit}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <input type="number" class="width-60" name="umonitoring_limit" min="1" value="{$sop_monitoring_limit}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="controls col-sm-8" ><p style="color:green">Note : This changes will takes effect only from now onwards</p></div>
                                    </div>          
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        {if isset($sop_monitoring_limit_remarks)}
                                            <table class="table table-bordered table-striped" id="sop_monitoring_limit_history_data-table">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$sop_monitoring_limit_remarks} 
                                                        <tr >
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#sop_monitoring_limit_history_data-table').dataTable( {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            "use strict";
            var form_submit = $('#monitoring_limit_form');
