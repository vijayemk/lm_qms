                            ...
                            <div class="panel widget light-widget">
                                <div class="panel-body">
                                    ...
                                    <form name="org-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="org-form" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="org_short_name"} <span class="vd_red">*</span></label>
                        ...
                        <div class="vd_content-section clearfix">
                            <div class="panel widget light-widget">
                                <div class="panel-body">
                                    ...
                                    <form name="plant-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="plant-form" autocomplete="off" enctype="multipart/form-data">
                                        <div class="alert alert-danger vd_hidden">
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                            <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="logo"} <span class="vd_red">*</span></label>
                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="add_department_form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_department_form" autocomplete="off">
                                    <div class="alert alert-danger vd_hidden">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                        <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> Change a few things up and try submitting again.
                                    </div>
                                            ...
                                            <table class="table table-bordered table-striped" id="org_data-tables">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{attribute_name module="admin" attribute="contact_number"}</th>
                                                        <th>{attribute_name module="admin" attribute="email"}</th>
                                                        <th>{attribute_name module="admin" attribute="website"}</th>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$orglist}
                                                        <tr >
                                                            ...
                                                            <td >{$item->email}</td>
                                                            <td >{$item->website}</td>
                                                            <td class="menu-action"><a data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"  href="?module=admin&action=update_org&object_id={$item->org_id}"><i class="fa fa-pencil"></i></a></td>
                                                        </tr>
                                                    {/foreach}
                                                </tbody>
                                            </table>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$plantlist}
                                                        <tr >
                                                            ...
                                                            <td >{$item.contact_number}</td>
                                                            <td >{$item.email}</td>
                                                            <td class="menu-action"><a data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"  href="?module=admin&action=update_plant&object_id={$item.plant_id}"><i class="fa fa-pencil"></i></a></td>
                                                        </tr>
                                                    {/foreach}
                                                </tbody>
                                            </table>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$deptlist}
                                                        <tr >
                                                            ...
                                                            <td ><button class="btn btn-primary" data-toggle="modal" onclick="set_udept('{$item.department_id}','{$item.department_code}','{$item.department}','{$item.full_name}','{$item.plant_id}');"  data-target="#edit-dept"><i class="fa fa-pencil"></i></button></td>
                                                        </tr>
                                                    {/foreach}
                                                </tbody>
                                            </table>
...
<div class="modal fade" id="edit-dept" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form name="edit_department_form" id="edit_department_form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" autocomplete="off">
