                    ...
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                ...
                                <form name="pass_expiry_setting-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="pass_expiry_setting-form" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="current_setting"} (Days) <span class="vd_red">*</span></label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <input type="text" class="width-60 required" name="current_expiry" value="{$current_expiry}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <table class="table table-bordered table-striped" id="pass_expiry_history_data-tables">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{attribute_name module="admin" attribute="changed_from"} Days</th>
                                                        <th>{attribute_name module="admin" attribute="changed_to"} Days</th>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$pass_expiry_remarks} 
                                                        <tr >
