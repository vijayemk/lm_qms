                                        ...
                                        <form name="add_exam_attempt_limit-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="add_exam_attempt_limit-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text"  class="required" value="{$cc_exam_attempt_limit}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="controls">
                                                        <select class="required" required name="uattempt_limit" id="uattempt_limit" title="Select Limit">
                                                            {foreach name=list item=item key=key from=$limit_range}
                                                                <option value="{$item}"{if $item eq $cc_exam_attempt_limit}selected{/if}>{$item}</option>
                                                            {/foreach}
                                                        </select>                                        
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel widget">
                                <div class="panel-body table-responsive">
                                    {if isset($cc_exam_limit_remarks)}
                                        <table class="table table-bordered table-striped generate_datatable" title="Online exam attempt history limit">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$cc_exam_limit_remarks} 
                                                    <tr >
                                                        <td></td>
