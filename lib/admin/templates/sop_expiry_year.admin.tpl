...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Expiry Year </li>
        </ul>
        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div class="panel-heading vd_bg-dark-green">
                    <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> SOP Expiry </a> </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                <h2 class="mgbt-xs-20">SOP Expiry Year Setting Form</h2>
                                <form name="expiry-year-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="expiry_year_form" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="current_sop_expiry_year"} <span class="vd_red">*</span></label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <input type="text" class="width-60 required" name="sop_expiry_year_config" value="{$sop_expiry_year}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <select class="width-60" name="expiry_year" id="expiry_year" title="Select Year" required>
                                                    {foreach name=list item=item key=key from=$year_range}
                                                        <option value="{$item}"{if $item eq $sop_expiry_year}selected{/if}>{$item}</option>
                                                    {/foreach}
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="controls col-sm-8" ><p style="color:green">Note : This changes will takes effect only for SOP's which will be authorized from now onwards</p></div>
                                    </div>          
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        {if isset($sop_expiry_remarks)}
                                            <table class="table table-bordered table-striped" id="sop_expiry_history_data-tables">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$sop_expiry_remarks} 
                                                        <tr >
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#sop_expiry_history_data-tables').dataTable( {
                ...
                buttons: [
                    'pageLength',
                    {
                        ...
                        message: 'SOP Expiry History List',
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            "use strict";
            var form_submit = $('#expiry_year_form');
