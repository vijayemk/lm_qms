...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Exam Passmark </li>
        </ul>
        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div class="panel-heading vd_bg-dark-green">
                    <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> SOP Online Exam Passmark </a> </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="vd_content-section clearfix">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                <h2 class="mgbt-xs-20">Pass Mark Setting Form</h2>
                                <form name="passmark_form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="passmark_form" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">{attribute_name module="admin" attribute="current_passmark"}</label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <input type="text" class="width-60" name="cexam_passmark_limit" value="{$sop_pass_mark}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <select class="width-60" name="usop_pass_mark" id="usop_pass_mark" title="Select Mark" required>
                                                    {foreach name=list item=item key=key from=$mark_range}
                                                        <option value="{$item}"{if $item eq $sop_pass_mark}selected{/if}>{$item}</option>
                                                    {/foreach}
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-body table-responsive">
                                        {if isset($sop_passmark_remarks)}
                                            <table class="table table-bordered table-striped" id="sop_passmark_history_data-table">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$sop_passmark_remarks} 
                                                        <tr >
...
{literal}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#sop_passmark_history_data-table').dataTable( {
                ...
                buttons: [
                    'pageLength',
                    {
                        ...
                        message: 'Online Exam Passmark History List',
