<?php
/**
 * Defines the attributes for user_profile
 * Project:     LogicMind
...
class UserProfile extends DB_Public_user_profile 
{
               /** Attributes */
/**
...
/**
* represents the father name of the User
* @var string
*/
    var  $father_name;

/**
* represents the birth date of the User
* @var date
*/
    var  $dob;
