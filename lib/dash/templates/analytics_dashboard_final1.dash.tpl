...
<script src="plugins/dom-to-image/dom-to-image.min.js"></script>
                        ...
                        <div id="dashboard-tab" class="tab-pane active">
                            <div class="pd-20">
                                ...
                                {foreach from=$docGroups item=item}
                                    <div class="dash_template" id="{$item.group}Dash" data-doc_group="{$item.group}" data-doc_group_id="{$item.id}">
                                        <div class="row ">
                                            <div class="col-sm-5">
                                                <div class="panel widget">
                                                    ...
                                                    <div class="panel-body pieChart-{$item.group}"  style="display: block;">
