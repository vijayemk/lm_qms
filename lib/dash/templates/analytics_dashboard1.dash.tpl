        ...
        <div class="tabs">
            ...
            <div class="tab-content  mgbt-xs-20" style="background-color: #F0F0F0;">
                <div class="tab-pane active" id="dashboard-tab">
                    {foreach from=$docGroups item=item key=key name=name}
                        <div class="row dashboard-analytics" data-doc-group="{$item.group}" data-doc-id="{$item.id}">
                            <div class="col-sm-5">
                                        ...
                                        <div class="panel vd_transaction-widget light-widget widget"
                                            ...
                                            <div class="panel-body" style="padding-bottom: 0;">
                                                ...
                                                <h5 class="mgbt-xs-0 mgtp-0">
                                                    ...
                                                    <strong id="{$item.group}Title"></strong>
                                                </h5>
                                                <div id="pie-chart-{$item.group}" class="pie-chart"
                                                ...
                                                <div class="vd_info br">
                                                    ...
                                                    <h3 class="text-right  vd_red {$item.group}-total-total"></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-7">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-black">
                                        ...
                                        <div class="vd_panel-menu" style="display: flex; align-items: center;">
                                            ...
                                            <div style="margin-right: 5px;">
                                                <select class="selectpicker module" id="module-{$item.group}" multiple data-style="bootstarp-select-custom-style" data-actions-box="true" data-selected-text-format="count" data-none-selected-text="Modules Not Selected">
                                                </select>
                                            </div>
                                            <div style="margin-right: 5px;">
                                                <select class="width-100 cursor year-from" id="year-from-{$item.group}">
                                                    
                                                </select>
                                            </div>
                                            <div style="margin-right: 5px;">
                                                <select class="width-100 cursor year-to" id="year-to-{$item.group}">
                                                    
                                                </select>
                                            </div>
                                            <div style="margin-right: 5px;" a>
                                                <select class="width-100 cursor plant-id" id="plant-id-{$item.group}">
                                                    <option value="">ALL PLANT</option>
                                                    {foreach from=$plants item=item key=key}
                                                        <option value="{$item.plant_id}" {if $item.plant_id eq $userPlantId }
                                                            selected {/if}>
                                            ...
                                            <div>
                                                <select class="cursor department-id" id="department-id-{$item.group}" style="width:200px;">
                                    ...
                                    <div class="panel-body" style="display: block;min-height: 423px;">
                                        <div class="panel widget">
                                            <div class="panel-body-list  table-responsive {$item.group}-table">
                            ...
                            <div class="panel widget">
                                <div class="panel-heading vd_bg-black">
                                    ...
                                    <div class="vd_panel-menu chart-location" style="display: flex; align-items: center;" data-chart-location="tab">
                                        {* <div data-action="refresh" data-original-title="Refresh" data-toggle="tooltip" data-placement="bottom" class="menu entypo-icon smaller-font refresh-tab">
                                            <i class="icon-cycle"></i>
                                        </div> *}
                                        <div style="margin-right: 5px;">
