                ...
                <div class="tabs widget">
                    ...
                    <div class="tab-content" style="background-color: #F0F0F0;border-top: none;">
                        <div id="dashboard-tab" class="tab-pane active">
                            <div class="pd-20">
                                <input type="hidden" id="userPlantId" value="{$userPlantId}">
                                {foreach from=$docGroups item=item}
                                    <div class="row dash_template" id="{$item.group}Dash" data-doc_group="{$item.group}" data-doc_group_id="{$item.id}">
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <div class="panel widget">
                                                    <div class="panel-heading vd_bg-grey">
                                                        <h3 class="panel-title"> <span class="menu-icon"><i class="icon-pie"></i></span>{$item.group} CHART</h3>
                                                    </div>
                                                        ...
                                                        <div class="panel vd_transaction-widget light-widget widget" style="box-shadow:none; margin-bottom:0;">
                                                            <div class="panel-body" style="padding-bottom: 0;">
                                                                ...
                                                                <h5 class="mgbt-xs-0 mgtp-0">
                                                                    ...
                                                                    <strong id="{$item.group}YearTitle">Current Year Data</strong>
                                                                </h5>
                                                                <div id="pie-chart-{$item.group}" class="pie-chart" style="height: 350px; padding: 0px; position: relative;">
                                                                ...
                                                                <div class="vd_info br">
                                                                    <h5 class="text-right font-semibold"><strong>TOTAL {$item.group}</strong></h5>
                                                                    <h3 class="text-right vd_red Total{$item.group}"></h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-7">
                                                <div class="panel widget">
                                                    <div class="panel-heading vd_bg-grey">
                                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-layout"></i> </span> {$item.group} TABLE</h3>
                                                        <div class="vd_panel-menu" style="display: flex;">
                                                            <div data-action="refresh" data-original-title="Refresh" data-toggle="tooltip" data-placement="bottom" class=" menu entypo-icon smaller-font refreshTable" id="refresh-{$item.group}"><i class="icon-cycle"></i></div>
                                                            <div style="margin-right: 5px;margin-bottom: 5px;">
                                                                <select class="selectpicker ModuleFilter" id="{$item.group}ModuleFilter"  multiple data-style="bootstarp-select-custom-style" data-actions-box="true" data-selected-text-format="count" data-none-selected-text="Modules Not Selected">
                                                                </select>
                                                            </div>
                                                            <div style="margin-right: 5px;">
                                                                <select class="YearFrom" style="padding: 2px;" id="{$item.group}YearFrom"></select>
                                                            </div>
                                                            <div style="margin-right: 5px;">
                                                                <select class="YearTo" style="padding: 2px;" id="{$item.group}YearTo"></select>
                                                            </div>
                                                            <div style="margin-right: 5px;">
                                                                <select class="PlantId" id="{$item.group}PlantId" onchange="get_plant_dept_list(this.options[this.selectedIndex].value, '#{$item.group}DepartmentId', '', '', 'All Department');" style="padding: 2px;">
                                                                    <option value="">All Plant</option>
                                                                    {foreach from=$plants item=item key=key}
                                                                        <option value="{$item.plant_id}" {if $item.plant_id eq $userPlantId } selected {/if}>{$item.short_name}</option>
                                                                    {/foreach}
                                                                </select>
                                                            </div>
                                                            <div>
                                                                <select class="DepartmentId" id="{$item.group}DepartmentId" style="padding: 2px;">
                                                    ...
                                                    <div class="panel-body" style="display: block;min-height: 423px;">
                                                        <div class="panel widget">
                                                            <div class="panel-body-list table-responsive {$item.group}-table"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="modal-body pd-15">
                <div class="form-group panel-body">
                    <div class="row mgbt-md-12">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="controls">
                                <select class="module reset_filter show_filter_icon">
                                    {foreach name=list item=item key=key from=$docGroups}
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="controls">
                                <select class="plant reset_filter sub_module_filter show_filter_icon" onchange="get_plant_dept_list(this.options[this.selectedIndex].value, '.dept', '', '', 'All Department');">
                                    <option value="">All</option>
                                    {foreach name=list item=item key=key from=$plants}
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="controls">
                                <select class="dept reset_filter sub_module_filter show_filter_icon">
                                    <option value="">All Department</option>
                                    {foreach name=list item=item key=key from=$departments}
                                        <option value="{$item.department_id}">{$item.drop_down_option}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <label class="control-label">{attribute_name module="dash" attribute="start_year"} </label>
                            <div class="controls">
                                <select class="required start_date reset_filter sub_module_filter show_filter_icon" id="start_date"></select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">{attribute_name module="dash" attribute="end_year"} </label>
                            <div class="controls">
...
{literal}
    <script>
        $(document).ready(function () {
            $('#trending-dashboard').on('click', function () {
                ...
                trendingChartDashboard($('#dashboardEntity').val(), $('#dashboardModule').val(), $('#dashboardYearFrom').val(), $('#dashboardYearTo').val(), $('#dashboardPlantId').val(), $('#dashboardChart').val(), $('#dashboardXaxes').val());
            });
            ...
            $('#dashboardXaxes').on('change', function () {
                trendingChartDashboard($('#dashboardEntity').val(), $('#dashboardModule').val(), $('#dashboardYearFrom').val(), $('#dashboardYearTo').val(), $('#dashboardPlantId').val(), $('#dashboardChart').val(), $(this).val());
            });

            $('#dashboardChart').on('change', function () {
                trendingChartDashboard($('#dashboardEntity').val(), $('#dashboardModule').val(), $('#dashboardYearFrom').val(), $('#dashboardYearTo').val(), $('#dashboardPlantId').val(), $(this).val(), $('#dashboardXaxes').val());
            });
            ...
            $('#dashboardYearFrom').on('change', function () {
                trendingChartDashboard($('#dashboardEntity').val(), $('#dashboardModule').val(), $(this).val(), $('#dashboardYearTo').val(), $('#dashboardPlantId').val(), $('#dashboardChart').val(), $('#dashboardXaxes').val());
            });

            $('#dashboardYearTo').on('change', function () {
                trendingChartDashboard($('#dashboardEntity').val(), $('#dashboardModule').val(), $('#dashboardYearFrom').val(), $(this).val(), $('#dashboardPlantId').val(), $('#dashboardChart').val(), $('#dashboardXaxes').val());
            });

            $('#dashboardPlantId').on('change', function () {
                trendingChartDashboard($('#dashboardEntity').val(), $('#dashboardModule').val(), $('#dashboardYearFrom').val(), $('#dashboardYearTo').val(), $(this).val(), $('#dashboardChart').val(), $('#dashboardXaxes').val());
            });
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            async function processDashTemplate() {
                const module_status = {};
                const promises = [];
                $('.dash_template').each(function () {
                    ...
                    let promise = new Promise((resolve) => {
                        ...
                        x_search_view("dash", 'dash_modules', [docGroup.toLowerCase(), docGroupId], function (modules_list) {
                            ...
                            $.each(modules_list, function (index, mod_val) {
                                let moduleObj = {lm_doc_id: mod_val[0], module: mod_val[1], status_count: []};
                                ...
                                let statusPromise = new Promise((statusResolve) => {
                                    x_search_view("dash", 'dash_module_statuses', [docGroup], function (status_list) {
                                        ...
                                        let from_year = $(this).find('#' + docGroup + 'YearFrom').val();
                                        let to_year = $(this).find('#' + docGroup + 'YearTo').val();

                                        // Fetch module-specific status count
                                        x_search_view("dash", 'dash_modules_status_count', [docGroup, lm_doc_id], function (status_count_list) {
                            ...
                            // ✅ Use await instead of Promise.all().then(resolve)
                            Promise.all(modulePromises).then(resolve);
                        });
                    });
                ...
                //console.log("Updated module_status:", JSON.stringify(module_status, null, 2));
            ...
            $('#trendingChart').on('change', function () {
                trendingChart(entity, $('#trendingModule').val(), $('#trendingYear1').val(), $('#trendingYear2').val(), $('#trendingPlantId').val(), $(this).val());
            });

            $('#trendingModule').on('change', function () {
                trendingChart(entity, $(this).val(), $('#trendingYear1').val(), $('#trendingYear2').val(), $('#trendingPlantId').val(), $('#trendingChart').val());
            });

            $('#trendingYear1').on('change', function () {
                trendingChart(entity, $('#trendingModule').val(), $(this).val(), $('#trendingYear2').val(), $('#trendingPlantId').val(), $('#trendingChart').val());
            });

            $('#trendingYear2').on('change', function () {
                trendingChart(entity, $('#trendingModule').val(), $('#trendingYear1').val(), $(this).val(), $('#trendingPlantId').val(), $('#trendingChart').val());
            });

            $('#trendingPlantId').on('change', function () {
                trendingChart(entity, $('#trendingModule').val(), $('#trendingYear1').val(), $('#trendingYear2').val(), $(this).val(), $('#trendingChart').val());
            });
            ...
            function trendingChart(entity, businessModule, year1, year2, plantId, chartType) {
                $('#trendingTitle').fadeOut().fadeIn().text(businessModule + " Trending Analytics of " + year1 + " and " + year2);
        ...
        function populateFilter(docName, docGroup, docGroupId, yearFrom, yearTo, plantId, departmentId, status) {
            ...
            if (yearTo)
                $('.start_date').val(yearTo);
            if (yearFrom)
                $('.end_date').val(yearFrom);
            if (plantId)
                $('.plant').val(plantId);
            if (departmentId) {
