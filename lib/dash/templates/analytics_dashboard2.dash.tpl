                        ...
                        <div id="dashboard-tab" class="tab-pane active">
                            <div class="pd-20">
                                {foreach from=$docGroups item=item}
                                    <div class="row dash_template" id="{$item.group}Dash" data-doc_group="{$item.group}"
                                        data-doc_group_id="{$item.id}">
                                        <div class="row">
                                            <div class="col-sm-5">
                                                        ...
                                                        <div class="panel vd_transaction-widget light-widget widget"
                                                            ...
                                                            <div class="panel-body" style="padding-bottom: 0;">
                                                                ...
                                                                <h5 class="mgbt-xs-0 mgtp-0">
                                                                    ...
                                                                    <strong id="{$item.group}YearTitle">Current Year
                                                                        Data</strong>
                                                                </h5>
                                                ...
                                                <div class="panel widget">
                                                    <div class="panel-heading vd_bg-grey">
                                                        <h3 class="panel-title"> <span class="menu-icon"> <i
                                                                    class="icon-layout"></i> </span> {$item.group} TABLE
                                                        </h3>
                                                        <div class="vd_panel-menu" style="display: flex;">
                                                            <div data-action="refresh" data-original-title="Refresh"
                                                                ...
                                                                id="refresh-{$item.group}">
                                                                <i class="icon-cycle"></i>
                                                            </div>

                                                            <div style="margin-right: 5px;margin-buttom: 5px;">
                                                            <select class="selectpicker ModuleFilter" id="{$item.group}ModuleFilter"  multiple data-style="bootstarp-select-custom-style" data-actions-box="true" multiple data-selected-text-format="count" data-none-selected-text="Modules Not Selected">
                                                                    
                                                          </select>
                                                            </div>
                                                            <div style="margin-right: 5px;">
                                                                <select class="width-100 YearTo" style="padding: 2px;"
                                                                    id="{$item.group}YearTo">
                                                                </select>
                                                            </div>
                                                            <div style="margin-right: 5px;">
                                                                <select class="width-100 YearFrom" style="padding: 2px;"
                                                                    id="{$item.group}YearFrom">
                                                                </select>
                                                            </div>
                                                            <div style="margin-right: 5px;">
                                                                <select class="width-100 PlantId" id="{$item.group}PlantId" onchange="get_plant_dept_list(this.options[this.selectedIndex].value, '#{$item.group}DepartmentId', '', '', 'All Department');"
                                                                    style="padding: 2px;">
                                                            ...
                                                            <div>
                                                                <select class="width-100 DepartmentId"
                                                                    id="{$item.group}DepartmentId" style="padding: 2px;">
                                                    ...
                                                    <div class="panel-body" style="display: block;min-height: 423px;">
                                                        <div class="panel widget">
                                                            <div
                                                                class="panel-body-list  table-responsive {$item.group}-table">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.refreshTable').click(function() {
                ...
                {/literal}
                    $('#'+docGroup+'PlantId').val('{$userPlantId}');
                {literal}  
