    ...
    <div class="panel widget">
        <div class="panel-body">
            <div class="panel-group" id="accordion">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="tab_pri_dtls">
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="am_no"}</div>
                                                            <input type="text" readonly value="{$am_no}">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="scheduled_by"}</div>
                                                            <input type="text" readonly value="{$sch_by} [{$sch_by_plant}] [{$sch_by_dept}]">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="scheduled_date"}</div>
                                                            <input type="text" readonly value="{display_date var=$am_schedule_obj->schedule_time}">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="assigned_by"}</div>
                                                            <input type="text" readonly value="{$assigned_by} [{$sch_by_plant}] [{$sch_by_dept}]">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="assigned_date"}</div>
                                                            <input type="text" readonly value="{display_date var=$am_schedule_obj->assigned_date}">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="audit_lead"}</div>
                                                            <input type="text" readonly value="{$audit_lead} [{$audit_lead_plant}] [{$audit_lead_dept}]">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="qa_approval_status"}</div>
                                                            <input type="text" readonly value="{$am_schedule_obj->approval_status}">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="status"}</div>
                                                            <input type="text" readonly value="{$am_schedule_obj->status}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="input-border pd-10 col-md-12">
                                                                <div class="col-sm-6 pd-0">
                                                                    ...
                                                                    <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $am_schedule_obj->is_meeting_required eq yes}checked{/if} readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="audit_plant"}</div>
                                                            <input type="text" readonly value="{$audit_plant}">
                                                        </div>
                                                        {if $audit_dept}
                                                            <div class="col-sm-3">
                                                                <div class="form-label font-semibold">{attribute_name module="ams" attribute="audit_dept"}</div>
                                                                <input type="text" readonly value="{$audit_dept}">
                                                            </div>
                                                        {/if}
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="am_type"}</div>
                                                            <input type="text" readonly value="{$audit_type_name}">
                                                            <input type="hidden" class="audit_type_id" readonly value="{$am_schedule_obj->audit_type_id}">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="am_sub_type"}</div>
                                                            <input type="text" readonly value="{$audit_sub_type}">
                                                            <input type="hidden" class="audit_sub_type_id" readonly value="{$am_schedule_obj->audit_sub_type_id}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="audit_date_from"}</div>
                                                            <input type="text" readonly value="{display_date var=$am_schedule_obj->from_date}">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="audit_date_to"}</div>
                                                            <input type="text" readonly value="{display_date var=$am_schedule_obj->to_date}">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="no_of_audit_days"}</div>
                                                            <input type="text" readonly value="{$am_schedule_obj->no_of_days}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="desc"}</div>
                                                            <textarea rows="3" >{display_if_null var=$am_schedule_obj->description}</textarea>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="scope"}</div>
                                                            <textarea rows="3" >{display_if_null var=$am_schedule_obj->scope}</textarea>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="objectives"}</div>
                                                            <textarea rows="3" >{display_if_null var=$am_schedule_obj->objectives}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <table class="table table-bordered table-striped generate_datatable" title="Review comments" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>{attribute_name module="ams" attribute="date"}</th>
                                                                    <th>{attribute_name module="ams" attribute="review_comments"}</th>
                                                                    <th>{attribute_name module="ams" attribute="user_name"}</th>
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    {if !empty($audit_findings_review)}
                                                        <table class="table table-bordered table-striped generate_datatable" title="Review comments" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                            ...
                                                            <tbody>
                                                                {foreach name=list item=item key=key from=$audit_findings_review}
                                                                    <tr>
                                                                        <td></td>
                                                                        <td>{$item.date_time}</td>
                                                                        <td>{$item.remarks}</td>
                                    ...
                                    <div class="tab-pane" id="tab_audit_schedule">
                                            ...
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="scope"}</div>
                                                            <textarea rows="3" readonly>{display_if_null var=$am_schedule_obj->scope}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-label font-semibold">{attribute_name module="ams" attribute="objectives"}</div>
                                                            <textarea rows="3" readonly>{display_if_null var=$am_schedule_obj->objectives}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    {if !empty($ams_aduit_agenda_list)}
                                                        <table class="table table-bordered table-hover input-border mgbt-md-20 generate_datatable" title="Audit Agenda" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                                    <th class="col-md-10">{attribute_name module="ams" attribute="agenda"}</th>
                                                                    <th class="col-md-2">{attribute_name module="ams" attribute="auditor"}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                {foreach item=item key=key from=$ams_aduit_agenda_list}
                                                                    <tr>
                                                                        <td>{$key+1}</span></td>
                                                                        <td>{$item.agenda}</td>
                                                                        <td>{display_if_null var=$item.auditor_name}</td>
                                                                    </tr>
                                                                {/foreach}
                                                            </tbody>
                                                        </table>
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    {if !empty($ams_aduit_plan_list)}
                                                        <div class="audit_plan_table_div audit_plan_toggle">
                                                            <table class="table table-bordered table-hover input-border mgbt-md-20 generate_datatable" title="Audit Agenda" data-sort_column=1>
                                                                <thead>
                                                                    <tr>
                                                                        <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                                        <th class="col-md-2">{attribute_name module="ams" attribute="date"}</th>
                                                                        <th class="col-md-2">{attribute_name module="ams" attribute="from_time"}</th>
                                                                        <th class="col-md-2">{attribute_name module="ams" attribute="to_time"}</th>
                                                                        <th class="col-md-6">{attribute_name module="ams" attribute="plan"}</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    {foreach item=item key=key from=$ams_aduit_plan_list}
                                                                        <tr>
                                                                            <td>{$key+1}</span></td>
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    {if !empty($am_schedule_obj->audit_lead)}
                                                        <table class="table table-bordered table-striped generate_datatable" title="Review comments" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                                    <th class="col-md-4">{attribute_name module="ams" attribute="audit_lead"}</th>
                                                                    <th class="col-md-4">{attribute_name module="ams" attribute="audit_lead_plant"}</th>
                                                                    <th class="col-md-4">{attribute_name module="ams" attribute="audit_lead_dept"}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    {if $audit_type_name eq 'INTERNAL'}
                                                        {if !empty($ams_int_auditors)}
                                                            <table class="table table-bordered table-striped generate_datatable" title="Auditors" data-sort_column=1>
                                                                <thead>
                                                                    <tr>
                                                                        <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                                        <th class="col-md-4">{attribute_name module="admin" attribute="user_name"}</th>
                                                                        <th class="col-md-4">{attribute_name module="admin" attribute="plant_name"}</th>
                                                                        <th class="col-md-4">{attribute_name module="admin" attribute="department"}</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    {foreach item=item from=$ams_int_auditors}
                                                                        <tr>
                                                                            <td></td>
                                                                            <td>{$item.auditor_name}</td>
                                                                            <td>{$item.auditor_plant_name}</td>
                                                                            <td>{$item.auditor_dept_name}</td>
                                                                        </tr>
                                                                    {/foreach}
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        {/if}
                                                    {/if}
                                                    {if $audit_type_name eq 'EXTERNAL'}
                                                        {if !empty($ams_ext_auditors)}
                                                            <table class="table table-bordered table-striped table-hover mgbt-md-0 generate_datatable" title="Auditors" data-sort_column=1>
                                                                <thead>
                                                                    <tr>
                                                                        <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                                        <th class="col-md-3">{attribute_name module="ams" attribute="ext_agency"}</th>
                                                                        <th class="col-md-3">{attribute_name module="ams" attribute="auditor_name"}</th>
                                                                        <th class="col-md-2">{attribute_name module="ams" attribute="designation"}</th>
                                                                        <th class="col-md-2">{attribute_name module="ams" attribute="email"}</th>
                                                                        <th class="col-md-2">{attribute_name module="ams" attribute="contact_number"}</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    {foreach name=list item=item key=key from=$ams_ext_auditors}
                                                                        <tr>
                                                                            <td></td>
                                                                            <td>{$item.ext_agency}</td>
                                                                            <td>{$item.auditor_name}</td>
                                                ...
                                                <div class="panel-body table-responsive">
                                                    {if !empty($ams_auditees)}
                                                        <table class="table table-bordered table-striped generate_datatable" title="Review comments" data-sort_column=1>
                                                            ...
                                                            <tbody>
                                                                {foreach item=item from=$ams_auditees}
                                                                    <tr>
                                                                        <td></td>
                                                                        <td>{$item.auditee_name}</td>
                                                                        <td>{$item.auditee_plant_name}</td>
                                                                        <td>{$item.auditee_dept_name}</td>
                                                                    </tr>
                                                                {/foreach}
                                                            </tbody>
                                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab_audit_finding">
                                        ...
                                        <div class="vd_content-section clearfix">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body table-responsive">
                                                    {if !empty($ams_agenda_list[0].observation)}
                                                            ...
                                                            <table class="table table-bordered input-border mgbt-md-20">
                                                                <tbody>
                                                                    <tr class="lm_grey">
                                                                        ...
                                                                        <td class="font-semibold col-md-12">{$item.agenda}</td>
                                                                    </tr>
                                                                            ...
                                                                            <td colspan="2">
                                                                                <div class="col-md-4 pd-0">
                                                                                    <div class="input-border pd-15 dropzone lm_zindex-99 vd_bg-white" data-rel="scroll" data-scrollheight="250" style="min-height:250px;">
                                                                                        <i class="append-icon fa fa-fw fa-indent"></i><b>NC Type </b>: {$item1.conformity}  {if $item1.conformity eq 'Conformance'}<i class="append-icon fa fa-fw fa-check-circle vd_green"></i>{else}<i class="append-icon append-icon icon-cross2 vd_red"></i>{/if}
                                                                                        <br><br>
                                                                                        <i class="append-icon glyphicon glyphicon-signal"></i><b>Severity Level </b>: {$item1.severity_level}
                                                                                        <br><br>
                                                                                        <i class="append-icon fa fa-fw fa-delicious"></i><b>Is CAPA Required </b>: <span class="label {if $item1.is_capa_required eq 'yes'}vd_bg-red{else}vd_bg-green{/if} append-icon">{$item1.is_capa_required}</span>
                                                                                        <br><br>
                                                                                        <i class="append-icon icon-sound"></i><b>Integration No :  {display_if_null var=$item1.integration_details->tracking_link}</b>
                                                                                        <br><br>
                                                                                        <i class="append-icon fa fa-fw fa-delicious"></i><b>CAPA No : {display_if_null var=$item1.integration_details->dest_doc_no_link}</b>
                                                                                        <br>
                                                                                        <button class="btn btn-default pdlr-10 width-100 show_audit_attachments mgtp-10" type="button"  data-target="#modal_audit_attachment" data-toggle="modal" data-attachments='{json_encode($item1.attachments)}' data-can_delete=false>
                                                                                            <i class="append-icon glyphicon glyphicon-paperclip"></i><span class="badge vd_bg-blue">{$item1.attachments|@count}</span> Attachemnts
                                                                                        </button>
                                                                                    </div>                                                                       
                                                                                </div>
                                                                                <div class="col-md-8 pd-0">
                                                                                    <div class="input-border pd-15 dropzone lm_zindex-99 vd_bg-white" data-rel="scroll" data-scrollheight="250" style="min-height:250px;">
                                                                                        <b><i class="append-icon glyphicon glyphicon-eye-open"></i>Observation</b>: <span class="badge vd_bg-blue">{$key1+1}</span>
                                                                                        <br>{display_if_null var=$item1.observation}  
                                                                                        <br><br>
                                                                                        <b>
                                                                                            {if $item1.severity_level eq 'Good Observation'}
                                                                                                <i class="append-icon fa fa-fw fa-gavel"></i>Justification 
                                                                                            {else}<i class="append-icon glyphicon glyphicon-wrench"></i>Action To Be Taken
                                                                                            {/if}: 
                                                                                        </b>
                                                                                        <br>{display_if_null var=$item1.action_to_be_taken}
                                                                                        <br><br>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                ...
                                                <div class="panel-body table-responsive">
                                                    {if $general_file_objectarray}
                                                        <table class="table table-bordered table-striped generate_datatable" title="Attachments" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    <th>{attribute_name module="ams" attribute="s_no"}</th>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-border mgtp-20 pd-0 pdlr-10 dropzone lm_zindex-99 unset_min_height">
                                                            ...
                                                            <select  class="show_report mgbt-md-20">
                                                                ...
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a2&rtype=full_report">Full Report [A2-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a2&rtype=full_report">Full Report [A2-L]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a3&rtype=full_report">Full Report [A3-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a3&rtype=full_report">Full Report [A3-L]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a4&rtype=full_report">Full Report [A4-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a4&rtype=full_report">Full Report [A4-L]</option>
                                                            </select> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="input-border mgtp-20 pd-0 pdlr-10 dropzone lm_zindex-99 unset_min_height">
                                                            ...
                                                            <select  class="show_report mgbt-md-20">
                                                                <option value="">Select Type</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a2&rtype=agenda">Full Report [A2-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a2&rtype=agenda">Full Report [A2-L]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a3&rtype=agenda">Full Report [A3-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a3&rtype=agenda">Full Report [A3-L]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a4&rtype=agenda">Full Report [A4-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a4&rtype=agenda">Full Report [A4-L]</option>
                                                            </select> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="input-border mgtp-20 pd-0 pdlr-10 dropzone lm_zindex-99 unset_min_height">
                                                            ...
                                                            <select  class="show_report mgbt-md-20">
                                                                <option value="">Select Type</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a2&rtype=observation">Full Report [A2-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a2&rtype=observation">Full Report [A2-L]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a3&rtype=observation">Full Report [A3-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a3&rtype=observation">Full Report [A3-L]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=p&paper_size=a4&rtype=observation">Full Report [A4-P]</option>
                                                                <option value="index.php?module=file&action=view_ams_details_file&object_id={$am_schedule_obj->object_id}&ori=l&paper_size=a4&rtype=observation">Full Report [A4-L]</option>
                                                            </select> 
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="panel-body pd-15">
                                                <div class="tab-content pd-0 mgtp-0 no-bd">
                                                            ...
                                                            <div class="panel widget panel-bd-left light-widget">
                                                                <div class="panel-body table-responsive">
                                                                    {if ($meeting_schedule)}
                                                                        <div class="row">
                                                                            <div class="col-sm-3">
                                                                                <div class="form-label font-semibold">{attribute_name module="ams" attribute=meeting_date}</div>
                                                                                <input type="text" readonly value="{$meeting_schedule['meeting_date1']}">
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                                <div class="form-label font-semibold">{attribute_name module="ams" attribute=meeting_time}</div>
                                                                                <input type="text" readonly value="{$meeting_schedule['meeting_time']}">
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                                <div class="form-label font-semibold">{attribute_name module="ams" attribute=venue}</div>
                                                                        ...
                                                                        {if ($meeting_schedule['meeting_link'])}
                                                                            <div class="row">
                                                                                <div class="col-sm-9">
                                                                                    <div class="form-label font-semibold">{attribute_name module="ams" attribute=online_meeting_link}</div>
                                                                    ...
                                                                    {if !empty($meeting_participant_details)}
                                                                        <table class="table table-bordered table-striped generate_datatable" title="Invitees List" data-sort_column=1>
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>{attribute_name module="ams" attribute="s_no"}</th>
                                                                                    <th>{attribute_name module="ams" attribute="participants"}</th>
                                                                                    <th>{attribute_name module="admin" attribute="plant_name"}</th>
                                                                                    <th>{attribute_name module="ams" attribute="department"}</th>
                                                                    ...
                                                                    {if !empty($meeting_attendees_details)}
                                                                        <table class="table table-bordered table-striped generate_datatable" title="Attendess list" data-sort_column=1>
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>{attribute_name module="ams" attribute="s_no"}</th>
                                                                                    <th>{attribute_name module="ams" attribute="attendee"}</th>
                                                                                    <th>{attribute_name module="admin" attribute="plant_name"}</th>
                                                                                    <th>{attribute_name module="ams" attribute="department"}</th>
                                                                                </tr>
                                                                            </thead>
                                                    ...
                                                    <div class="tab-pane" id="insight_access_rights">
                                                        ...
                                                        {if !empty($current_access_rights)}
                                                            <table   class="table table-bordered table-striped generate_datatable" title="Access Rights" data-whitespace="pre-wrap" data-ori="landscape" data-sort_column=1>
                                                                <thead>
                                                                    <tr>
                                                                        <th class="col-md-1">{attribute_name module="ams" attribute="s_no"}</th>
                                                                        ...
                                                                        <th class="col-md-1">{attribute_name module="ams" attribute="last_modified_by"}</th>
                                                                        <th class="col-md-1">{attribute_name module="ams" attribute="last_modified_date"}</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                        ...
                                                        {if !empty($cancelled_details)}
                                                            <table   class="table table-bordered table-striped generate_datatable" title="Cancelled Details" data-whitespace="pre-wrap" data-ori="landscape" data-sort_column=1>
                                                                <thead>
                                                                    <tr>
                                                                        <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                                        <th class="col-md-6">{attribute_name module="ams" attribute="reason"}</th>
                                                                        <th class="col-md-3">{attribute_name module="ams" attribute="cancelled_by"}</th>
                                                                        <th class="col-md-3">{attribute_name module="ams" attribute="cancelled_date"}</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                ...
                                                                <tbody>
                                                                    {foreach name=list item=item key=key from=$etrigger_details}
                                                                        <tr>
                                                                            ...
                                                                            <td>{display_if_null var={display_datetime var=$item.assigned_date}}</td>
                                                    ...
                                                    <div class="tab-pane" id="insight_audit_trail">
                                                        ...
                                                        <input type="hidden" class="refrence_object_id" type="hidden" value="{$am_schedule_obj->object_id}">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapsestatus" class="panel-collapse collapse">
                        <div class="panel widget light-widget">
                            <div class="panel-body">
                                <div class="col-md-8 h4 mgtp-0 mgbt-md-0 pd-0 row"><span class="vd_blue"><strong>{$am_schedule_obj->wf_status}</strong></span>
                            ...
                            <div class="panel-body">
                                ...
                                <form name="ams_comments_form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal row" role="form" id="ams_comments_form" autocomplete="off">
                                    <table class="table table-bordered table-striped generate_datatable" title="Comments" data-sort_column=1>
                                        <thead>
                                            <tr>
                                                <th>{attribute_name module=admin attribute="sl_no"}</th>
                                                <th>{attribute_name module="ams" attribute="date"}</th>
                                                <th>{attribute_name module="ams" attribute="username"}</th>
                                                <th>{attribute_name module=admin attribute="plant_name"}</th>
                                                <th>{attribute_name module="ams" attribute="department"}</th>
                                                <th>{attribute_name module="ams" attribute="remarks"}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                    ...
                                                    <div class="modal-body pd-15">
                                                        <form name="update_audit_schedule-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="update_audit_schedule-form" autocomplete="off">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-4">
                                                                    <label class="control-label">{attribute_name module="ams" attribute="audit_plant"} <span class="vd_red">*</span></label>
                                                                    <div class="controls">
                                                                        <input type="text" placeholder="Audit Plant" title="Select Valid Audit Plant" value="{$audit_plant}" disabled> 
                                                                    </div>
                                                                </div>
                                                                {if $audit_type_name eq 'INTERNAL'}   
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="controls">
                                                                            <input type="text" placeholder="Audit Department" title="Select Valid Audit Department" value="{$audit_dept}" disabled> 
                                                                        </div>
                                                                    </div>
                                                                {/if}
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" placeholder="Audit Type" title="Select Valid Audit Type" value="{$audit_type_name}" disabled> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label class="control-label">{attribute_name module="ams" attribute="am_sub_type"} <span class="vd_red">*</span></label>
                                                                    <div class="controls">
                                                                        <input type="text" placeholder="Audit Sub Type" title="Select Valid Audit Sub Type" value="{$audit_sub_type}" disabled> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" class="generate_datepicker date_changed" name="uams_start_date" value="{$am_schedule_obj->from_date}" title="Select Valid Date" data-datepicker_min=0 data-date_changed="uams_end_date" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label class="control-label">{attribute_name module="ams" attribute="audit_date_to"} <span class="vd_red">*</span></label>
                                                                    <div class="controls">
                                                                        <input type="text" class="generate_datepicker" name="uams_end_date" value="{$am_schedule_obj->to_date}" title="Select Valid Date" data-datepicker_min={{$am_schedule_obj->from_date}}>                                                        
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-label font-semibold">{attribute_name module=admin attribute=meeting_required} <span class="vd_red">*</span></div>
                                                                    <div class="controls">
                                                                        <input type="checkbox" class="switch_unchecked" name="uams_meeting"  data-rel="switch" data-size="mini" data-wrapper-class="green" name="uams_meeting"  data-on-text="Yes" data-off-text="No"  title="Select Valid Option"  data-checkd_val="yes" data-uncheckd_val="no" {if $am_schedule_obj->is_meeting_required eq yes}checked{/if}>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <label class="control-label">{attribute_name module="ams" attribute="scope"} <span class="vd_red">*</span></label>
                                                                    <div class="controls">
                                                                        <textarea rows="4" name="uams_scope" title="Enter Valid Scope" placeholder="The audit will assess adherence to quality management systems and GMP standards, inspect facility conditions, equipment, and personnel training, verify compliance with regulatory requirements, review risk management processes and corrective actions, and evaluate supply chain management and product quality control procedures.">{$am_schedule_obj->scope}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <label class="control-label">{attribute_name module="ams" attribute="objectives"} <span class="vd_red">*</span></label>
                                                                    <div class="controls">
                                                                        <textarea rows="4" name="uams_objectives" title="Enter Valid Objectives" placeholder="The audit aims to evaluate compliance with quality management systems and GMP standards, verify the effectiveness of regulatory adherence, assess risk management and corrective action processes, and ensure robust supply chain and product quality controls. The goal is to identify areas for improvement and confirm that all practices meet required standards.">{$am_schedule_obj->objectives}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {if !empty($ams_aduit_plan_list)}
                                        ...
                                        <div class="modal fade" id="edit_agenda" tabindex="-1" role="dialog" aria-labelledby="edit_basic_details_ModalLabel" aria-hidden="true">
                                            <div class="modal-dialog width-70">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body pd-15">
                                                        <form name="update_agenda-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="update_agenda-form" autocomplete="off">
                                                            ...
                                                            <div class="form-group mgbt-md-0">
                                                                <div class="col-sm-12">
                                                                    <table class="table table-bordered table-striped table-hover mgbt-md-0">
                                                                        <thead>
                                                                            <tr>
                                                                                <th class="col-md-12">{attribute_name module="ams" attribute="agenda"} <span class="vd_red">*</span></th>
                                                                                <th>{attribute_name module="ams" attribute="action"}</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody class="add_agenda_parent_ele">
                                                                            {if $ams_agenda_list}
                                                                                {foreach name=list item=item key=key from=$ams_agenda_list}
                                                                                    <tr class="add_agenda_child_ele">
                                                                                        <td><textarea name="uams_agenda[]" class="uams_agenda reset_ele" rows="3" placeholder="Enter Agenda" title="Enter Agenda">{$item.agenda}</textarea></td>
                                                            ...
                                                            <div class="form-group mgbt-md-0">
                                                                <div class="col-sm-12">
                                                                    <table class="table table-bordered table-striped table-hover mgbt-md-0">
                                                                        <thead>
                                                                            <tr>
                                                                                <th class="col-md-2">{attribute_name module="ams" attribute="date"} <span class="vd_red">*</span></th>
                                                                                <th class="col-md-2">{attribute_name module="ams" attribute="from_time"} <span class="vd_red">*</span></th>
                                                                                <th class="col-md-2">{attribute_name module="ams" attribute="to_time"} <span class="vd_red">*</span></th>
                                                                                <th class="col-md-8">{attribute_name module="ams" attribute="plan"} <span class="vd_red">*</span></th>
                                                                                <th>{attribute_name module="ams" attribute="action"}</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody class="add_audit_plan_parent_ele">
                                                                            {if $ams_aduit_plan_list}
                                                                                {foreach name=list item=item key=key from=$ams_aduit_plan_list}
                                                                                    <tr class="add_audit_plan_child_ele">
                                                                                        <td><input type="text" class="generate_datepicker audit_plan_date" name="uams_plan_date[]" title="Select Valid Date" data-datepicker_min={$am_schedule_obj->from_date} data-datepicker_max={$am_schedule_obj->to_date} value="{$item.date}"></td>
                                                                                        <td><input type="text" class="generate_timepicker audit_plan_from_time" name="uams_plan_from_time[]" title="Select Valid Time" data-time_show_secondas="true" data-time_show_input="false" value="{$item.from_time}"></td>
                                                                                        <td><input type="text" class="generate_timepicker audit_plan_to_time" name="uams_plan_to_time[]" title="Select Valid Time" data-time_show_secondas="true" data-time_show_input="false" value="{$item.to_time}"></td>
                                                                                        <td><input type="text" class="reset_ele audit_plan" name="uams_plan[]" placeholder="Enter Plan" title="Enter Plan" value="{$item.plan}"></td>
                                                                            ...
                                                                            {else}
                                                                                <tr class="add_audit_plan_child_ele">
                                                                                    <td><input type="text" class="generate_datepicker audit_plan_date" name="uams_plan_date[]" title="Select Valid Date" data-datepicker_min={$am_schedule_obj->from_date} data-datepicker_max={$am_schedule_obj->to_date}></td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body pd-15">
                                                            <form name="update_auditors-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="update_auditors-form" autocomplete="off">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-md-12">
                                                                        <div class="col-md-6 pd-0">
                                                                            ...
                                                                            <div class="controls">
                                                                                <select onchange="get_access_rights_dept_list('{$am_schedule_obj->object_id}', this.options[this.selectedIndex].value, '', 'yes', '#int_auditor_department');" title="Select Valid Plant">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-md-12">
                                                                        <label class="control-label">{attribute_name module="ams" attribute="auditor_name"}<span class="vd_red">*</span> </label>
                                                                        <div class="controls">
                                                                            ...
                                                                            <div class="col-md-5 pd-0">
                                                                                <select name="uams_auditors[]" id="uams_int_auditors_users_to"  class="form-control" size="7" multiple="multiple"  title="Select Valid User Name">
                                                                                    {foreach name=list item=item key=key from=$ams_int_auditors}
                                            ...
                                            <div class="modal fade" id="edit_auditors" tabindex="-1" role="dialog" aria-labelledby="edit_basic_details_ModalLabel" aria-hidden="true">
                                                <div class="modal-dialog width-80">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body pd-15">
                                                            <form name="update_ext_auditors-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="update_ext_auditors-form" autocomplete="off">
                                                                <div class="alert alert-danger vd_hidden">
                                                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                                                    <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span> Change a few things up and try submitting again.
                                                                </div>
                                                                ...
                                                                <div class="form-group mgbt-md-0">
                                                                    <div class="col-sm-12">
                                                                        <table class="table table-bordered table-striped table-hover mgbt-md-0">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th class="col-md-3">{attribute_name module="ams" attribute="ext_agency"} <span class="vd_red">*</span></th>
                                                                                    <th class="col-md-3">{attribute_name module="ams" attribute="auditor_name"} <span class="vd_red">*</span></th>
                                                                                    <th class="col-md-2">{attribute_name module="ams" attribute="designation"} <span class="vd_red">*</span></th>
                                                                                    <th class="col-md-2">{attribute_name module="ams" attribute="email"} <span class="vd_red">*</span></th>
                                                                                    <th class="col-md-2">{attribute_name module="ams" attribute="contact_number"} <span class="vd_red">*</span></th>
                                                                                    <th>{attribute_name module="ams" attribute="action"}</th>
                                                                                </tr>
                                                                            </thead>
                                                                                ...
                                                                                {if $ams_ext_auditors}
                                                                                    {foreach name=list item=item key=key from=$ams_ext_auditors}
                                                                                        <tr class="add_auditor_child_ele">
                                                                                            <td><input type="text" class="reset_ele auditor_agency" name="uams_ext_agency[]" placeholder="Enter Agency Name" title="Enter Agency Name" value="{$item.ext_agency}"></td>
                                                                                            <td><input type="text" class="reset_ele auditor_name" name="uams_auditor_name[]" placeholder="Enter Auditor Name" title="Enter Auditor Name" value="{$item.auditor_name}"></td>
                                                                                            <td><input type="text" class="reset_ele auditor_desi" name="uams_auditor_designation[]" placeholder="Enter Desigination" title="Enter Desigination" value="{$item.designation}"></td>
                                                                                            <td><input type="email" class="reset_ele auditor_mail" name="uams_auditor_email[]" placeholder="Enter Email Address" title="Enter Email Address" value="{$item.email}"></td>
                                                                                            <td><input type="number" class="reset_ele auditor_contact" name="uams_auditor_contact_number[]" placeholder="Enter Contact Number" title="Enter Contact Valid Number" value="{$item.contact_number}"></td>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <div class="col-md-5 pd-0">
                                                                        <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                                        <div class="controls">
                                                                            <select onchange="get_access_rights_dept_list('{$am_schedule_obj->object_id}', this.options[this.selectedIndex].value, '', 'yes', '#auditee_department');" title="Select Valid Plant">
                                                                                <option value="">Select</option>
                                                                                {foreach name=list item=item key=key from=$ar_plant_list}
                                                                                    <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                                {/foreach}
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        <div class="col-md-5 pd-0">
                                                                            <select name="uams_auditees[]" id="uams_auditees_users_to"  class="form-control" size="7" multiple="multiple"  title="Select Valid User Name">
                                                                                {foreach name=list item=item key=key from=$ams_auditees}
                                                                                    <option value="{$item.auditee_id}" data-drop_down_value="{$item.auditee_id}">{$item.auditee_name}</option>
                                                                                {/foreach}
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <form name="request_qa_approval-form" method="post" action="{$smarty.server.REQUEST_URI}"  class="form-horizontal panel-body panel-bd-left" role="form" id="request_qa_approval-form" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                <div class="controls">
                                                    <select name="plant" onchange="get_access_rights_dept_list('{$am_schedule_obj->object_id}', this.options[this.selectedIndex].value, '', 'yes', '#qa_approve_drop');" title="Select Valid Plant">
                                                        <option value="">Select</option>
                                                        {foreach name=list item=item key=key from=$ar_plant_list}
                                                            <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                        {/foreach}
                                            ...
                                            <div class="col-md-3">
                                                <label class="control-label ">{attribute_name module="ams"  attribute="department"} <span class="vd_red">*</span></label>
                                                <div class="control">
                                            ...
                                            <div class="col-md-3">
                                                <label class="control-label">{attribute_name module="ams" attribute="user_name"} <span class="vd_red">*</span></label>
                                                <div class="controls ">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-9">
                                                <label class="control-label">{attribute_name module="ams" attribute="remarks"} <span class="vd_red">*</span></label>
                                                <div class="controls">
                                    ...
                                    <div class="panel widget panel-bd-left light-widget">
                                        <div class="panel-body">
                                            <div class="col-md-12 row mgbt-md-0">
                                                ...
                                                <table class="table table-bordered table-hover input-border mgbt-md-20">
                                                    <thead>
                                                        <tr>
                                                            <th>{attribute_name module="admin" attribute="sl_no"}</th>
                                                            <th class="col-md-12">{attribute_name module="ams" attribute="agenda"}</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {foreach item=item key=key from=$ams_aduit_agenda_list}
                                            ...
                                            <div class="form-group row qa_approval_drop mgtp-10">
                                                <div class="col-md-2">
                                                    <label class="control-label">{attribute_name module="ams" attribute="approve_type"}<span class="vd_red">*</span></label>
                                                    <div class="controls">
                                        ...
                                        <form name="qa_accepted-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="qa_accepted-form" autocomplete="off">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-12 row mgbt-md-0">
                                                        <label class="control-label">{attribute_name module="ams" attribute="qa_approval_comments"} <span class="vd_red">*</span></label>
                                                        <div class="controls">
                                        ...
                                        <form name="qa_rejected-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="qa_rejected-form" autocomplete="off">
                                            <div class="panel widget panel-bd-left light-widget">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-12 row mgbt-md-0">
                                                        <label class="control-label">{attribute_name module="ams" attribute="rejected_reason"} <span class="vd_red">*</span></label>
                                                        <div class="controls">
                                    ...
                                    <div class="panel widget light-widget">
                                        ...
                                        <form name="meeting_schedule-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="meeting_schedule-form" autocomplete="off">
                                            <div class="panel-body panel-bd-left">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <div class="col-md-3 pd-0">
                                                            <label class="control-label">{attribute_name module="ams" attribute="meeting_date"}<span class="vd_red">*</span></label>
                                                            <div  class="controls">
                                                                <input type="text" class="generate_datepicker" name="meeting_date" title="Select Valid Meeting Date" data-datepicker_min=0>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="control-label">{attribute_name module="ams" attribute="meeting_time"}<span class="vd_red">*</span></label>
                                                            <div  class="controls">
                                                                <input type="text" class="generate_timepicker" name="meeting_time"  title="Select Valid Meeting Time">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label class="control-label">{attribute_name module="ams" attribute="venue"}<span class="vd_red">*</span></label>
                                                            <div  class="controls">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 verfiy_parent">
                                                        <div class="col-md-12 pd-0">
                                                            <label class="control-label">{attribute_name module="ams" attribute="online_meeting_link"}</label>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <div class="col-md-3 pd-0">
                                                            <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                            <div class="controls">
                                                                <select name="plant" onchange="get_access_rights_dept_list('{$am_schedule_obj->object_id}', this.options[this.selectedIndex].value, '', 'yes', '#department');" title="Select Valid Plant">
                                                                    <option value="">Select</option>
                                                                    {foreach name=list item=item key=key from=$ar_plant_list}
                                                                        <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                    {/foreach}
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">{attribute_name module="ams" attribute="department"}</label>
                                                            <div class="controls">
                                                                <select name="department" id="department"  onchange="get_dept_users(this.options[this.selectedIndex].value, '#participant_from_users', 'multiselect', '{$am_schedule_obj->created_by}');" title="Select Valid Department">
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label class="control-label">{attribute_name module="ams" attribute="schedule_to"}<span class="vd_red">*</span></label>
                                            ...
                                            <form name="update_meeting_attendees-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal update_meeting" role="form" id="update_meeting_attendees-form" autocomplete="off" style="display:none">
                                                <div class="form-group mgbt-md-0">
                                                    <div class="col-md-12">
                                                        ...
                                                        <label class="control-label">{attribute_name module="ams" attribute="attendees"}<span class="vd_red">*</span> </label>
                                            ...
                                            <form name="update_meeting_conclusion-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal update_meeting" role="form" id="update_meeting_conclusion-form" autocomplete="off" style="display:none">       
                                                <div class="form-group mgbt-md-0">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                <label class="control-label">{attribute_name module="ams" attribute="remarks"}
                                                        ...
                                                        {foreach item=item key=key from=$ams_agenda_list}
                                                            <table class="table table-bordered">
                                                                <tbody>
                                                                    <tr>
                                                                        <td><span class="badge vd_bg-green">{$key+1}</span></td>
                                                                        <td class="col-md-8">{$item.agenda}</td>
                                                                        <td class="col-md-3">
                                                                            <select class="uams_assign_auditors" name="uams_assign_auditors[]" title="Select Auditor"">
                                                                                ...
                                                                                {if $ams_ext_auditors}
                                                                                    {foreach name=list item=item key=key from=$ams_ext_auditors}
                                                                                        <option value="{$item.auditor_name}">{$item.auditor_name}</option>
                                                                                    {/foreach}
                                                                                {/if}
                                                                            </select>
                                                                        </td>
                                                                        {if $audit_type_name eq 'INTERNAL'}
                                                                            <td class="col-md-1">
                                                                                <span class="font-semibold mgl-10"><span class="vd_checkbox checkbox-danger"><input type="checkbox" name="uams_assign_auditors[]" value="{$am_schedule_obj->audit_lead}" id="audit_myself_{$key}" class="audit_myself"><label for="audit_myself_{$key}" ></label></span> Myself</span>
                                                                            </td>
                                                                        {/if}
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                            <input type="hidden" name="agenda_object_id[]" value="{$item.object_id}">
                                                        {/foreach}
                                                    </div>
                                                </div>
                                                <div class="form-actions-condensed row mgbt-xs-0 text-left mgtp-0">
                                                        ...
                                                        {foreach item=item key=key from=$ams_agenda_list}
                                                            <table class="table table-bordered">
                                                                <tbody>
                                                                    <tr class="lm_grey">
                                                                        <td><span class="badge vd_bg-green">{$key+1}</span></td>
                                                                        <td class="col-md-12">{$item.agenda}
                                                                            <span class="vd_hover pull-right" data-original-title="Auditor" data-toggle="tooltip" data-placement="bottom">
                                                                                {if $audit_type_name eq 'INTERNAL'} [ <i class="fa fa-fw fa-user"></i> {$item.auditor_name}] {/if}
                                                                            </span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>    
                                                                        <td colspan="2">
                                                                            ...
                                                                            <span class="pull-right">Total Observations : <span class="total_ob badge vd_bg-blue">{if $item.observation}{$item.observation|@count}{else}1{/if}</span></span> 
                                                                        </td>
                                                                    </tr>  
                                                                </tbody>
                                                                <tbody class="add_mul_ob_parent parent_{$key} 2d_parent">
                                                                    {if $item.observation}
                                                                        {foreach item=item1 key=key1 from=$item.observation}
                                                                            <tr class="add_mul_ob_child mgtp-5">
                                                                                <td colspan="2">
                                                                                    <button class="btn vd_bg-red vd_white delete_ele pd-10 pull-right cal_ob" type="button" data-delete_ele=".add_mul_ob_child" data-delete_from=".parent_{$key}" style="position:relative;margin-bottom: -4% !important;"><span class="menu-icon"><i class="fa fa-trash-o"></i></span></button>
                                                                                    <!-- Observation -->
                                                                                    <textarea name="uams_audit_observation_id[{$key}][]" class="reset_ele" style="display:none">{$item1.object_id}</textarea>
                                                                                    <textarea rows="3" class="audit_observation 2d_array reset_ele" name="uams_audit_observation[{$key}][]" title="Enter Audit Observation" placeholder="Audit Observation" data-2dname="uams_audit_observation" data-2d_index="{$key}">{$item1.observation}</textarea>
                                                                                    <!-- attachment -->
                                                                                    <div class="col-md-3 pd-0" style="margin-top:-5px;">
                                                                                        <input type="file" name="file[{$key}][{$key1}][]" multiple class="pd-5">
                                                                                    </div>
                                                                                    <div class="col-md-2 btn-group pd-0 reset_ele" style="margin-top:-5px;">
                                                                                        <button class="btn btn-default pdlr-10 width-100 show_audit_attachments" type="button"  data-target="#modal_audit_attachment" data-toggle="modal" data-attachments='{json_encode($item1.attachments)}' data-can_delete=true><i class="append-icon glyphicon glyphicon-paperclip"></i><span class="badge vd_bg-blue reset_ele">{$item1.attachments|@count}</span></button>
                                                                                    </div>
                                                                                    <!--NC -->
                                                                                    <div class="col-md-2 btn-group pd-0"  style="margin-top:-5px;">
                                                                                        <select class="audit_conformity vd_bg-white 2d_array" name="uams_conformity[{$key}][]" title="Select Conformity" style="padding-bottom:7px !important;" data-2dname="uams_conformity" data-2d_index="{$key}">
                                                                                            <option value="">Select Conformity</option>
                                                                                            <option value="Conformance" {if $item1.conformity eq 'Conformance'}selected{/if}>Conformance</option>
                                                                                            <option value="Non Conformance" {if $item1.conformity eq 'Non Conformance'}selected{/if}>Non Conformance</option>
                                                                                        </select>
                                                                                    </div>
                                                                                    <!--NC Category -->
                                                                                    <div class="col-md-2 btn-group pd-0"  style="margin-top:-5px;">
                                                                                        <select class="severity_level vd_bg-white 2d_array" name="uams_severity_level[{$key}][]" title="Select Severity Level" style="padding-bottom:7px !important;" data-2dname="uams_severity_level" data-2d_index="{$key}">
                                                                                            <option value="">Select Severity Level</option>
                                                                                            <option class="conformance_opt" style="display:none;" value="Good Observation" {if $item1.severity_level eq 'Good Observation'}selected{/if}>Good Observation</option>
                                                                                            <option class="non_conformance_opt" style="display:none;"  value="Major NC" {if $item1.severity_level eq 'Major NC'}selected{/if}>Major NC </option>
                                                                                            <option class="non_conformance_opt" style="display:none;" value="Minor NC" {if $item1.severity_level eq 'Minor NC'}selected{/if} >Minor NC </option>
                                                                                            <option class="non_conformance_opt" style="display:none;" value="OFI" {if $item1.severity_level eq 'OFI'}selected{/if}>OFI </option>
                                                                                        </select>
                                                                                    </div>
                                                                                    <div class="col-md-2 pd-0 input-border capa_div pd-5 {if $item1.conformity eq 'Conformance'}lm_grey{/if}"  style="margin-top:-5px;">
                                                                                        <span><i class="append-icon fa fa-fw fa-delicious" style="margin-top:3%;"></i>{attribute_name module="ams" attribute="is_capa_required"}</span>
                                                                                    </div>
                                                                                    <div class="col-md-1 pd-0 capa_div"  style="margin-top:-5px;">
                                                                                        <select class="is_capa_required vd_bg-white" name="is_capa_required[{$key}][]" data-2dname="is_capa_required" data-2d_index="{$key}" style=";padding-top:6%;" title="Select is CAPA required">
                                                                                            <option class="hide_capa" value="" {if $item1.conformity eq 'Conformance'}style="display:none;"{/if}>Select</option>
                                                                                            <option class="hide_capa" value="yes" {if $item1.conformity eq 'Conformance'}style="display:none;"{/if}{if $item1.is_capa_required eq 'yes'}selected{/if}>Yes</option>
                                                                                            <option value="no" {if $item1.is_capa_required eq 'no'}selected{/if}>No</option>
                                                                                        </select>
                                                                                    </div>
                                                                                    <!--Action To Be Taken Category -->
                                                                                    <textarea rows="3" class="nc_action 2d_array reset_ele" name="uams_nc_action[{$key}][]" title="Enter Action To Be Taken" placeholder="Action To Be Taken" data-2dname="uams_nc_action" data-2d_index="{$key}"  {if !$item1.action_to_be_taken}style="display:none;"{/if}>{$item1.action_to_be_taken}</textarea>
                                                                                </td>
                                                                            </tr>
                                                                        {/foreach}
                                                                    {else}
                                                                        <tr class="add_mul_ob_child mgtp-5">
                                                                            <td colspan="2">
                                                                                <button class="btn vd_bg-red vd_white delete_ele pd-10 pull-right cal_ob" type="button" data-delete_ele=".add_mul_ob_child" data-delete_from=".parent_{$key}" style="position:relative;margin-bottom: -4% !important;"><span class="menu-icon"><i class="fa fa-trash-o"></i></span></button>
                                                                                <!-- Observation -->
                                                                                <textarea rows="3" class="audit_observation 2d_array" name="uams_audit_observation[{$key}][]" title="Enter Audit Observation" placeholder="Audit Observation" data-2dname="uams_audit_observation" data-2d_index="{$key}"></textarea>
                                                                                <!-- attachment -->
                                                                                <div class="col-md-3 pd-0" style="margin-top:-5px;">
                                                                                    <input type="file" name="file[{$key}][]" multiple class="pd-5">
                                                                                </div>
                                                                                <div class="col-md-2 btn-group pd-0" style="margin-top:-5px;">
                                                                                ...
                                                                                <!--Action To Be Taken Category -->
                                                                                <textarea rows="3" class="nc_action 2d_array" name="uams_nc_action[{$key}][]" title="Enter Action To Be Taken" placeholder="Action To Be Taken" data-2dname="uams_nc_action" data-2d_index="{$key}"></textarea>
                                                                            </td>
                                                                        </tr>
                                                                    {/if}
                                                                </tbody>
                ...
                {/if}
                {if !empty($recall_audit_findings_review_btn)}
                    {include file="templates/common/recall.tpl"}
                {/if}
                {if !empty($show_audit_findings_review_btn)}
                    <div class="panel panel-default">
                        <div class="panel-heading vd_bg-dark-green">
                                ...
                                <div class="vd_content-section clearfix">
                                    ...
                                    <div class="panel widget light-widget">
                                        ...
                                        <div class="panel widget light-widget audit_findings_review_div" id="audit_findings_review_div" style="display:none;">
                                            <form name="audit_findings_review-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="audit_findings_review-form" autocomplete="off">
                                                                            ...
                                                                            <td colspan="2">
                                                                                <div class="col-md-4 pd-0">
                                                                                    <div class="input-border pd-15 dropzone lm_zindex-99 vd_bg-white" data-rel="scroll" data-scrollheight="250" style="min-height:250px;">
                                                                                        ...
                                                                                        <br>
                                                                                        <button class="btn btn-default pdlr-10 width-100 show_audit_attachments mgtp-10" type="button"  data-target="#modal_audit_attachment" data-toggle="modal" data-attachments='{json_encode($item1.attachments_observe)}' data-can_delete=false>
                                                                                ...
                                                                                <div class="col-md-8 pd-0">
                                                                                    <div class="input-border pd-15 lm_zindex-99 {if $item1.is_capa_required eq 'yes'}bg-info{else}vd_bg-white{/if}" data-rel="scroll" data-scrollheight="250" style="min-height:250px;">
                                                                                        {if $item1.is_capa_required eq 'yes'}
                                                                                            <div class="col-md-12 pd-0 mgbt-md-20">
                                                                                                <label class="control-label"><i class="fa fa-fw fa-delicious"></i> {attribute_name module="ams" attribute="capa_reason"} <span class="vd_red">*</span></label>
                                                                                                <div class="controls mgtp-5">
                                                                                                    <textarea rows="3" name="capa_reason[]" class="capa_reason" title="Enter Valid Reason"></textarea>
                                                                                                    <!-- Plant -->
                                                                                                    <select class="col-md-4" name="plant" onchange="get_access_rights_dept_list('{$am_schedule_obj->object_id}', this.options[this.selectedIndex].value, '', 'yes', lm_dom.find_in_parent(this, 'tr', '.dept'));" title="Select Valid Plant" style="margin-top:-5px">
                                                                                                ...
                                                                                                <input type="hidden" name="observation_object_id[]" value="{$item1.object_id}">
                                                                                            </div>
                                                                                        {/if}
                                                                                        <b><i class="append-icon glyphicon glyphicon-eye-open"></i>Observation</b>: <span class="badge vd_bg-blue">{$key1+1}</span>
                                                                                        <br>{display_if_null var=$item1.observation}  
                                        ...
                                        <div class="panel widget light-widget audit_findings_review_div" id="audit_findings_review_need_correction_div" style="display:none;">
                                            <form name="audit_findings_review_need_correction-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="audit_findings_review_need_correction-form" autocomplete="off">
                                                <div class="panel-bd-left">
                                                    <div class="panel-body">
                                                        <div class="alert alert-danger vd_hidden">
                                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
...
{/if}
<input type="hidden" id="am_object_id" value="{$am_schedule_obj->object_id}" />
<input type="hidden" id="wf_status" value="{$am_schedule_obj->wf_status}"/>
<input type="hidden" id="status" value="{$am_schedule_obj->status}" />
