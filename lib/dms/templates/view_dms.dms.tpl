...
<div class="panel widget">
    <div class="panel-body">
        <div class="panel-group" id="accordion">
                        ...
                        <div class="form-wizard generate_wizard">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="tab_pri_dtls">
                                    ...
                                    <div class="vd_content-section clearfix">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body table-responsive">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=deviation_no}</div>
                                                        <input type="text" readonly value="{$dms_no}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=initiator}</div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=department}</div>
                                                        <input type="text" readonly value="{$dm_department}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=dm_type}</div>
                                                        <div class="input-border pd-5" readonly >{$dm_type}</div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=classification}</div>
                                                        <input type="text" readonly value="{$dm_classification}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=reporting_time}</div>
                                                        <input type="text" readonly value="{$reporting_date} {$dm_master_obj->reporting_time}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=date_of_occurrence}</div>
                                                        <input type="text" readonly value="{$date_of_occurrence}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=time_of_occurrence}</div>
                                                        <input type="text" readonly value="{$dm_master_obj->time_of_occurrence}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=date_of_discovery}</div>
                                                        <input type="text" readonly value="{$date_of_discovery}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=time_of_discovery}</div>
                                                        <input type="text" readonly value="{$dm_master_obj->time_of_discovery}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=status}</div>
                                                        <input type="text" readonly value="{$dm_master_obj->status}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="input-border pd-10 col-md-12">
                                                            <div class="col-sm-6 pd-0">
                                                                <div class="form-label font-semibold">{attribute_name module=admin attribute=invest_required}</div>
                                                                <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $dm_master_obj->is_investigation_required eq yes}checked{/if} readonly>
                                                            </div>
                                                            {if $latest_invest_details->target_date}
                                                                <div class="col-sm-6 pd-0">
                                                                    <div class="form-label font-semibold">{attribute_name module=dms attribute=target_date}</div>
                                                                    <input type="text" readonly value="{display_date var=$latest_invest_details->target_date}">
                                                                </div>
                                                            {/if}
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="input-border pd-10 col-md-12">
                                                            <div class="col-sm-6 pd-0">
                                                                ...
                                                                <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $dm_master_obj->is_meeting_required eq yes}checked{/if} readonly>
                                                            </div>
                                                            {if $dm_master_obj->meeting_target_date}
                                                                <div class="col-sm-6 pd-0">
                                                                    <div class="form-label font-semibold">{attribute_name module=dms attribute=target_date}</div>
                                                                    <input type="text" readonly value="{display_date var=$dm_master_obj->meeting_target_date}">
                                                                </div>
                                                            {/if}
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="input-border pd-10 col-md-12">
                                                            <div class="col-sm-6 pd-0">
                                                                ...
                                                                <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $dm_master_obj->is_training_required eq yes}checked{/if} readonly>
                                                            </div>
                                                            {if $dm_master_obj->training_target_date}
                                                                <div class="col-sm-6 pd-0">
                                                                    <div class="form-label font-semibold">{attribute_name module=dms attribute=target_date}</div>
                                                                    <input type="text" readonly value="{display_date var=$dm_master_obj->training_target_date}">
                                                                </div>
                                                            {/if}
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="input-border pd-10 col-md-12">
                                                            <div class="col-sm-6 pd-0">
                                                                ...
                                                                <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $dm_master_obj->is_online_exam_required eq yes}checked{/if} readonly>
                                                            </div>
                                                            {if $dm_master_obj->exam_target_date}
                                                                <div class="col-sm-6 pd-0">
                                                                    <div class="form-label font-semibold">{attribute_name module=dms attribute=target_date}</div>
                                                                    <input type="text" readonly value="{display_date var=$dm_master_obj->exam_target_date}">
                                                                </div>
                                                            {/if}
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="input-border pd-10 col-md-12">
                                                            <div class="col-sm-6 pd-0">
                                                                ...
                                                                <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $dm_master_obj->is_task_required eq yes}checked{/if} readonly>
                                                            </div>
                                                            {if $dm_master_obj->task_target_date}
                                                                <div class="col-sm-6 pd-0">
                                                                    <div class="form-label font-semibold">{attribute_name module=dms attribute=target_date}</div>
                                                                    <input type="text" readonly value="{display_date var=$dm_master_obj->task_target_date}">
                                                                </div>
                                                            {/if}
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="input-border pd-10 col-md-12">
                                                            <div class="col-md-7 col-sm-7 col-xs-7 pd-0">
                                                                <div class="form-label font-semibold">{attribute_name module=dms attribute=is_capa_required}</div>
                                                                <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $dm_master_obj->is_capa_required eq yes}checked{/if} readonly>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="input-border pd-10 col-md-12">
                                                            <div class="col-md-7 col-sm-7 col-xs-7 pd-0">
                                                                <div class="form-label font-semibold">{attribute_name module=admin attribute=cc_required}</div>
                                                                <input type="checkbox" data-rel="switch" data-size="mini" data-on-text="Yes" data-off-text="No" data-wrapper-class="green"  {if $dm_master_obj->is_cc_required eq yes}checked{/if} readonly>
                                                            </div>
                                                            <div class="form-label font-semibold mgtp-20">
                                                                {$etrigger_cc_no}
                                                            </div>
                                    ...
                                    <div class="vd_content-section clearfix">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body table-responsive">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=approval_status}</div>
                                                        <div class="input-border pd-5"><span class="font-semibold badge">{display_if_null var=$dm_master_obj->approval_status}</span></div>
                                                    </div>

                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=target_date}</div>
                                                        <input type="text" readonly value="{display_if_null var={display_date var=$dm_master_obj->target_date}}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=close_out_date}</div>
                                                        <input type="text" readonly value="{display_if_null var={display_datetime var=$dm_master_obj->close_out_date}}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=completion_date}</div>
                                                        <input type="text" readonly value="{display_if_null var={display_datetime var=$dm_master_obj->completed_date}}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=description}</div>
                                                        <textarea  rows="4" readonly="">{display_if_null var=$dm_master_obj->description}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=risk_impact_assess}</div>
                                                        <textarea  rows="4" " readonly="">{display_if_null var=$dm_master_obj->risk_impact_assessment}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=immed_action_taken}</div>
                                                        <textarea class="mgbt-xs-20  mgbt-sm-0" rows="4" style="resize: none" readonly="">{display_if_null var=$dm_master_obj->immed_action_taken}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=closeout_comments}</div>
                                                        <textarea rows="4" readonly="">{display_if_null var=$dm_master_obj->close_out_comments}</textarea>
                                                    </div>
                                                </div>
                                                {if ($dm_master_obj->rejected_reason)}
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-label font-semibold">{attribute_name module=dms attribute=rejected_reason}</div>
                                                            <textarea rows="4" readonly="">{display_if_null var=$dm_master_obj->rejected_reason}</textarea>
                                                        </div>
                                                    </div>
                                                {/if}
                                                <input type="hidden" id="dms_object_id" value="{$dm_master_obj->dm_object_id}" />
                                                <input type="hidden" id="wf_status" value="{$dm_master_obj->wf_status}" />
                                                <input type="hidden" id="status" value="{$dm_master_obj->status}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="vd_content-section clearfix">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body table-responsive">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=product_name}</div>
                                                        <input type="text" readonly value="{display_if_null var=$product_name}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=processing_stage}</div>
                                                        <input type="text" readonly value="{display_if_null var=$process_stage}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=manu_date}</div>
                                                        <input type="text" readonly value="{display_if_null var={display_date var=$dm_master_obj->manu_date}}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=manu_expiry_date}</div>
                                                        <input type="text" readonly value="{display_if_null var={display_date var=$dm_master_obj->manu_expiry_date}}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=batch_no}</div>
                                                        <input type="text" readonly value="{display_if_null var=$dm_master_obj->batch_no}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=lot_no}</div>
                                                        <input type="text" readonly value="{display_if_null var=$dm_master_obj->lot_no}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=batch_size}</div>
                                                        <input type="text" readonly value="{display_if_null var=$dm_master_obj->batch_size}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=material_type}</div>
                                                        <input type="text" readonly value="{display_if_null var=$material_type}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=material_name}</div>
                                                        <input type="text" readonly value="{display_if_null var=$dm_master_obj->material_name}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=customer}</div>
                                                        <input type="text" readonly value="{display_if_null var=$customer_name}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-label font-semibold">{attribute_name module=dms attribute=scope}</div>
                                    ...
                                    <br>
                                    <h4><span class="font-semibold text-uppercase vd_grey"><i class="append-icon fa fa-fw fa-share-alt"></i>"Deviation Related To" Details</span><span class="font-semibold font-10 badge vd_bg-red mgl-10">{$dev_related_to_list|@count}</span></h4>
                                    <div class="vd_content-section clearfix">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body table-responsive">
                                                <div  class="controls">
                                                    <div class="vd_pricing-table">
                                                        {foreach name=list item=item key=key from=$dev_related_to_list}
                                                            <div class="col-md-12 col-lg-4">
                                                                <div class="plan  mgr-10">
                                                                    <div class="plan-header vd_bg-green vd_white text-center vd_info-parent">
                                                                        <div class="vd_bg-black-30 pd-5">{$item.dev_related_to}<span class="font-semibold font-10 badge vd_bg-yellow mgl-10">{$item.dev_sub_related_to|@count}</span></div>
                                                                    </div>
                                                                    <div data-rel="scroll" data-scrollheight="150" class="input-border content-list">
                                                                        <ul class="list-wrapper pd-5">
                                                                            {foreach name=list2 item=item2 key=key from=$item.dev_sub_related_to}
                                                                                <li class="vd_hover" data-original-title="{$item2.desc}" data-placement="bottom" data-toggle="tooltip" data-container="body"><span class="menu-rating vd_yellow col-md-1 pd-0"><i class="icon-star mgr-10"></i></span><span class="col-md-11 pd-0">{$item2.sub_type}</span>
                                                                                </li>
                                                                            {/foreach}
                                                                        </ul>
                                                                    </div>
                                            ...
                                            <div class="panel-body table-responsive">
                                                {if !empty($pre_review_comments)}
                                                    <table class="table table-bordered table-striped generate_datatable" title="Review comments" data-sort_column=1>
                                                        ...
                                                        <tbody>
                                                            {foreach name=list item=item key=key from=$pre_review_comments}
                                                                <tr>
                                                                    <td></td>
                                ...
                                <div class="tab-pane" id="tab_investigation">
                                            ...
                                            <div class="panel-body table-responsive">
                                                {if !empty($investigation_details)}
                                                    <table class="table table-bordered table-striped generate_datatable" title="Investigation Details" data-ori="landscape" data-pagesize="B4">
                                                        <thead>
                                                            <tr>
                                                                <th>{attribute_name module="dms" attribute="iteration"}</th>
                                                                <th>{attribute_name module="dms" attribute="assigned_by"}</th>
                                                                <th>{attribute_name module="dms" attribute="investigation_details"}</th>
                                                                <th>{attribute_name module="dms" attribute="target_date"}</th>
                                                                <th>{attribute_name module="dms" attribute="invest_feedback"}</th>
                                                                <th>{attribute_name module="dms" attribute="probable_rc"}</th>
                                                                <th>{attribute_name module="dms" attribute="investigated_by"}</th>
                                                                <th>{attribute_name module="dms" attribute="dept_head_review"}</th>
                                                                <th>{attribute_name module="dms" attribute="qa_verification"}</th>
                                                                <th>{attribute_name module="dms" attribute="completion_date"}</th>
                                                                <th>{attribute_name module="dms" attribute="status"}</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            {foreach name=list item=item key=key from=$investigation_details}
                                                                <tr>
                                                                    <td>{$item.iteration}</td>
                                                                    <td>{$item.assigned_by}<br><br>{$item.assigned_date}</td>
                                                                    <td>{display_if_null var=$item.investigation_details}</td>
                                                                    <td>{$item.target_date}</td>
                                                                    <td>{display_if_null var=$item.investigator_feedback}</td>
                                                                    <td>{display_if_null var=$item.root_cause}</td>
                                                                    <td>{$item.investigated_by}<br><br>{$item.investigator_dept}</td>
                                                                    <td>{display_if_null var=$item.dept_head_review}<br><br>{$item.dept_head_review_date}<br><br>{$item.dept_head_name}</td>
                                                                    <td>{display_if_null var=$item.qa_reviewer_review}<br><br>{$item.qa_reviewer_review_date}<br><br>{$item.qa_reviewer}</td>
                                                                    <td>{display_if_null var=$item.completion_date}</td>
                                                                    <td>{$item.status}</td>
                                                                </tr>
                                                            {/foreach}
                                                        </tbody>
                                    ...
                                    <div class="vd_content-section clearfix">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body table-responsive">
                                                {if !empty($investigation_file_objectarray)}
                                                    <table class="table table-bordered table-striped generate_datatable" title="Attacments" data-sort_column=1>
                                                        ...
                                                        <tbody>
                                                            {foreach name=list item=item key=key from=$investigation_file_objectarray}
                                                                <tr>
                                                                    <td></td>
                                                                    <td><a class="menu-icon vd_bd-green vd_blue font-semibold" data-original-title="Download" data-toggle="tooltip" data-placement="bottom" href="?module=file&action=view_request_file&file_id={$item.object_id}">{$item.name}</font></a></td>
                                            ...
                                            <div class="panel-body table-responsive">
                                                {if !empty($dms_task_list)}
                                                    <table class="table table-bordered table-striped generate_datatable" title="Task Responsible Persons" data-sort_column=1>
                                                        ...
                                                        <tbody>
                                                            {foreach name=list item=item key=key from=$dms_task_list}
                                                                <tr>
                                                                    <td></td>
                                                                    <td>{$item.task_id}</td>
                                                                    <td>{$item.task}</td>
                                                ...
                                                {if !empty($dms_task_list)}
                                                    <table class="table table-bordered generate_datatable" title="Attacments" data-ori="landscape" data-pagesize="B4" data-sort_column=1>
                                                        <thead>
                                                            <tr>
                                                                <th>{attribute_name module="dms" attribute="s_no"}</th>
                                                                <th class="col-md-2 pd-10">{attribute_name module="dms" attribute="task"} </th>
                                                                <th class="col-md-3">{attribute_name module="dms" attribute="sec_resp_per"}</th>
                                                                <th class="col-md-3">{attribute_name module="dms" attribute="pri_resp_per"}</th>
                                                                <th class="col-md-3">{attribute_name module="dms" attribute="task_verification"}</th>
                                                                <th class="col-md-1">{attribute_name module="dms" attribute="qa_review"}</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            {foreach name=list item=item key=key from=$dms_task_list}
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {if $dm_master_obj->task_qa_review}
                                                                            <div class="input-border dropzone unset_min_height pd-10">
                                                                                <div class="row mgbt-md-10 pdlr-10">
                                                                                    <div class="col-md-10 pd-0">
                                                                                        <i class="append-icon fa fa-fw fa-calendar"></i>{display_datetime var=$dm_master_obj->close_out_date}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row mgbt-md-0 pdlr-10">
                                                                                    <div class="col-md-12 pd-0">
                                                                                        {$dm_master_obj->task_qa_review}
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        {/if}
                                                        ...
                                                        <tbody>
                                                            {foreach name=list item=item key=key from=$investigation_file_objectarray}
                                                                <tr>
                                                                    <td></td>
                                                                    <td>
                                                                        <a class="menu-icon vd_bd-green vd_blue font-semibold" data-original-title="Download" data-toggle="tooltip" data-placement="bottom" href="?module=file&action=view_request_file&file_id={$item.object_id}">{$item.name}</font></a>
                                                                        <br>
                                                                    </td>
                                                                    <td>
                                                                        {GetFriendlySize file_size=$item.size}
                                                                        <br>
                                                                    </td>
                                                                    <td>
                                                                        {$item.attached_by}
                                                ...
                                                <div class="panel-body table-responsive">
                                                    {if !empty($dms_task_list)}
                                                        <table class="table table-bordered table-striped generate_datatable" title="Attacments" data-sort_column=1>
                                                            ...
                                                            <tbody>
                                                                {foreach item=item key=key from=$dms_task_list}
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-border mgtp-20 pd-0 pdlr-10 dropzone lm_zindex-99 unset_min_height">
                                                        ...
                                                        <select  class="show_report mgbt-md-20">
                                                            ...
                                                            <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a2&rtype=full_report">Full Report [A2-P]</option>
                                                            <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a2&rtype=full_report">Full Report [A2-L]</option>
                                                            <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a3&rtype=full_report">Full Report [A3-P]</option>
                                                            <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a3&rtype=full_report">Full Report [A3-L]</option>
                                                            <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a4&rtype=full_report">Full Report [A4-P]</option>
                                                            <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a4&rtype=full_report">Full Report [A4-L]</option>
                                                        </select> 
                                                    </div>
                                                </div>
                                                {if $dm_master_obj->is_meeting_required eq 'yes'}
                                                    <div class="col-md-3">
                                                        <div class="input-border mgtp-20 pd-0 pdlr-10 dropzone lm_zindex-99 unset_min_height">
                                                            ...
                                                            <select  class="show_report mgbt-md-20">
                                                                <option value="">Select Type</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a2&rtype=meeting">Meeting Report [A2-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a2&rtype=meeting">Meeting Report [A2-L]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a3&rtype=meeting">Meeting Report [A3-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a3&rtype=meeting">Meeting Report [A3-L]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a4&rtype=meeting">Meeting Report [A4-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a4&rtype=meeting">Meeting Report [A4-L]</option>
                                                            </select> 
                                                        </div>
                                                    </div>
                                                {/if}
                                                {if $dm_master_obj->is_training_required eq 'yes'}
                                                    <div class="col-md-3">
                                                        <div class="input-border mgtp-20 pd-0 pdlr-10 dropzone lm_zindex-99 unset_min_height">
                                                            ...
                                                            <select  class="show_report mgbt-md-20">
                                                                <option value="">Select Type</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a2&rtype=training">Training Report [A2-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a2&rtype=training">Training Report [A2-L]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a3&rtype=training">Training Report [A3-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a3&rtype=training">Training Report [A3-L]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a4&rtype=training">Training Report [A4-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a4&rtype=training">Training Report [A4-L]</option>
                                                            </select> 
                                                        </div>
                                                    </div>
                                                {/if}
                                                {if $dm_master_obj->is_task_required eq 'yes'}
                                                    <div class="col-md-3">
                                                        <div class="input-border mgtp-20 pd-0 pdlr-10 dropzone lm_zindex-99 unset_min_height">
                                                            ...
                                                            <select  class="show_report mgbt-md-20">
                                                                <option value="">Select Type</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a2&rtype=task">Task Report [A2-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a2&rtype=task">Task Report [A2-L]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a3&rtype=task">Task Report [A3-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a3&rtype=task">Task Report [A3-L]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=p&paper_size=a4&rtype=task">Task Report [A4-P]</option>
                                                                <option value="index.php?module=file&action=view_dms_details_file&object_id={$dm_master_obj->dm_object_id}&ori=l&paper_size=a4&rtype=task">Task Report [A4-L]</option>
                                                            </select> 
                                                        </div>
                                                    </div>
                                                {/if}
                                        ...
                                        <div class="panel-body pd-15">
                                            <div class="tab-content pd-0 mgtp-0 no-bd">
                                                                ...
                                                                {if !empty($meeting_participant_details)}
                                                                    <table class="table table-bordered table-striped generate_datatable" title="Invitees List" data-sort_column=1>
                                                                        <thead>
                                                                            <tr>
                                                                                <th>{attribute_name module="dms" attribute="s_no"}</th>
                                                                                <th>{attribute_name module="dms" attribute="participants"}</th>
                                                                                <th>{attribute_name module="admin" attribute="plant_name"}</th>
                                                                                <th>{attribute_name module="dms" attribute="department"}</th>
                                                        ...
                                                        <div class="vd_content-section clearfix">
                                                            <div class="panel widget panel-bd-left light-widget">
                                                                <div class="panel-body table-responsive">
                                                                    <ul class="vd_li pd-0 vd_bg-white form-group">
                                                                        <div class="alert vd_bg-dark-blue vd_white alert-dismissable alert-condensed mgbt-md-0 pdlr-10">
                                                                            <i class="fa fa-circle fa-fw vd_white"></i> <span class="font-semibold">Exam Status  : {$dm_master_obj->exam_status} | {attribute_name module="dms" attribute="target_date"} : {display_date var=$dm_master_obj->exam_target_date}</span>
                                                                        </div>
                                                                    </ul>
                                                                                ...
                                                                                {foreach item=item2 key=key2 from=$item1.user_details}
                                                                                    <tr >
                                                                                        ...
                                                                                        <td class="menu-action">
                                                                                            {if $dm_master_obj->exam_status eq 'Completed'}
                                                                                                <a data-original-title="Exam Result Report" data-toggle="tooltip" data-placement="bottom" class="btn menu-icon vd_bd-yellow vd_red" href="index.php?module=file&action=view_dms_exam_result_file&dm_object_id={$dm_master_obj->dm_object_id}&exam_object_id={$item2.exam_object_id}" onclick="window.open(this.href, 'mysignupwin', 'left=200,top=150,width=500,height=500,toolbar=1,resizable=0');
                                                ...
                                                <div class="tab-pane" id="insight_access_rights">
                                                    ...
                                                    {if !empty($current_access_rights)}
                                                        <table   class="table table-bordered table-striped generate_datatable" title="Access Rights" data-whitespace="pre-wrap" data-ori="landscape" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    <th class="col-md-1">{attribute_name module="dms" attribute="s_no"}</th>
                                                        ...
                                                        <table   class="table table-bordered table-striped generate_datatable" title="Cancelled Details" data-whitespace="pre-wrap" data-ori="landscape" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>{attribute_name module="dms" attribute="cancelled_by"}</th>
                                                                    <th>{attribute_name module="dms" attribute="cancelled_date"}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                ...
                                                <div class="tab-pane" id="insight_repetitive_dms">
                                                    ...
                                                    {if !empty($repetitive_dms_details)}
                                                        <table class="table table-bordered table-striped generate_datatable" title="Repetitive DMS" data-sort_column=1>
                                                            <thead>
                                                                <tr>
                                                                    <th>{attribute_name module="dms" attribute="s_no"}</th>
                                                                    <th>{attribute_name module="dms" attribute="deviation_no"}</th>

                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                {foreach name=list item=item key=key from=$repetitive_dms_details}
                                                                    <tr>
                                                                        <td></td>
                                                                        <td>{$item.repetitive_dm_no_link}</td>
                                                                    </tr>
                                                                {/foreach}
                                                            </tbody>
                                                        </table>
                                                            ...
                                                            <tbody>
                                                                {foreach name=list item=item key=key from=$etrigger_details}
                                                                    <tr>
                                                                        ...
                                                                        <td>{if $item.dest_doc_no}{display_if_null var=$item.dest_doc_no_link}<br>{$item.dest_doc_name}{/if}</td>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapsestatus" class="panel-collapse collapse">
                    <div class="panel widget light-widget">
                        <div class="panel-body">
                            <div class="col-md-8 h4 mgtp-0 mgbt-md-0 pd-0 row"><span class="vd_blue"><strong>{$dm_master_obj->wf_status}</strong></span>
                                                    ...
                                                    <form name="edit_basic_details-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_basic_details-form" autocomplete="off">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="controls">
                                                                    <select  class="required" name="udev_type" id="udev_type" required title="Select Valid Deviation Type">
                                                                        ...
                                                                        {foreach name=list item=item key=key from=$dev_type_list_master}
                                                                            <option value="{$item.object_id}" {if $dm_master_obj->dm_type_id eq $item.object_id} selected{/if}>{$item.type}</option>
                                                                        {/foreach}
                                                                    </select> 
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="controls">
                                                                    <select class="required" name="udev_classification" id="udev_classification" required title="Select Valid Claasfication">
                                                                        ...
                                                                        {foreach item=item key=key from=$classification_list}
                                                                            <option value="{$item.object_id}"  {if $dm_master_obj->classification eq $item.object_id} selected{/if}>{$item.type}{$item.short_name}</option>
                                                                        {/foreach}
                                                                    </select> 
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="required generate_datepicker date_changed" placeholder="YYYY-MM-DD" name="udev_date_of_occ" id="udev_date_of_occ" readonly required title="Select Valid Date of Occurance" value="{$dm_master_obj->date_of_occurrence}" data-datepicker_max="0" data-date_changed="udev_date_of_discover">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label">{attribute_name module="dms" attribute="time_of_occurrence"} <span class="vd_red">*</span></label>
                                                                <div class="controls">
                                                                    <input type="text" class="required generate_timepicker" placeholder="HH:MM AM/PM" name="udev_time_of_occ" id="udev_time_of_occ" required readonly title="Select Valid Time of Occurance"  value="{$dm_master_obj->time_of_occurrence}" data-time_show_secondas=true data-time_show_input=false>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label">{attribute_name module="dms" attribute="date_of_discovery"} <span class="vd_red">*</span></label>
                                                                <div class="controls">
                                                                    <input type="text" class="required generate_datepicker" name="udev_date_of_discover" title="Select Valid Date Of Discovery" value="{$dm_master_obj->date_of_discovery}" data-datepicker_max=0 data-datepicker_min="{$dm_master_obj->date_of_occurrence}" required readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label">{attribute_name module="dms" attribute="time_of_discovery"} <span class="vd_red">*</span></label>
                                                                <div class="controls">
                                                                    <input type="text" class="required generate_timepicker" name="udev_time_of_discover" title="Select Valid Time Of Discovery" value="{$dm_master_obj->time_of_discovery}" data-time_show_secondas="true" data-time_show_input="false" required readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="required generate_select2" name="udev_related_to[]" id="udev_related_to" required title="Select Valid Deviation Related To Item" multiple="multiple" style="width:100%">
                                                                        {foreach item=item key=key from=$dev_realted_to_list_edit}
                                                                            <optgroup class="vd_bg-green" label="{$item.dev_realted_to} - [{$item.desc}]">
                                                                                {foreach item=item1 key=key1 from=$item.sub_related_to_details}
                                                                                    <option value="{$item.dev_realted_to_id}-{$item1.sub_related_to_id}" {if $item1.is_sub_related_exist} selected{/if}>{$item1.sub_related_to} - [{$item1.desc}]</option>
                                                                                {/foreach}
                                                                            </optgroup>
                                                                        {/foreach}
                                                                    </select>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-8">
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="checkbox" class="switch_unchecked" name="udev_meeting"  data-rel="switch" data-size="mini" data-wrapper-class="green" name="adev_meeting"  data-on-text="Yes" data-off-text="No"  title="Select Valid Option"  data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_meeting_required eq yes}checked{/if}>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="controls mgtp-5">
                                                                        <input type="checkbox" name="udev_training" id="toggle_training" class="is_traing_required switch_unchecked" data-rel="switch"  data-size="mini" data-wrapper-class="green" data-on-text="Yes" data-off-text="No" name="adev_training" title="Select Valid Option" data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_training_required eq yes}checked{/if}>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3 toggle_training" data-toggle_to="toggle_training" style="display:{if $dm_master_obj->is_training_required eq yes}block{else}none{/if}">
                                                                    <div class="form-label font-semibold">{attribute_name module=admin attribute=exam_required} <span class="vd_red">*</span></div>
                                                                    <div class="controls mgtp-5">
                                                                        <input type="checkbox" class="switch_unchecked" name="udev_exam" data-rel="switch" data-size="mini" data-wrapper-class="green" data-on-text="Yes" data-off-text="No" name="adev_exam" title="Select Valid Option" data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_online_exam_required eq yes}checked{/if}>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="form-label font-semibold">{attribute_name module=admin attribute=task_required} <span class="vd_red">*</span></div>
                                                                    <div class="controls mgtp-5">
                                                                        <input type="checkbox" class="switch_unchecked" name="udev_task"  data-rel="switch" data-size="mini" data-wrapper-class="green" data-on-text="Yes" data-off-text="No" name="adev_task"   title="Select Valid Option" data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_task_required eq yes}checked{/if}>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="required generate_select2" name="udev_repetitive_dms_no[]" id="udev_repetitive_dms_no" required title="Repetitive DMS No" multiple="multiple" style="width:100%">
                                                                        <option value="NA" {if count($repetitive_dms_details) eq 0} selected {/if}>NA</option>
                                                                        {foreach item=item key=key from=$repetitive_dms_list_edit}
                                                                            <option value="{$item.drop_down_value}" {if $item.is_exist} selected{/if}>{$item.drop_down_option}</option>
                                                                        {/foreach}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <form name="edit_prod_info-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_prod_info-form" autocomplete="off">
                                                        <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select  name="udev_mat_id" id="udev_mat_id" title="Select Valid Material Type">
                                                                        ...
                                                                        {foreach name=list item=item key=key from=$material_category_list}
                                                                            <option value="{$item.object_id}" {if $item.object_id eq $dm_master_obj->material_type_id} selected{/if}>{$item.material_type}</option>
                                                                        {/foreach}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <div  class="controls ">
                                                                    <input type="text" class="" placeholder="Enter material name" name="udev_mat_name" id="udev_mat_name" value="{$dm_master_obj->material_name}" title="Enter Material Name">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="controls">
                                                                    <select name="udev_prod_name" id="udev_prod_name" title="Select Valid Product Name">
                                                                        ...
                                                                        {foreach name=list item=item key=key from=$productlist}
                                                                            <option value="{$item.object_id}" {if $item.object_id eq $dm_master_obj->product_id} selected{/if}>{$item.product_name}</option>
                                                                        {/foreach}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="controls">
                                                                    <select name="udev_scope" id="udev_scope" title="Select Valid Market Name">
                                                                        ...
                                                                        {foreach name=list item=item key=key from=$marketlist}
                                                                            <option value="{$item.object_id}" {if $item.object_id eq $dm_master_obj->scope} selected{/if}>{$item.market_name}</option>
                                                                        {/foreach}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div  class="controls">
                                                                    <select  name="udev_customer" id="udev_customer" title="Select Valid Customer Name">
                                                                        ...
                                                                        {foreach name=list item=item key=key from=$customerlist}
                                                                            <option value="{$item.object_id}" {if $item.object_id eq $dm_master_obj->customer} selected{/if}>{$item.customer_name}</option>
                                                                        {/foreach}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" placeholder="Enter batch no" name="udev_batch_no" id="udev_batch_no" value="{$dm_master_obj->batch_no}" title="Enter Batch No">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label">{attribute_name module="dms" attribute="batch_size"} </label>
                                                                <div  class="controls">
                                                                    <input type="text" placeholder="Enter batch size" name="udev_batch_size" id="udev_batch_size" value="{$dm_master_obj->batch_size}" title="Enter Batch Size">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label">{attribute_name module="dms" attribute="lot_no"} </label>
                                                                <div class="controls">
                                                                    <input type="text" placeholder="Enter lot no" name="udev_lot_no" id="udev_lot_no" value="{$dm_master_obj->lot_no}" title="Enter Lot No">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select name="udev_processing_stage" id="udev_processing_stage" title="Select Valid Process Stage">
                                                                        ...
                                                                        {foreach name=list item=item key=key from=$process_stage_list}
                                                                            <option value="{$item.object_id}" {if $item.object_id eq $dm_master_obj->process_stage_id} selected{/if}>{$item.process_stage}</option>
                                                                        {/foreach}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="generate_datepicker date_changed" placeholder="YYYY-MM-DD" name="udev_manu_date" value="{$dm_master_obj->manu_date}" title="Select Valid Manufacturing Date" data-datepicker_max=0 data-date_changed="udev_manu_expiry_date">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label">{attribute_name module="dms" attribute="manu_expiry_date"}</label>
                                                                <div  class="controls">
                                                                    <input type="text" class="generate_datepicker" placeholder="YYYY-MM-DD" name="udev_manu_expiry_date" value="{$dm_master_obj->manu_expiry_date}" title="Select Valid Expiry Date" data-datepicker_min="{$dm_master_obj->manu_date}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                    ...
                                    <div class="modal fade" id="edit_desc_imd_action" tabindex="-1" role="dialog" aria-labelledby="edit_ModalLabel" aria-hidden="true">
                                        <div class="modal-dialog width-60">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body pd-15">
                                                    <form name="edit_desc_risk_ass_immed_action-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="edit_desc_risk_ass_immed_action-form" autocomplete="off">
                                                        <div class="alert alert-danger vd_hidden">
                                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                                            <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span> Change a few things up and try submitting again.
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                <label class="control-label">{attribute_name module="dms" attribute="description"} <span class="vd_red">*</span></label>
                                                                <div class="controls">
                                                                    <textarea placeholder="Enter description" rows="3" class="width-100" name="udev_desc"  required title="Enter Valid Description">{$dm_master_obj->description}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                <label class="control-label">{attribute_name module="dms" attribute="risk_impact_assess"} <span class="vd_red">*</span></label>
                                                                <div class="controls">
                                                                    <textarea placeholder="Enter impact assessment" rows="3" class="width-100" name="udev_risk_impact" required  title="Enter Valid Impact Assessment">{$dm_master_obj->risk_impact_assessment}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                <label class="control-label">{attribute_name module="dms" attribute="immed_action_taken"} <span class="vd_red">*</span></label>
                                                                <div class="controls">
                                                                    <textarea placeholder="Enter immediate action taken" rows="3" class="width-100" name="udev_imd_action" required title="Enter Valid Action Taken">{$dm_master_obj->immed_action_taken}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
            ...
            {/if}
            {if !empty($request_pre_review_dept_approve_button)}
                <div class="panel panel-default">
                    <div class="panel-heading vd_bg-dark-green">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-3 pd-0">
                                                    ...
                                                    <div class="controls">
                                                        <select onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#department');" title="Select Valid Plant">
                                                            <option value="">Select</option>
                                    ...
                                    <form name="request_dept_approve-form" method="post" action="{$smarty.server.REQUEST_URI}"  class="form-horizontal" role="form" id="request_dept_approve-form" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <select name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#dept_approve_drop');" title="Select Valid Plant">
                                                        <option value="">Select</option>
                                                        {foreach name=list item=item key=key from=$ar_plant_list}
                                                            <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                        {/foreach}
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="control">
                                                    <select name="department" id="dept_approve_drop" onchange="get_action_users('{$lm_doc_id}', 'dept_approve', this.options[this.selectedIndex].value, '#userid');"  required title="Select Valid Department">
                                                        <option value="">Select</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <form name="request_qa_review-form" method="post" action="{$smarty.server.REQUEST_URI}"  class="form-horizontal" role="form" id="request_qa_review-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <label class="control-label">{attribute_name module="admin" attribute="plant_name"} <span class="vd_red">*</span></label>
                                                    <div class="controls">
                                                        <select name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#qa_review_drop');" title="Select Valid Plant">
                                                            <option value="">Select</option>
                                                            {foreach name=list item=item key=key from=$ar_plant_list}
                                                                <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                            {/foreach}
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-3">
                                                            <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                            <div class="controls">
                                                                <select name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#cft_drop');" title="Select Valid Plant">
                                                                    <option value="">Select</option>
                                                                    {foreach name=list item=item key=key from=$ar_plant_list}
                                                                        <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                    {/foreach}
                                ...
                                <div class="panel widget panel-bd-left light-widget">
                                    <div class="panel-body">
                                        ...
                                        <form name="cft_assesment-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="cft_assesment-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <label class="control-label">{attribute_name module="dms" attribute="cft_comments"} <span class="vd_red">*</span></label>
                                                    <div class="controls">
            ...
            {/if}
            {if !empty($assign_investgator_btn)}
                <div class="panel panel-default">
                    <div class="panel-heading vd_bg-dark-green">
                        <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseshowdeptapprove"> Action <i class="fa  fa-exclamation-triangle vd_white"></i></a> </h4>
                    </div>
                    <div id="collapseshowdeptapprove" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="vd_content-section clearfix">     
                                ...
                                <div class="panel-body panel widget panel-bd-left light-widget">
                                    <form name="assign_investigator-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="assign_investigator-form" autocomplete="off">
                                        <div class="alert alert-danger vd_hidden">
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                            <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span> Change a few things up and try submitting again.
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                <div class="controls">
                                                    <select name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#invest_drop');" title="Select Valid Plant">
                                                        <option value="">Select</option>
                                                        {foreach name=list item=item key=key from=$ar_plant_list}
                                                            <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                        {/foreach}
                                            ...
                                            <div class="col-md-3">
                                                <label class="control-label">{attribute_name module="dms" attribute="investigator"}<span class="vd_red">*</span></label>
                                                <div  class="controls">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="control-label">{attribute_name module="dms" attribute="investigation_details"} <span class="vd_red">*</span></label>
                                                <div  class="controls">
            ...
            {/if}
            {if !empty($investigation_feedback_btn)}
                <div class="panel panel-default">
                    <div class="panel-heading vd_bg-dark-green">
                    ...
                    <div id="collapseshowinvestigation" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="vd_content-section clearfix">
                                ...
                                <div class="panel widget panel-bd-left light-widget">
                                    <div class="panel-body">
                                        <form name="investigation_feedback-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="investigation_feedback-form" autocomplete="off">
                                            <div class="alert alert-danger vd_hidden">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                                <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span> Change a few things up and try submitting again.
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <label class="control-label">{attribute_name module="dms" attribute="invest_feedback"} <span class="vd_red">*</span></label>
                                                    <div  class="controls">
                                                        <textarea placeholder="Kindly provide the comprehensive feedback on the investigation" rows="3" class="required" name="uinst_investigation_feedback" id="uinst_investigation_feedback" required title="Enter Valid wFeedback">{$latest_invest_details->investigator_feedback}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <label class="control-label">{attribute_name module="dms" attribute="probable_rc"} <span class="vd_red">*</span></label>
                                                    <div  class="controls">
                                                        <textarea placeholder="Kindly enter the Probable Root Cause" rows="3" class="required" name="uinst_root_cause" id="uinst_root_cause" required title="Enter Valid Root Cause">{$latest_invest_details->root_cause}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="vd_login-error" class="alert alert-danger hidden"><i class="fa fa-exclamation-circle fa-fw"></i> Please fill the necessary field </div>
            ...
            {/if}
            {if !empty($request_investigation_extension_btn)}
                {include file="templates/common/extension_request.tpl"}
            {/if}
            {if !empty($investigation_extension_approval_btn)}
                {include file="templates/common/extension_approval.tpl"}
            {/if}
            {if !empty($show_investigation_review)}
                <div class="panel panel-default">
                    <div class="panel-heading vd_bg-dark-green">
                        <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseshowdeptapprove"> Action <i class="fa  fa-exclamation-triangle vd_white"></i></a> </h4>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="vd_content-section clearfix">     
                                ...
                                <div class="invest_review" id="invest_review_div" style="display:none;">
                                    <form name="invest_reviewed-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="invest_reviewed-form" autocomplete="off">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body">                                           
                                                <div class="form-group mgbt-md-0">
                                                    <div class="col-md-12">
                                ...
                                <div class="invest_review" id="invest_review_need_correction_div" style="display:none;">
                                    <form name="invest_review_need_correction-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="invest_review_need_correction-form" autocomplete="off">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body">
                                                <div class="form-group mgbt-md-0">
                                                    <div class="col-md-12">
            ...
            {/if}
            {if !empty($show_investigation_verification)}
                <div class="panel panel-default">
                    <div class="panel-heading vd_bg-dark-green">
                        <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseshowdeptapprove"> Action <i class="fa  fa-exclamation-triangle vd_white"></i></a> </h4>
                    </div>
                    <div id="collapseshowdeptapprove" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="vd_content-section clearfix">     
                                ...
                                <div>
                                    <form name="invest_verification-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="invest_verification-form" autocomplete="off">
                                        <div class="panel widget panel-bd-left light-widget">
                                            <div class="panel-body">                                           
                                                <div class="form-group mgbt-md-0">
                                                    <div class="col-md-12">
                                                        <label class="control-label">{attribute_name module="dms" attribute="qa_verification"} <span class="vd_red">*</span></label>
                                                        <div  class="controls">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                        <div class="controls">
                                                            <select name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#qa_approve_drop');" title="Select Valid Plant">
                                                                <option value="">Select</option>
                                                                {foreach name=list item=item key=key from=$ar_plant_list}
                                                                    <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                {/foreach}
            ...
            {if !empty($recall_cft_button)}
                {include file="templates/common/recall.tpl"}
            {/if}
            {if !empty($recall_investigator_button)}
                <div class="panel panel-default">
                    <div class="panel-heading vd_bg-dark-green">
                    ...
                    <div id="collapseRecallinvest" class="panel-collapse collapse ">
                        <div class="panel-body">
                            <div class="vd_content-section clearfix">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group col-md-12">
                                                <div class="col-md-2">
                                                    <label class="control-label">{attribute_name module="dms" attribute="recall_from"} &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp; {$latest_invest_details->investigated_by}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel widget panel-bd-left light-widget">
                                    <div class="panel-body">
                                        <form name="recall_investigator-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="recall_investigator-form" autocomplete="off">
                                            <div class="alert alert-danger vd_hidden">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                                <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span> Change a few things up and try submitting again.
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="control-label">{attribute_name module="dms" attribute="department"}<span class="vd_red">*</span></label>
                                                        <div  class="controls">
                                                            <select class="" name="department" id="invest_drop" onchange="get_dept_users(this.options[this.selectedIndex].value, '#responsible_person', null, '{$latest_invest_details->investigated_by_id}');" title="Select Valid Department">
                                                                <option value="">Select</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="control-label">{attribute_name module="dms" attribute="replaced_by"}<span class="vd_red">*</span></label>
                                                        <div  class="controls">
                                                            <select  name="responsible_person" id="responsible_person" title="Select Valid Person"><option value="">Select</option> </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="control-label">{attribute_name module="dms" attribute="target_date"}
                                                            <span class="vd_red">*</span></label>
                                                        <div  class="controls">
                                                            <input type=text class="generate_datepicker"  data-datepicker_min="0" name="invest_target_date"  placeholder="DD/MM/YYYY" title="Select Valid Target Date" value="{$latest_invest_details->target_date1}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <div class="col-md-12">
                                                        <label class="control-label">{attribute_name module="dms" attribute="investigation_details"} <span class="vd_red">*</span></label>
                                                        <div  class="controls">
                                                            <textarea placeholder="(e.g.) Enter Investigation Details" rows="3" class="required" name="investigation_details" id="investigation_details" required title="Enter Valid Investigation Details">{$latest_invest_details->investigation_details}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12">
            ...
            {/if}
            {if !empty($request_invest_qa_approval_btn)}
                <div class="panel panel-default">
                    <div class="panel-heading vd_bg-dark-green">
                        ...
                        <div class="panel-body"> 
                            <div class="vd_content-section clearfix">
                                ...
                                <div class="mgtp-5 request_invest_type" style="display: none;" id="request_investigation_div">
                                    ...
                                    <form name="investigation_required-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal panel-body panel-bd-left" role="form" id="investigation_required-form" autocomplete="off">
                                        <div class="alert alert-danger vd_hidden">
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i  class="icon-cross"></i></button>
                                            <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span> Change a few things up and try submitting again.
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                        <div class="controls">
                                                            <select name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#pre_approve_drop');" title="Select Valid Plant">
                                                                <option value="">Select</option>
                                                                {foreach name=list item=item key=key from=$ar_plant_list}
                                                                    <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                {/foreach}
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <div  class="controls">
                                                            <select type="text" class="" name="udev_type" required title="Select Valid Deviation Type">
                                                                <option value="">Select</option>
                                                                {foreach name=list item=item key=key from=$dev_type_list_master}
                                                                    <option value="{$item.object_id}" {if $item.object_id eq $dm_master_obj->dm_type_id}selected{/if}>{$item.type}</option>
                                                                {/foreach}
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="controls">
                                                            <select  name="udev_classification"  title="Select Valid Classification">
                                                                <option value="">Select</option>
                                                                {foreach item=item key=key from=$classification_list}
                                                                    <option value="{$item.object_id}" {if $item.object_id eq $dm_master_obj->classification}selected{/if}>{$item.short_name}</option>
                                                                {/foreach}
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="controls">
                                                            <select class="required generate_select2" name="udev_related_to[]"  required title="Select Valid Deviation Related To Item" multiple="multiple" style="width:100%">
                                                                {foreach item=item key=key from=$dev_realted_to_list_edit}
                                                                    <optgroup label="{$item.dev_realted_to} - [{$item.desc}]">
                                                                        {foreach item=item1 key=key1 from=$item.sub_related_to_details}
                                                                            <option value="{$item.dev_realted_to_id}-{$item1.sub_related_to_id}" {if $item1.is_sub_related_exist} selected{/if}>{$item1.sub_related_to} - [{$item1.desc}]</option>
                                                                        {/foreach}
                                                                    </optgroup>
                                                    ...
                                                    <div class="input-border panel-body pd-15">
                                                        ...
                                                        <div class="form-group date_diff">
                                                            ...
                                                            <div class="controls col-md-1">
                                                                <input type="checkbox" class="switch_unchecked" id="udev_meeting" name="udev_meeting"  data-rel="switch" data-size="mini" data-wrapper-class="green"   data-on-text="Yes" data-off-text="No" title="Select Valid Option"  data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_meeting_required eq yes}checked{/if}>
                                                            </div>
                                                            <div class="form-label col-md-1 font-semibold meeting_toggle" style="display:{if $dm_master_obj->is_meeting_required eq yes}block{else}none{/if}">{attribute_name module=dms attribute=target_date} <span class="vd_red">*</span></div>
                                                            <div class="controls col-md-2 meeting_toggle" style="display:{if $dm_master_obj->is_meeting_required eq yes}block{else}none{/if}">
                                                        ...
                                                        <div class="form-group date_diff">
                                                            ...
                                                            <div class="controls col-md-1">
                                                                <input type="checkbox" id="udev_training" name="udev_training" class="switch_unchecked" data-rel="switch"  data-size="mini" data-wrapper-class="green" data-on-text="Yes" data-off-text="No" title="Select Valid Option" data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_training_required eq yes}checked{/if}>
                                                            </div>
                                                            <div class="form-label col-md-1 font-semibold training_toggle" style="display:{if $dm_master_obj->is_training_required eq yes}block{else}none{/if}">{attribute_name module=dms attribute=target_date} <span class="vd_red">*</span></div>
                                                            <div class="controls col-md-2 training_toggle" style="display:{if $dm_master_obj->is_training_required eq yes}block{else}none{/if}">
                                                        ...
                                                        <div class="form-group date_diff exam_toggle" style="display:{if $dm_master_obj->is_online_exam_required eq yes}block{else}none{/if}">
                                                            ...
                                                            <div class="controls col-md-1">
                                                                <input type="checkbox" class="switch_unchecked" id="udev_exam" name="udev_exam" data-rel="switch" data-size="mini" data-wrapper-class="green" data-on-text="Yes" data-off-text="No" title="Select Valid Option" data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_online_exam_required eq yes}checked{/if}>
                                                            </div>
                                                            <div class="form-label col-md-1 font-semibold exam_toggle_date" style="display:{if $dm_master_obj->is_online_exam_required eq yes}block{else}none{/if}">{attribute_name module=dms attribute=target_date} <span class="vd_red">*</span></div>
                                                            <div class="controls col-md-2 exam_toggle_days" style="display:{if $dm_master_obj->is_online_exam_required eq yes}block{else}none{/if}">
                                                        ...
                                                        <div class="form-group date_diff">
                                                            ...
                                                            <div class="controls col-md-1">
                                                                <input type="checkbox" class="switch_unchecked" id="udev_task" name="udev_task"  data-rel="switch" data-size="mini" data-wrapper-class="green" data-on-text="Yes" data-off-text="No" title="Select Valid Option" data-checkd_val="yes" data-uncheckd_val="no" {if $dm_master_obj->is_task_required eq yes}checked{/if}>
                                                            </div>
                                                            <div class="form-label col-md-1 font-semibold task_toggle" style="display:{if $dm_master_obj->is_task_required eq yes}block{else}none{/if}">{attribute_name module=dms attribute=target_date} <span class="vd_red">*</span></div>
                                                            <div class="controls col-md-2 task_toggle" style="display:{if $dm_master_obj->is_task_required eq yes}block{else}none{/if}">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <div class="col-md-3 pd-0">
                                                        ...
                                                        <div  class="controls">
                                                            <input type="text" class="generate_datepicker" name="meeting_date" title="Select Valid Meeting Date" data-datepicker_min=0 data-datepicker_max="{$dm_master_obj->meeting_target_date}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <div class="col-md-3 pd-0">
                                                        <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                        <div class="controls">
                                                            <select name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', '#department');" title="Select Valid Plant">
                                                                <option value="">Select</option>
                                                                {foreach name=list item=item key=key from=$ar_plant_list}
                                                                    <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                {/foreach}
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="control-label">{attribute_name module="dms" attribute="department"}</label>
                                                        <div class="controls">
                                                            <select name="department" id="department"  onchange="get_dept_users(this.options[this.selectedIndex].value, '#participant_from_users', 'multiselect', '{$dm_master_obj->created_by}');" title="Select Valid Department">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <form name="meeting_reschedule-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="meeting_reschedule-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <label class="control-label">{attribute_name module="dms" attribute="meeting_date"}<span class="vd_red">*</span></label>
                                                    <div  class="controls">
                                                        <input type=text class="generate_datepicker" name="rmeeting_date" id="rmeeting_date"  title="Select Valid Meeting Date" data-datepicker_min=0 data-datepicker_max={$dm_master_obj->meeting_target_date} value="{$meeting_schedule['meeting_date']}">
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div>
                                                                <table class="table table-bordered table-striped" title="Meeting Conclusion">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>{attribute_name module=dms attribute="meeting_agenda"}</th>
                                                                            <th> {attribute_name module=dms attribute="meeting_conclusion"}</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        {foreach name=list item=item key=key from=$meeting_agenda_details}
                                        ...
                                        <form name="assign_trainer-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" enctype="multipart/form-data"  role="form" id="assign_trainer-form" autocomplete="off">
                                            ...
                                            <div class="form-group trainer_row">
                                                <div class="col-md-3">
                                                    <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                    <div class="controls">
                                                        <select  onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', lm_dom.find_in_parent(this, '.trainer_row', '.trainer_dept_drop'));" title="Select Valid Plant">
                                                            <option value="">Select</option>
                                                            {foreach name=list item=item key=key from=$ar_plant_list}
                                                                <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                            {/foreach}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <label class="control-label">{attribute_name module="ccm" attribute="training_date"}
                                                                        <span class="vd_red">*</span></label>
                                                                    <div  class="controls">
                                                                        <input type=text class="generate_datepicker training_date" name="training_date[{$key}][]"  placeholder="DD/MM/YYYY" title="Select Valid Training Date" data-datepicker_min="0" data-datepicker_max="{$dm_master_obj->training_target_date}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <div class="col-md-3 pd-0">
                                                                        <label class="control-label">{attribute_name module="admin" attribute="plant_name"}</label>
                                                                        <div class="controls">
                                                                            <select onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', lm_dom.find_in_parent(this, '.training_schedule_child_ele_{$key}', '.training_schedule_dept'));" title="Select Valid Plant">
                                                                                <option value="">Select</option>
                                                                                {foreach name=list item=item key=key from=$ar_plant_list}
                                                                                    <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                                {/foreach}
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$eligible_rescheduled_training_details}
                                                        <tr>
                                                            ...
                                                            <td>{$item.venue}</td>
                                                            <td>
                                                                <input type="text" class="generate_datepicker training_reschedule_date reschedule_training_ed" id="training_reschedule_date_{$key}" name="training_rescheduled_date[]" placeholder="DD/MM/YY"  data-datepicker_min=0 data-datepicker_max="{$dm_master_obj->training_target_date}" title="Select Valid Date" disabled>
                                                            </td>
                                                            <td>
                                        ...
                                        {foreach item=item2 key=key2 from=$item1.user_details}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <div class="widget dark-widget input-border mgtp-0">
                                                        <div class="panel-body  pd-5 pdlr-10"><h5 class="font-semibold text-center vd_grey">{display_date var=$dm_master_obj->exam_target_date}</h5></div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                                            ...
                                                            {if $dms_task_list}
                                                                {foreach name=list item=item key=key from=$dms_task_list}
                                                                    <tr class="add_task_child_ele">
                                                                        ...
                                                                        <td class="pd-5">
                                                                            <select class="mgtp-5" name="plant[]" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', lm_dom.find_in_parent(this, 'td', '#task_department'));" title="Select Valid Plant">
                                            ...
                                            <div class="form-group mgbt-md-0">
                                                <div class="col-sm-12">
                                                    <table class="table table-bordered mgbt-md-0">
                                                        ...
                                                        <tbody class="add_task_parent_ele">
                                                            <tr class="add_task_child_ele">
                                                                <td><input type="text" class="task_id" name="task_id[]" readonly value="T{$dms_task_list|@count+1}"></td>
                                                                <td>
                                                                    <textarea name="task[]" class="reset_ele" rows="5" placeholder="Enter Task Details" title="Enter Task Details"></textarea>
                                                                </td>
                                                                <td class="pd-5">
                                                    ...
                                                    <input type="hidden" class="old_task_count" value="{$dms_task_list|@count}">
                                                </div>
                                            </div>
                                            <div class="alert alert-warning pd-10 input-border">
                                                <div class="row mgbt-md-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="col-md-4 pdlr-10">
                                                                    <select class="assign_others" name="plant" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', lm_dom.find_in_parent(this, 'tr', '.department'));" title="Select Valid Plant">
                                                                        <option value="">Select</option>
                                                                        {foreach name=list item=item key=key from=$ar_plant_list}
                                                                            <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                        {/foreach}
                                            ...
                                            <tbody>
                                                {foreach name=list item=item key=key from=$recall_sec_pending_users_list}
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <select name="plant[]" class="recall_ed" onchange="get_access_rights_dept_list('{$dm_master_obj->dm_object_id}', this.options[this.selectedIndex].value, '', 'yes', lm_dom.find_in_parent(this, 'tr', '.department'));" title="Select Valid Plant" disabled>
                                                                <option value="">Select</option>
                                                                {foreach name=list item=item key=key from=$ar_plant_list}
                                                                    <option value="{$item.drop_down_value}">{$item.drop_down_option}</option>
                                                                {/foreach}
                                                ...
                                                <tbody>
                                                    {foreach name=list item=item key=key from=$sec_per_pending_task_details}
                                                        <tr class="bg-info">
                                                            ...
                                                            <td><i class="append-icon fa fa-fw fa-calendar"></i>{display_date var=$dm_master_obj->task_target_date}</td>
                                                        </tr>
                                ...
                                <div class="panel widget light-widget">
                                    ...
                                    <div class="panel-body panel-bd-left">
                                        <form name="close_out-form" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="close_out-form" autocomplete="off">
                                            <div class="form-group panel-body mgbt-md-0 pd-15">
                                                ...
                                                {if $dms_task_list}
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th class="col-md-3">{attribute_name module="dms" attribute="task"} </th>
                                                                <th class="col-md-3">{attribute_name module="dms" attribute="sec_resp_per"}</th>
                                                                <th class="col-md-3">{attribute_name module="dms" attribute="pri_resp_per"}</th>
                                                                <th class="col-md-3">{attribute_name module="dms" attribute="task_verification"}</th>
                                                            </tr>
                                                ...
                                                <div class="input-border panel-body pd-15">
                                                    ...
                                                    <div class="col-md-12 pd-0">
                                                        <div class="form-label col-md-2 font-semibold pd-0">{attribute_name module=admin attribute=capa_required} <span class="vd_red">*</span></div>
                                                        ...
                                                        <div class="form-label col-md-1 font-semibold" data-toggle_to="udev_capa" style="display:none;">{attribute_name module=dms attribute=dept_head} <span class="vd_red">*</span></div>
                                                        ...
                                                        <div class="form-label col-md-1 font-semibold" data-toggle_to="udev_capa" style="display:none;">{attribute_name module=admin attribute=reason} <span class="vd_red">*</span></div>
                                                    ...
                                                    <div class="col-md-12 pd-0 mgtp-10">
                                                        <div class="form-label col-md-2 font-semibold pd-0">{attribute_name module=admin attribute=cc_required} <span class="vd_red">*</span></div>
                                                        <div class="controls col-md-1 pd-0">
                                                        ...
                                                        <div class="form-label col-md-1 font-semibold" data-toggle_to="udev_cc" style="display:none;">{attribute_name module=dms attribute=dept_head} <span class="vd_red">*</span></div>
                                                        ...
                                                        <div class="form-label col-md-1 font-semibold" data-toggle_to="udev_cc" style="display:none;">{attribute_name module=admin attribute=reason} <span class="vd_red">*</span></div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <label class="control-label">{attribute_name module="dms" attribute="closeout_comments"} <span class="vd_red">*</span></label>
                                                    <div  class="controls">
