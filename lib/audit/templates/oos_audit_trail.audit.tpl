                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 pd-0">
                                <label class="control-label">{attribute_name module="audit" attribute="oos_no"}</label>
                                <div class="controls">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="controls">
                                    <input type="text" class="generate_datepicker search_audit_trail from_date" placeholder="YYYY/MM/DD" data-datepicker_min=-365 data-datepicker_max=0 value="{$def_start_date}" style="height: 30px;">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <label class="control-label">{attribute_name module="audit" attribute="date"} To</label>
                                <div class="controls">
                                    <input type="text" name='to_date' class="generate_datepicker to_date search_audit_trail" placeholder="YYYY/MM/DD" data-datepicker_min=-365 data-datepicker_max=0 value="{$def_end_date}" style="height: 30px;">
                                </div>
                            </div>
                        </div>
                    </div>
