...
/**
 * Project:     Logicmind
 * File:        view_ams_observation_entry_file.file.php
...
if($am_master_obj->get("object_id",$am_object_id)){
   ...
   // Extend the TCPDF class to create custom Header and Footer
    class AUDIT_FINDINGS extends TCPDF {
        //Page header
        public function Header() {
            ...
            $this->Cell(0, 0, 'AUDIT FINDINGS - MANUAL ENTRY SHEET', 0, 1, 'C', 0, '', 0, false, 'M', 'M');
            $this->Ln(10);
        }
        // Page footer
    ...
    $pdf = new AUDIT_FINDINGS(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
    ...
    $pdf->SetSubject('Audit Observation Manual Entry Sheet');
    $pdf->SetKeywords('Audit Observation Manual Entry Sheet');
...
EODAUDITSCHED;
    ...
    <table cellspacing="0" cellpadding="4" border="1">
        <thead>
             <tr>
                <td align="center" width="1153px" style="border:1px solid #000000;"><b>SECTION - 3 : AGENDA DETAILS  </b></td>
            </tr>
            <tr>
                <td align="center" width="40px"  style="border:1px solid #000000;"><b>S.No.</b></td>
                <td align="center" width="400px" style="border:1px solid #000000;"><b>Agenda </b></td>
                <td align="center" width="400px" style="border:1px solid #000000;"><b>Observation</b></td>
                <td align="center" width="111px"  style="border:1px solid #000000;"><b>Primary Responsible Person</b></td>
                <td align="center" width="111px"  style="border:1px solid #000000;"><b>Secondary Responsible Person</b></td>
                <td align="center" width="89px"  style="border:1px solid #000000;"><b>Target Date</b></td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td align="center" width="40px"  height="240px" style="border:1px solid #000000;"></td>
                <td align="center" width="400px" height="240px" style="border:1px solid #000000;"></td>
                <td align="center" width="400px" height="240px" style="border:1px solid #000000;"></td>
                <td align="center" width="111px" height="240px" style="border:1px solid #000000;"></td>
                <td align="center" width="111px" height="240px" style="border:1px solid #000000;"></td>
                <td align="center" width="89px"  height="240px" style="border:1px solid #000000;"></td>
            </tr>
            <tr>
                <td align="center" width="40px"  height="201px" style="border:1px solid #000000;"></td>
                <td align="center" width="400px" height="201px" style="border:1px solid #000000;"></td>
                <td align="center" width="400px" height="201px" style="border:1px solid #000000;"></td>
                <td align="center" width="111px" height="201px" style="border:1px solid #000000;"></td>
                <td align="center" width="111px" height="201px" style="border:1px solid #000000;"></td>
                <td align="center" width="89px"  height="201px" style="border:1px solid #000000;"></td>
            </tr>
            <tr>
                <td align="center" width="40px"  height="200px" style="border:1px solid #000000;"></td>
                <td align="center" width="400px" height="200px" style="border:1px solid #000000;"></td>
                <td align="center" width="400px" height="200px" style="border:1px solid #000000;"></td>
                <td align="center" width="111px" height="200px" style="border:1px solid #000000;"></td>
                <td align="center" width="111px" height="200px" style="border:1px solid #000000;"></td>
                <td align="center" width="89px"  height="200px" style="border:1px solid #000000;"></td>
            </tr>
           <tr>
                <td align="center" width="40px"  height="200px" style="border:1px solid #000000;"></td>
                <td align="center" width="400px" height="200px" style="border:1px solid #000000;"></td>
...
EODMOM;
    $pdf->writeHTML($mom_list_tbl, true, false, false, false, '');
    $pdf->Ln();
    $pdf->Ln();
    $pdf->Ln();
       ...
       //Close and output PDF document
        $pdf->Output("Audit Observation Manual Entry Sheet.pdf", 'I');
        //============================================================+
        // END OF FILE
        //============================================================+
    }else {
