...
if($pre_loaded_tempalte_obj->is_moved=="no" && $pre_loaded_tempalte_obj->orientation=="P") {
    ...
    <table width="100%" style="margin: 5px 0px 0px 0px;padding:1px;">
        <tr>
            <td width="20%" style="font-size: 12px;font-family: arial;font-weight: bold;">'.$pre_loaded_temp_acronym.'</td>
            <td width="70%" style="text-align: center;font-size: 12px;font-family: arial;font-weight: bold;color: #ffc3c3;">Downloaded By ['.$usr_full_nmae.'] ['.$usr_dept.'] ['.$createtime.']</td>
