...
if ($oosObj->get("object_id", $oosObjectId)) {
    ...
    if (!empty($oosObj->qms_capa_no) && ($oosObj->qms_capa_no != "NA")) {
        $capaNo = $oosObj->qms_capa_no;
    } else {
        $capaNo = $oosObj->manual_capa_no;
    }
    ...
    $preliminaryAssignCauseDetails = $preliminaryInvestigationObject->assign_cause_details ? $preliminaryInvestigationObject->assign_cause_details : "Nil";
    $phase1AssignCauseDetails = $phase1InvestigationObject->assign_cause_details ? $phase1InvestigationObject->assign_cause_details : "Nil";
    $phase2RetestAssignCauseDetails = $phase2RetestInvestigationObject->assign_cause_details ? $phase2RetestInvestigationObject->assign_cause_details : "Nil";
    $phase2ResampleAssignCauseDetails = $phase2ResampleInvestigationObject->assign_cause_details ? $phase2ResampleInvestigationObject->assign_cause_details : "Nil";
    $phase2RsampleProcessingStage = $phase2ResampleInvestigationObject->process_stage_id ? getProcessStage($phase2ResampleInvestigationObject->process_stage_id) : "Nil";
    $phase3AssignCauseDetails = $phase3InvestigationObject->assign_cause_details ? $phase3InvestigationObject->assign_cause_details : "Nil";
    $phase3LabInvestigationReview = $phase3InvestigationObject->lab_investigation_review;
    $phase3ManufacturingInvestigationReview = $phase3InvestigationObject->mfg_investigation_review;
    $phase3IsOosValid = $phase3InvestigationObject->is_oos_valid;
    $phase3FinalClosureComments = $phase3InvestigationObject->final_closure_comments;
    ...
    if (!empty($fileObjectArray)) {
        foreach ($fileObjectArray as $key => $value) {
            $fileMarkup .= "<tr><td width=\"195px\" style=\"border:1px solid #000000;text-align: justify;\">$value[name]</td><td width=\"195px\" style=\"border:1px solid #000000;text-align: center;\">$value[attached_by]</td><td width=\"195px\" style=\"border:1px solid #000000;text-align: center;\">$value[attached_date]</td><td width=\"195px\" style=\"border:1px solid #000000;text-align: center;\">$value[file_type]</td></tr>";
        }
    } else {
    ...
    class OOS_PDF extends TCPDF
    {
        ...
        public function Header()
        {
            ...
            $this->Cell(0, 0, 'REPORT - OOS ISSUE', 0, 1, 'C', 0, '', 0, false, 'M', 'M');
            $this->Ln(10);
        }
        // Page footer
    ...
    $pdf->SetSubject('OOS Details Report');
    $pdf->SetKeywords('OOS Details Report');
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('arial', '', 10);
    $mcp3close_tbl = <<<EODPDQAPHASECLOSE
        <table cellspacing="0" cellpadding="7" border="0">
            <tr>
                <td align="center" width="780px" style="border:1px solid #000000;"><b>SECTION - 14 : CLOSE-OUT </b></td>
            </tr>
            <tr>
                <td align="left" width="200px" style="border:1px solid #000000;"><b>Final Closure Conclusion</b></td>
                <td align="justify" width="580px" style="border:1px solid #000000;">$oosObj->final_closure_conclusion</td>
            </tr>
            <tr>
                <td align="left" width="200px" style="border:1px solid #000000;"><b>Impact Assessment</b></td>
                <td align="justify" width="580px" style="border:1px solid #000000;">$oosObj->impact_assesment</td>
            </tr>
            <tr>
                <td align="left" width="200px" style="border:1px solid #000000;"><b>Risk Assessment</b></td>
                <td align="justify" width="580px" style="border:1px solid #000000;">$oosObj->risk_assesment</td>
            </tr>
            <tr>
                <td align="left" width="200px" style="border:1px solid #000000;"><b>CAPA No.</b></td>
                <td align="justify" width="580px" style="border:1px solid #000000;">$capaNo</td>
            </tr>
            <tr>
                <td align="left" width="200px" style="border:1px solid #000000;"><b>Close-out Date</b></td>
                <td align="justify" width="580px" style="border:1px solid #000000;">$finalClosureDate</td>
            </tr>
            <tr>
                <td rowspan="2"  width="200px" style="border:1px solid #000000;text-align:center;line-height: 50px;"><b>Closed-out By</b></td>
                <td   width="150px" style="border:1px solid #000000;"><b>Name</b></td>
                <td   width="140px" style="border:1px solid #000000;"><b>Designation</b></td>
                <td   width="140px" style="border:1px solid #000000;"><b>Department</b></td>
                <td   width="150px" style="border:1px solid #000000;"><b>Date & Time</b></td>
            ...
            <tr>
                ...
                <td  width="140px" style="border:1px solid #000000;">$qaApproverDesignation</td>
                <td  width="140px" style="border:1px solid #000000;">$qaApproverDepartment</td>
                <td  width="150px" style="border:1px solid #000000;">$finalClosureDate</td>
           </tr>
        </table>
    EODPDQAPHASECLOSE;
    $pdf->writeHTML($mcp3close_tbl, true, false, false, false, '');
    ...
    $attach_tbl = <<<EODMARKETING
        <table cellspacing="0" cellpadding="7" border="0">
            <thead>
                <tr>
                    <td align="center" width="780px" style="border:1px solid #000000;"><b>SECTION - 15 : ATTACHMENTS (Supporting Documents)</b></td>
                </tr>
                <tr>
    ...
    $pdf->MultiCell(221, 0, 'Digitally Signed By : ', 0, 'L', 1, 1, '', $pdf->GetY() + 5, true, 0, FALSE, false, 0, 'T', false);
    $pdf->Ln();
    $pdf->Ln();

    if (!empty($creator)) {
        $validCreatorDigitalSignInfo = "Digitally Signed Information \nOOS :  \nCreated By : $creatorName \nDesignation : $creatorDesignation \nDepartment : $creatorDepartment \nDate : $createdTime";
    }
    if (!empty($qcReviewer)) {
        $validQcReviewerDigitalSignInfo = "Digitally Signed Information \nOOS :  \nReviewed By : $qcReviewerName \nDesignation : $qcReviewerDesignation \nDepartment : $qcReviewerDepartment \nDate : $qcReviewedTime";
    }
    if (!empty($qaReviewer)) {
        $validQaReviewerDigitalSignInfo = "Digitally Signed Information \nOOS :  \nReviewed By : $qaReviewerName \nDesignation : $qaReviewerDesignation \nDepartment : $qaReviewerDepartment \nDate : $qaReviewedTime";
    }
    if (!empty($qcApprover)) {
        $validQcApproverDigitalSignInfo = "Digitally Signed Information \nOOS :  \nApproved By : $qcApproverName \nDesignation : $qcApproverDesignation \nDepartment : $qcApproverDepartment \nDate : $qcApprovedTime";
    }
    if (!empty($qaApprover)) {
        $validQaApproverDigitalSignInfo = "Digitally Signed Information \nOOS :  \nApproved By : $qaApproverName \nDesignation : $qaApproverDesignation \nDepartment : $qaApproverDepartment \nDate : $qaApprovedTime";
    }
    $invalidDigitalSignInfo = "Not Yet Digitally Signed - Invalid Document";

    $pdf->SetFont('calibri', 'B', 8);
    $pdf->SetTextColor(0, 0, 128);
    if (!empty($creator_name)) {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/valid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $validCreatorDigitalSignInfo, '', true, 200, '', false, false, 0, false, false, false);
    } else {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/invalid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $invalidDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    }
    ...
    if (!empty($creator)) {
        $pdf->Cell(72, 5, $creatorName, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(30, 5, $creatorDesignation, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(22, 5, $creatorDepartment, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(33, 5, $createdTime, 0, false, 'L', 0, '', 0, false, 'M', 'M');
    }
    $pdf->SetLineStyle(array('width' => 5, 'cap' => 'round', 'join' => 'round', 'dash' => '2'));
    $pdf->Line(15, $pdf->GetY() + 5, 236, $pdf->GetY() + 5, $style = array('width' => 0.05, 'color' => array(67, 179, 230)));
    $pdf->Ln();
    $pdf->Ln();

    $pdf->SetFont('calibri', 'B', 8);
    $pdf->SetTextColor(0, 0, 128);
    if (!empty($qcReviewerName)) {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/valid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $validQcReviewerDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    } else {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/invalid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $invalidDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    }
    ...
    if (!empty($qcReviewer)) {
        $pdf->Cell(72, 5, $qcReviewerName, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(30, 5, $qcReviewerDesignation, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(22, 5, $qcReviewerDepartment, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(33, 5, $qcReviewedTime, 0, false, 'L', 0, '', 0, false, 'M', 'M');
    }
    $pdf->SetLineStyle(array('width' => 5, 'cap' => 'round', 'join' => 'round', 'dash' => '2'));
    $pdf->Line(15, $pdf->GetY() + 5, 236, $pdf->GetY() + 5, $style = array('width' => 0.05, 'color' => array(67, 179, 230)));
    $pdf->Ln();
    ...
    $pdf->SetFont('calibri', 'B', 8);
    $pdf->SetTextColor(0, 0, 128);
    if (!empty($qaReviewerName)) {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/valid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $validQaReviewerDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    } else {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/invalid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $invalidDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    }
    $pdf->Cell(33, 5, "Reviewed By ", 0, false, 'L', 0, '', 0, false, 'M', 'M');
    ...
    $pdf->SetTextColor(0, 0, 128);
    if (!empty($qaReviewer)) {
        $pdf->Cell(72, 5, $qaReviewerName, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(30, 5, $qaReviewerDesignation, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(22, 5, $qaReviewerDepartment, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(33, 5, $qaReviewedTime, 0, false, 'L', 0, '', 0, false, 'M', 'M');
    }
    $pdf->SetLineStyle(array('width' => 5, 'cap' => 'round', 'join' => 'round', 'dash' => '2'));
    $pdf->Line(15, $pdf->GetY() + 5, 236, $pdf->GetY() + 5, $style = array('width' => 0.05, 'color' => array(67, 179, 230)));
    $pdf->Ln();
    ...
    if (!empty($qcApproverName)) {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/valid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $validQcApproverDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    } else {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/invalid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $invalidDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    }
    ...
    $pdf->SetTextColor(0, 0, 128);
    if (!empty($qcApprover)) {
        $pdf->Cell(72, 5, $qcApproverName, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(30, 5, $qcApproverDesignation, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(22, 5, $qcApproverDepartment, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(33, 5, $qcApprovedTime, 0, false, 'L', 0, '', 0, false, 'M', 'M');
    }
    $pdf->SetLineStyle(array('width' => 5, 'cap' => 'round', 'join' => 'round', 'dash' => '2'));
    $pdf->Line(15, $pdf->GetY() + 5, 236, $pdf->GetY() + 5, $style = array('width' => 0.05, 'color' => array(67, 179, 230)));
    $pdf->Ln();
    ...
    if (!empty($qaApproverName)) {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/valid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $validQaApproverDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    } else {
        $pdf->Image(_URL_ . 'img/custom_logicmind_img/invalid.jpg', $pdf->GetX() + 25, $pdf->GetY() - 2.2, 4, 4, 'JPG', $invalidDigitalSignInfo, '', true, 150, '', false, false, 0, false, false, false);
    }
    $pdf->Cell(33, 5, "Approved By ", 0, false, 'L', 0, '', 0, false, 'M', 'M');
    ...
    $pdf->SetTextColor(0, 0, 128);
    if (!empty($qaApprover)) {
        $pdf->Cell(72, 5, $qaApproverName, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(30, 5, $qaApproverDesignation, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(22, 5, $qaApproverDepartment, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(33, 5, $qaApprovedTime, 0, false, 'L', 0, '', 0, false, 'M', 'M');
    }
