...
if ($sop_master->get("sop_object_id", $sop_object_id)) {
    ...
    <div style="width: 100%; text-align:center;font-size: 7px;font-family: muli;padding:2px;"> <span >CONFIDENTIAL : Do not copy, print or transmit in electronic and any other format without the permission of the authorities of ' . $sop_plant . '</span><span ></span><br>
    </div>
    ');
    $mpdf->AddPage();
    //$mpdf->ln();
