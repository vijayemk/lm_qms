                            ...
                            <div class="card">
                                    ...
                                    <div class="col">
                                        ...
                                        <select class="width-100" name="object_id1" id="object_id1" onchange = "addList('object_id1', this.options[this.selectedIndex].value);">
                                            ...
                                            {foreach name=list item=item key=key from=$comp_list_all}
                                                <option value="{$item.object_id}" {if $object_id1 eq $item.object_id} selected {/if}>{$item.no} - [{$item.revision}] - [{$item.created_time}]</option>
                                            {/foreach}
                                        </select>
                                    </div>
                                    <div class="col">
                                        ...
                                        <select class="width-100" name="object_id2" id="object_id2" onchange = "addList('object_id2', this.options[this.selectedIndex].value);">
                                            ...
                                            {foreach name=list item=item key=key from=$comp_list_latest}
                                                <option value="{$item.object_id}" {if $object_id2 eq $item.object_id} selected {/if}>{$item.no} - [{$item.revision}] - [{$item.created_time}]</option>
                                            {/foreach}
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#open_compare_modal"><i class="fa fa-copy"></i> Compare</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-wide-width">
                                    <div class="modal-content">
                                        <div class="modal-header vd_bg-blue vd_white">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Output [{$date_time}]</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="card">
                                                    <div class="row">
                                                        <div class="col">
                                                            <h4>Past {$old_doc_no}</h4>
                                                            <div class="card" id="outputOriginal"></div>
                                                        </div>
                                                        <div class="col">
                                                            <h4>Changes {$new_doc_no}</h4>
