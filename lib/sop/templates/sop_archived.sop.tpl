...
<div class="vd_head-section clearfix">
    <div class="vd_panel-header">
        <ul class="breadcrumb">
            ...
            <li class="active">Obsolete SOP </li>
        </ul>
                            ...
                            <div class="panel-body">
                                <form name="sop_list" method="post" action="{$smarty.server.REQUEST_URI}" class="form-horizontal" role="form" id="sop_list-form" autocomplete="off">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-1">{attribute_name module="sop" attribute="sop_type"} </label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-4">
                                                <select class="width-50" name="sop_type" id="sop_type" onchange = addList('type',this.options[this.selectedIndex].value); required title="Select Valid SOP Type">
                                            ...
                                            <label class="control-label  col-sm-1">SOP Count </label>
                                            <div id="first-name-input-wrapper"  class="controls col-sm-6">
                                                <input type="text" placeholder="Sop Count" class="width-10 required" name="sop_count" value="{$sop_count}" readonly title="SOP Count">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
